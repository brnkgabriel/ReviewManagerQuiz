...
--
-- Host: 68.178.143.2
-- Generation Time: Aug 02, 2017 at 01:55 PM
...
INSERT INTO `demiladeoladipuposcores` VALUES(60, '2017-07-28', 'Talent is Never Enough 1', 'Online Quiz', 'John C Maxwell', 1000, 16, '62.5', 'demiladeoladipuposcores', '1221.534');
...
INSERT INTO `desolaoladipuposcores` VALUES(81, '2017-07-28', 'Talent is Never Enough 1', 'Online Quiz', 'John C Maxwell', 930, 17, '55.879', 'desolaoladipuposcores', '2246.921');
...
INSERT INTO `ebunoluwaajiboyescores` VALUES(64, '2017-07-28', 'Talent is Never Enough 1', 'Online Quiz', 'John C Maxwell', 2330, 14, '166.362', 'ebunoluwaajiboyescores', '2741.432');
...
INSERT INTO `funtoadeniyiscores` VALUES(60, '2017-07-28', 'Talent is Never Enough 1', 'Online Quiz', 'John C Maxwell', 400, 14, '28.56', 'funtoadeniyiscores', '749.024');
...
INSERT INTO `hannahojoscores` VALUES(43, '2017-07-28', 'Talent is Never Enough 1', 'Online Quiz', 'John C Maxwell', 1370, 19, '72.062', 'hannahojoscores', '2243.244');
...
CREATE TABLE `messagequestions` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=6776 ;

--
-- Dumping data for table `messagequestions`
--

INSERT INTO `messagequestions` VALUES(6657, 'Talent is often overrated and frequently _________', 'Single Answer', 'misinterpreted,misunderstood', 'misunderstood');
INSERT INTO `messagequestions` VALUES(6658, 'Talent is a _______ that should be celebrated', 'Single Answer', 'gift,God-given gift', 'God-given gift');
INSERT INTO `messagequestions` VALUES(6659, '...as we observe talented people, we should separate what they can do from ___________', 'Single Answer', 'what they can''t do,who they are', 'who they are');
INSERT INTO `messagequestions` VALUES(6660, '<strong>Fred Smith</strong> said <strong>John, the giftedness is usually greater than the person</strong>, by that he meant that the talent of some people is greater than other important personal attributes such as character and _________', 'Single Answer', 'integrity,commitment,focus', 'commitment');
INSERT INTO `messagequestions` VALUES(6661, '...talented people are always tempted to coast on their _________', 'Single Answer', 'strengths,talents,abilities', 'abilities');
INSERT INTO `messagequestions` VALUES(6662, '...or they want others to recognize their skills but overlook their __________', 'Single Answer', 'weaknesses,deficiencies,faults', 'deficiencies');
INSERT INTO `messagequestions` VALUES(6663, 'The advantage talent gives lasts __________', 'Single Answer', 'for a long time,only a short time', 'only a short time');
INSERT INTO `messagequestions` VALUES(6664, '...talent is only a starting point in business, we''ve got to keep working that talent. True or False?', 'Single Answer', 'True,False', 'True');
INSERT INTO `messagequestions` VALUES(6665, '...talent is cheaper than table salt. What separates the talented individual from the successful one is a lot of ________', 'Single Answer', 'effort,hardwork,commitment', 'hardwork');
INSERT INTO `messagequestions` VALUES(6666, '...everyone has talent. People have equal value but not equal ________', 'Single Answer', 'talent,giftedness', 'giftedness');
INSERT INTO `messagequestions` VALUES(6667, '...everybody is capable of doing something better than the next  _________ people', 'Single Answer', '10,10000,100000', '10000');
INSERT INTO `messagequestions` VALUES(6668, '#2 says to develop the talent we have, not the one we ______', 'Single Answer', 'like,want', 'want');
INSERT INTO `messagequestions` VALUES(6669, 'We should stop working on our weaknesses and start working on our strengths. By this John means abilities not attitude or character issues. True or False?', 'Single Answer', 'True,False', 'True');
INSERT INTO `messagequestions` VALUES(6670, '________ must be addressed', 'Single Answer', 'strengths,attitudes or character issues', 'attitudes or character issues');
INSERT INTO `messagequestions` VALUES(6671, 'What creates the effectiveness that <strong>Peter Drucker</strong> says is necessary for converting talent into results?', 'Single Answer', 'Talents developed,Giftedness,The choices we make', 'The choices we make');
INSERT INTO `messagequestions` VALUES(6672, '#1 of the 13 key choices that can be made to maximize any person''s talent is ________', 'Single Answer', 'focus channels our talent,belief lifts our talent', 'belief lifts our talent');
INSERT INTO `messagequestions` VALUES(6673, '#2 of the 13 key choices that can be made to maximize any person''s talent is ________', 'Single Answer', 'belief lifts our talent,passion energizes our talent', 'passion energizes our talent');
INSERT INTO `messagequestions` VALUES(6674, '#3 of the 13 key choices that can be made to maximize any person''s talent is ________', 'Single Answer', 'passion energizes our talent,belief lifts our talent,initiative activates our talent', 'initiative activates our talent');
INSERT INTO `messagequestions` VALUES(6675, '#4 of the 13 key choices that can be made to maximize any person''s talent is ________', 'Single Answer', 'focus channels our talent,focus directs our talent,initiative activates our talent', 'focus directs our talent');
INSERT INTO `messagequestions` VALUES(6676, '#5 of the 13 key choices that can be made to maximize any person''s talent is ________', 'Single Answer', 'initiative activates our talent,focus directs our talent,preparation positions our talent', 'preparation positions our talent');
INSERT INTO `messagequestions` VALUES(6677, '#6 of the 13 key choices that can be made to maximize any person''s talent is ________', 'Single Answer', 'preparation positions our talent,practice sharpens our talent', 'practice sharpens our talent');
INSERT INTO `messagequestions` VALUES(6678, '#7 of the 13 key choices that can be made to maximize any person''s talent is ________', 'Single Answer', 'endurance sustains our talent,perseverance sustains our talent', 'perseverance sustains our talent');
INSERT INTO `messagequestions` VALUES(6679, '#8 of the 13 key choices that can be made to maximize any person''s talent is ________', 'Single Answer', 'boldness tests our talents,courage tests our talent,perseverance sustains our talent', 'courage tests our talent');
INSERT INTO `messagequestions` VALUES(6680, '#9 of the 13 key choices that can be made to maximize any person''s talent is ________', 'Single Answer', 'teachability extends our talent,teachability expands our talent', 'teachability expands our talent');
INSERT INTO `messagequestions` VALUES(6681, '#10 of the 13 key choices that can be made to maximize any person''s talent is ________', 'Single Answer', 'teachability expands our talent,character protects our talent', 'character protects our talent');
INSERT INTO `messagequestions` VALUES(6682, '#11 of the 13 key choices that can be made to maximize any person''s talent is ________', 'Single Answer', 'relationships influence our talents,character protects our talent', 'relationships influence our talents');
INSERT INTO `messagequestions` VALUES(6683, '#12 of the 13 key choices that can be made to maximize any person''s talent is ________', 'Single Answer', 'responsibility strengthens our talent,responsibility lengthens our talent', 'responsibility strengthens our talent');
INSERT INTO `messagequestions` VALUES(6684, '#13 of the 13 key choices that can be made to maximize any person''s talent is ________', 'Single Answer', 'team work expands our talent,team work multiplies our talent', 'team work multiplies our talent');
INSERT INTO `messagequestions` VALUES(6685, '...if we have talent, we stand alone. If we have ______ we stand out', 'Single Answer', 'developed talent,talent+', 'talent+');
INSERT INTO `messagequestions` VALUES(6686, '...in the article titled <strong>things that do not require talent</strong> the characteristics listed were: punctuality, effort, patience and unselfishness. The article was contained in the _________', 'Single Answer', 'success manual,winners manual', 'winners manual');
INSERT INTO `messagequestions` VALUES(6687, '...people that neglect to make the right choices to release and maximize their talent continually ________', 'Single Answer', 'perform,under deliver,under perform', 'under perform');
INSERT INTO `messagequestions` VALUES(6688, '...talent is a given, but we must earn success. True or False?', 'Single Answer', 'True,False', 'True');
INSERT INTO `messagequestions` VALUES(6689, '...life is a matter of ________s, and every ______ we make makes us.', 'Single Answer', 'decision,choice', 'choice');
INSERT INTO `messagequestions` VALUES(6690, '...one of the most important choices we''ll make is who we''ll _____', 'Single Answer', 'be,become', 'become');
INSERT INTO `messagequestions` VALUES(6691, '<code>talent + right choices = __________</code>', 'Single Answer', 'a successful person,a talent+ person', 'a talent+ person');
INSERT INTO `messagequestions` VALUES(6692, '...the _______ people are the ones who maximize their talent, reach the potential and fulfill their destiny', 'Single Answer', 'talent+,successful', 'talent+');
INSERT INTO `messagequestions` VALUES(6693, '...the first and greatest obstacle to success for most people is _________', 'Single Answer', 'low self esteem,their belief in themselves', 'their belief in themselves');
INSERT INTO `messagequestions` VALUES(6694, '...our potential is a picture of what we can become. _________ helps us see the picture and reach for it.', 'Single Answer', 'Courage,Belief', 'Belief');
INSERT INTO `messagequestions` VALUES(6695, '...if we want to become our best, we need to _________ our best', 'Single Answer', 'practice,believe,develop', 'believe');
INSERT INTO `messagequestions` VALUES(6696, '<strong>If we did all the things we are capable of doing we will literally astonish ourselves.</strong> Who made this remark?', 'Single Answer', 'Thomas Edison,Nicola Tesla,Isaac Newton', 'Thomas Edison');
INSERT INTO `messagequestions` VALUES(6697, '...too often we see what __________ not what could be.', 'Single Answer', 'exists,is present,is', 'is');
INSERT INTO `messagequestions` VALUES(6698, '...our potential is God''s gift to us, our gift to Him is ________', 'Single Answer', 'realizing it,fulfilling it', 'fulfilling it');
INSERT INTO `messagequestions` VALUES(6699, '<strong>Life is a 10 speed bike. Most of us have gears we never use.</strong> Who made this statement?', 'Single Answer', 'Charles Shulz,Andrew Stanton', 'Charles Shulz');
INSERT INTO `messagequestions` VALUES(6700, '...when a man has put a limit on what he will do, he has put a limit on what ________', 'Single Answer', 'he will ever do,he can do', 'he can do');
INSERT INTO `messagequestions` VALUES(6701, '...our potential is really up to us. It doesn''t matter what others might think. True or False?', 'Single Answer', 'True,False', 'True');
INSERT INTO `messagequestions` VALUES(6702, '...to reach our potential, we must first believe in our potential and determine way above _______', 'Single Answer', 'the norm,normal,average', 'average');
INSERT INTO `messagequestions` VALUES(6703, '...people who believe in themselves get better jobs and _______ better in them than those who don''t', 'Single Answer', 'excel,perform', 'perform');
INSERT INTO `messagequestions` VALUES(6704, '...when it comes to academic achievement in school, there''s a greater correlation between __________ and achievement than there is IQ and achievement', 'Single Answer', 'belief,self confidence', 'self confidence');
INSERT INTO `messagequestions` VALUES(6705, '...________ people believe in themselves, especially when others do not.', 'Single Answer', 'talent+,successful', 'successful');
INSERT INTO `messagequestions` VALUES(6706, '<strong>the one thing that will guarantee the successful completion of a doubtful undertaking is faith in the beginning that we can do it.</strong> Who asserted this?', 'Single Answer', 'William James,Jack Welch,Thomas Edison', 'William James');
INSERT INTO `messagequestions` VALUES(6707, '...having confidence in what we are doing gives us the power to achieve it. True or False?', 'Single Answer', 'True,False', 'True');
INSERT INTO `messagequestions` VALUES(6708, '...__________ people can usually evaluate a task before undertaking it and know whether they can do it.', 'Single Answer', 'talent+,successful,confident', 'confident');
INSERT INTO `messagequestions` VALUES(6709, '...a woman __________ to win will have her naysayers, a man on a mission will have his critics', 'Single Answer', 'on a mission,with a will', 'with a will');
INSERT INTO `messagequestions` VALUES(6710, 'What often allows such people to keep going in a negative environment?', 'Single Answer', 'Belief in themselves,Belief in the mission', 'Belief in the mission');
INSERT INTO `messagequestions` VALUES(6711, '...so many of our dreams at first seem impossible, then they seem improbable and then when we summon the will, they soon become _________', 'Single Answer', 'possible,inevitable', 'inevitable');
INSERT INTO `messagequestions` VALUES(6712, '...only a life lived for others is _______', 'Single Answer', 'successful,worthwhile', 'worthwhile');
INSERT INTO `messagequestions` VALUES(6713, '...how do we become a talent+ person? We tap into a natural chain of actions that begins with belief and ends with ___________', 'Single Answer', 'positive action,action', 'positive action');
INSERT INTO `messagequestions` VALUES(6714, '...belief determines _______', 'Single Answer', 'hope,expectations', 'expectations');
INSERT INTO `messagequestions` VALUES(6715, '...we will become on the outside what we believe on the inside. True or False?', 'Single Answer', 'True,False', 'True');
INSERT INTO `messagequestions` VALUES(6716, '...a belief is a habit of mind in which confidence becomes a ________ that we embrace', 'Single Answer', 'mentality,conviction', 'conviction');
INSERT INTO `messagequestions` VALUES(6717, '...in the long run, a belief is more than an idea that a person possesses. It''s an idea that _______ a person', 'Single Answer', 'controls,possesses', 'possesses');
INSERT INTO `messagequestions` VALUES(6718, '<strong>Blessed is he who expects nothing, for he shall never be disappointed.</strong> Who made this statement?', 'Single Answer', 'Jack Welch,Charles Shulz,Benjamin Franklin', 'Benjamin Franklin');
INSERT INTO `messagequestions` VALUES(6719, '<strong>Contrary to popular opinion, life does not get better by chance, life gets better by change.</strong> Who made this statement?', 'Single Answer', 'Kerry Randall,Wiston Churchill,Thomas Edison', 'Kerry Randall');
INSERT INTO `messagequestions` VALUES(6720, '...and this change always takes place inside. It''s the change of _______ that creates the better life.', 'Single Answer', 'mindset,thought,attitude,mentality', 'thought');
INSERT INTO `messagequestions` VALUES(6721, '...improvement comes from change, but change requires ____________', 'Single Answer', 'belief,confidence', 'confidence');
INSERT INTO `messagequestions` VALUES(6722, 'Expectations determine _______', 'Single Answer', 'action,actions', 'actions');
INSERT INTO `messagequestions` VALUES(6723, '...in 20 of the world''s most primitive languages, the word for <strong>belief</strong> is the same as the word for ______', 'Single Answer', 'act,talk,do', 'do');
INSERT INTO `messagequestions` VALUES(6724, '...we cannot live in a way that is inconsistent with our _______ for ourselves', 'Single Answer', 'aspirations,expectations,hopes', 'expectations');
INSERT INTO `messagequestions` VALUES(6725, '...there are ______ kinds of people in this world.', 'Single Answer', '2,3,4', '2');
INSERT INTO `messagequestions` VALUES(6726, '...there are 2 kinds of people in this world. Those who want to get things done and those who want to make mistakes. True or False?', 'Single Answer', 'True,False', 'False');
INSERT INTO `messagequestions` VALUES(6727, '...tough times never last, but tough _________ do', 'Single Answer', 'situations,people', 'people');
INSERT INTO `messagequestions` VALUES(6728, '...we don''t overcome challenges by making them smaller, we overcome them by making _______ bigger', 'Single Answer', 'them,ourselves,our confidence', 'ourselves');
INSERT INTO `messagequestions` VALUES(6729, '_______ determine results', 'Single Answer', 'Action,Actions', 'Actions');
INSERT INTO `messagequestions` VALUES(6730, 'Sir Isaac Newton''s 3rd law of motion states that <strong>for every action, there is an equal and opposite ________</strong>', 'Single Answer', 'action,reaction', 'reaction');
INSERT INTO `messagequestions` VALUES(6731, 'Is hope a strategy?', 'Single Answer', 'Yes,No', 'No');
INSERT INTO `messagequestions` VALUES(6732, '________ energizes our talent', 'Single Answer', 'Action,Initiative,Passion', 'Passion');
INSERT INTO `messagequestions` VALUES(6733, '...passion creates ________, it provides fuel', 'Single Answer', 'energy,a flame,motion,fire', 'fire');
INSERT INTO `messagequestions` VALUES(6734, '...passion can _______ every aspect of a person''s life, including his talent', 'Single Answer', 'propel,activate,energize', 'energize');
INSERT INTO `messagequestions` VALUES(6735, '...a passionate person with limited talent will outperform a passive person who possesses greater talent. True or False?', 'Single Answer', 'True,False', 'True');
INSERT INTO `messagequestions` VALUES(6736, '...passionate people act with ________ and they just keep on going', 'Single Answer', 'enthusiasm,boundless enthusiasm', 'boundless enthusiasm');
INSERT INTO `messagequestions` VALUES(6737, 'talent + passion ___________', 'Single Answer', '= energy,energizes', 'energizes');
INSERT INTO `messagequestions` VALUES(6738, '...in the study of 1500 people over 20 years, the group was divided into Group A (83%) and Group B (17%). Which of the options define Group A?', 'Single Answer', 'Money now to do what I like later,Do what I like now money later', 'Money now to do what I like later');
INSERT INTO `messagequestions` VALUES(6739, '...at the end of the 20 years ______ of the 1500 had become millionaires.', 'Single Answer', '100,101,102', '101');
INSERT INTO `messagequestions` VALUES(6740, '... of the millionaires 100 out of 101 were from the group that did what they liked now and worried about the money later. What group was that?', 'Single Answer', 'Group A,Group B', 'Group B');
INSERT INTO `messagequestions` VALUES(6741, '...find something you like to do so much that you''ll gladly do it for nothing and if you learn to do it well, someday people will be happy to pay you for it. True or False?', 'Single Answer', 'True,False', 'True');
INSERT INTO `messagequestions` VALUES(6742, '_______ is the first step to achievement', 'Single Answer', 'confidence,passion', 'passion');
INSERT INTO `messagequestions` VALUES(6743, '...the only way we can ________ anything of significance is to really want it.', 'Single Answer', 'accomplish,achieve', 'achieve');
INSERT INTO `messagequestions` VALUES(6744, '...passion increases _________', 'Single Answer', 'the will,will power', 'will power');
INSERT INTO `messagequestions` VALUES(6745, '...passion turns our <code>have tos</code> to ______', 'Single Answer', 'need tos,want tos', 'want tos');
INSERT INTO `messagequestions` VALUES(6746, '...the secret to will power is _________', 'Single Answer', 'passion,want power', 'want power');
INSERT INTO `messagequestions` VALUES(6747, '...we can''t help people to become winners unless they want to win. True or False?', 'Single Answer', 'True,False', 'True');
INSERT INTO `messagequestions` VALUES(6748, '...champions become champions from within, not from ________', 'Single Answer', 'outside,without', 'without');
INSERT INTO `messagequestions` VALUES(6749, '<strong>it''s the greatest shot of adrenaline to be doing what you''ve wanted to do so badly, you almost feel like you could fly without the plane.</strong> Who made this statement?', 'Single Answer', 'Charles Lindbergh,Charles Stanley,Charles Shulz', 'Charles Lindbergh');
INSERT INTO `messagequestions` VALUES(6750, 'passion is the _________ excellence', 'Single Answer', 'root of,foundation for', 'foundation for');
INSERT INTO `messagequestions` VALUES(6751, '...if we don''t possess the energy we desire, we need to fire up our passion by: #1 _______ our lives according to our passion', 'Single Answer', 'ordering,prioritizing', 'prioritizing');
INSERT INTO `messagequestions` VALUES(6752, '...if we don''t possess the energy we desire, we need to fire up our passion by: #2 _______', 'Single Answer', 'preserving our passion,protecting our passion', 'protecting our passion');
INSERT INTO `messagequestions` VALUES(6753, '...if we don''t possess the energy we desire, we need to fire up our passion by: #3 _______ your passion with everything you''ve got', 'Single Answer', 'follow,pursue,work', 'pursue');
INSERT INTO `messagequestions` VALUES(6754, '__________ activates our talent', 'Single Answer', 'actions,initiative', 'initiative');
INSERT INTO `messagequestions` VALUES(6755, '...the secret that good leaders understand is that ________ is their friend.', 'Single Answer', 'passion,momentum,speed', 'momentum');
INSERT INTO `messagequestions` VALUES(6756, '_________ is the first step to anywhere we want to go.', 'Single Answer', 'Action,Initiative', 'Initiative');
INSERT INTO `messagequestions` VALUES(6757, 'Where we finish in life is not determined so much by where we start but by whether we start. Meaning our background doesn''t matter, the thing is we should start and we''ll redefine our background in time. True or False?', 'Single Answer', 'True,False', 'True');
INSERT INTO `messagequestions` VALUES(6758, '...someone elses opinion of us doesn''t have to be our reality. True or False?', 'Single Answer', 'True,False', 'True');
INSERT INTO `messagequestions` VALUES(6759, '________ people initiate, and then they follow through', 'Single Answer', 'Talent+,Successful', 'Successful');
INSERT INTO `messagequestions` VALUES(6760, 'Initiative closes the door to fear. True or False?', 'Single Answer', 'True,False', 'True');
INSERT INTO `messagequestions` VALUES(6761, '<strong>Action is a great restorer and builder of confidence. Inaction is not only the result but the cause of fear.</strong> Who made this statement?', 'Single Answer', 'Michael Angelo,Wiston Churchill,Jack Welch,Norman Vincent Peale', 'Norman Vincent Peale');
INSERT INTO `messagequestions` VALUES(6762, 'Initiative opens the door to _________', 'Single Answer', 'momentum,opportunity', 'opportunity');
INSERT INTO `messagequestions` VALUES(6763, '...the hardest work is often the accumulation of many easy things that should have been done yesterday, last week or last month. True or False?', 'Single Answer', 'True,False', 'True');
INSERT INTO `messagequestions` VALUES(6764, '<strong>To move the world, we must first move ourselves. Show me those who refuse to take responsibility for their own lives and I''ll show you a people who also lack initiative.</strong> Who made this statement?', 'Single Answer', 'Isaac Newton,Socrates,Thomas Edison', 'Socrates');
INSERT INTO `messagequestions` VALUES(6765, '...excuses are like ________ signs on the road of progress.', 'Single Answer', 'quit,exit', 'exit');
INSERT INTO `messagequestions` VALUES(6766, '...it''s easier to move from _______ to success, than from excuses to success.', 'Single Answer', 'setbacks,failure', 'failure');
INSERT INTO `messagequestions` VALUES(6767, '...procrastination is the _______ that makes difficulties grow.', 'Single Answer', 'soil,water,fertilizer', 'fertilizer');
INSERT INTO `messagequestions` VALUES(6768, '...share your goal with a friend who will help you. No one achieves success alone. True or False?', 'Single Answer', 'True,False', 'True');
INSERT INTO `messagequestions` VALUES(6769, '#5 break large tasks down into _______ ones', 'Single Answer', 'little,smaller', 'smaller');
INSERT INTO `messagequestions` VALUES(6770, '...overwhelmed people <strong>seldom</strong> initiate. A synonym for seldom used in the last sentence is _______', 'Single Answer', 'always,rarely', 'rarely');
INSERT INTO `messagequestions` VALUES(6771, '...when we don''t take initiative and prioritize what we must do according to its importance, the tasks begin to arrange themselves according to their ________.', 'Single Answer', 'need,urgency,immediate need', 'urgency');
INSERT INTO `messagequestions` VALUES(6772, '...the most important step in accomplishing something big is determining who will be on the team. T or F?', 'Single Answer', 'T,F', 'T');
INSERT INTO `messagequestions` VALUES(6773, '#6 allocate specific times to task you might __________', 'Single Answer', 'postpone,procrastinate', 'procrastinate');
INSERT INTO `messagequestions` VALUES(6774, '...preparation includes ________', 'Single Answer', 'working,doing', 'doing');
INSERT INTO `messagequestions` VALUES(6775, '...desire isn''t enough, good intentions aren''t enough, talent isn''t enough. Success requires ________', 'Single Answer', 'character,initiative,confidence', 'initiative');
...
INSERT INTO `michaelalofescores` VALUES(72, '2017-07-28', 'Talent is Never Enough 1', 'Online Quiz', 'John C Maxwell', 540, 18, '30.024', 'michaelalofescores', '1293.703');
...
INSERT INTO `oluwanifemifawalescores` VALUES(14, '2017-07-28', 'Talent is Never Enough 1', 'Online Quiz', 'John C Maxwell', 870, 11, '79.083', 'oluwanifemifawalescores', '708.998');
...
INSERT INTO `oluwaseyialofescores` VALUES(11, '2017-07-28', 'Talent is Never Enough 1', 'Online Quiz', 'John C Maxwell', 160, 10, '16', 'oluwaseyialofescores', '172.92');
...
INSERT INTO `preciousfalodunscores` VALUES(48, '2017-07-28', 'Talent is Never Enough 1', 'Online Quiz', 'John C Maxwell', 570, 14, '40.698', 'preciousfalodunscores', '804.073');
...
INSERT INTO `profiles` VALUES(25, 'Oluwanifemi', 'Fawale', '11', 'oluwanifemifawale@gmail.com', '5f1cf5af2ac6807754b1825d0250ee8be60ed712', '708.998', '12th', '0', 'ff0080', 'OF', 'pink_femi838', 'oluwanifemifawalescores', '', '{"cTab":"Scripture","wQAnswered":"16","wQGotten":"15","wQMissed":"1","mQAnswered":"119","mQGotten":"95","mQMissed":"24","sTyped":"8","sWordsTyped":"Matthew 12:26-And if satan drives out satan, he has become divided against himself and did-unified; how will his kingdom last or continue to stand?","sGotten":"5","sMissed":"3","tPoints":"870","eAForToday":"79.083","totalAggregate":"708.998","email":"oluwanifemifawale@gmail.com","age":"11"}');
...
INSERT INTO `profiles` VALUES(27, 'Oluwaseyi', 'Alofe', '10', 'oluwaseyialofe13@gmail.com', '9125a5ca7d2d99dec906b5548dec123f66da5711', '172.92', '24th', '0', 'FF530C', 'OA', 'Lilshay', 'oluwaseyialofescores', '', '{"cTab":"Worship","wQAnswered":"16","wQGotten":"16","wQMissed":"0","mQAnswered":"0","mQGotten":"0","mQMissed":"0","sTyped":"0","sWordsTyped":"","sGotten":"0","sMissed":"0","tPoints":"160","eAForToday":"16","totalAggregate":"172.92","email":"oluwaseyialofe13@gmail.com","age":"10"}');
...
INSERT INTO `profiles` VALUES(29, 'Prosper', 'Falodun', '11', 'prosperfalodun@gmail.com', '16254f13cea30be88237e04d059e57802a28b819', '339.333', '19th', '0', '3a2805', 'PF', 'pros353', 'prosperfalodunscores', '', '{"cTab":"Worship","wQAnswered":"16","wQGotten":"16","wQMissed":"0","mQAnswered":"0","mQGotten":"0","mQMissed":"0","sTyped":"0","sWordsTyped":"","sGotten":"0","sMissed":"0","tPoints":"160","eAForToday":"14.544","totalAggregate":"339.333","email":"prosperfalodun@gmail.com","age":"11"}');
...
INSERT INTO `profiles` VALUES(32, 'Peter', 'Akindiya', '14', 'akindiyapeter@gmail.com', '3f0c00a0fe773bbc05855c75ab6bc3cc038839f7', '30.25', '30th', '0', '2b2745', 'PA', 'cashon2255', 'peterakindiyascores', '', '');
...
INSERT INTO `prosperfalodunscores` VALUES(9, '2017-07-28', 'Talent is Never Enough 1', 'Online Quiz', 'John C Maxwell', 160, 11, '14.544', 'prosperfalodunscores', '339.333');
...
INSERT INTO `quizsettings` VALUES(1, 'quiz', 'Materials', '2017-07-28 23:59:00');
...
INSERT INTO `scripturematerials` VALUES(87, 'Matthew', 11, 28, 'Matthew 11:28-Come to Me, all you who labor and are heavy-laden and overburdened, and I will give you rest.', 'Matthew 11:28');
INSERT INTO `scripturematerials` VALUES(88, 'Matthew', 11, 29, 'Matthew 11:29-Take My yoke upon you and learn of Me, for I am gentle and humble in heart, and you will find rest for your souls.', 'Matthew 11:29');
INSERT INTO `scripturematerials` VALUES(89, 'Matthew', 11, 30, 'Matthew 11:30-For My yoke is easy, and My burden is light.', 'Matthew 11:30');
INSERT INTO `scripturematerials` VALUES(90, 'Matthew', 12, 22, 'Matthew 12:22-Then a blind and dumb man under the power of a demon was brought to Jesus, and He cured him, so that the blind and dumb man both spoke and saw.', 'Matthew 12:22');
INSERT INTO `scripturematerials` VALUES(91, 'Matthew', 12, 23, 'Matthew 12:23-And all the people were stunned with bewildered wonder and said, This cannot be the Son of David, can it?', 'Matthew 12:23');
INSERT INTO `scripturematerials` VALUES(92, 'Matthew', 12, 24, 'Matthew 12:24-But the Pharisees, hearing it, said, This Man drives out demons only by and with the help of Beelzebub, the prince of demons.', 'Matthew 12:24');
INSERT INTO `scripturematerials` VALUES(93, 'Matthew', 12, 25, 'Matthew 12:25-And knowing their thoughts, He said to them, Any kingdom that is divided against itself is being brought to desolation and laid waste, and no city or house divided against itself will last or continue to stand.', 'Matthew 12:25');
INSERT INTO `scripturematerials` VALUES(94, 'Matthew', 12, 26, 'Matthew 12:26-And if satan drives out satan, he has become divided against himself and dis-unified; how then will his kingdom last or continue to stand?', 'Matthew 12:26');
INSERT INTO `scripturematerials` VALUES(95, 'Matthew', 12, 27, 'Matthew 12:27-And if I drive out demons by Beelzebub, by whose do your sons drive them out? For this reason they shall be your judges.', 'Matthew 12:27');
INSERT INTO `scripturematerials` VALUES(96, 'Matthew', 12, 28, 'Matthew 12:28-But if it is by the Spirit of God that I drive out demons, then the kingdom of God has come upon you.', 'Matthew 12:28');
INSERT INTO `scripturematerials` VALUES(97, 'Matthew', 12, 29, 'Matthew 12:29-Or how can a person go into a strong man''s house and carry off his goods without first binding the strong man? Then indeed he may plunder his house.', 'Matthew 12:29');
INSERT INTO `scripturematerials` VALUES(98, 'Matthew', 12, 30, 'Matthew 12:30-He who is not with Me is against Me, and he who does not gather with Me scatters.', 'Matthew 12:30');
INSERT INTO `scripturematerials` VALUES(99, 'Matthew', 12, 31, 'Matthew 12:31-Therefore I tell you, every sin and blasphemy can be forgiven men, but blasphemy against the Holy Spirit shall not and cannot be forgiven.', 'Matthew 12:31');
INSERT INTO `scripturematerials` VALUES(100, 'Matthew', 12, 32, 'Matthew 12:32-And whoever speaks a word against the Son of Man will be forgiven, but whoever speaks against the Spirit, the Holy One, will not be forgiven, either in this world and age or in the world and age to come.', 'Matthew 12:32');
INSERT INTO `scripturematerials` VALUES(101, 'Matthew', 12, 33, 'Matthew 12:33-Either make the tree sound, and its fruit sound, or make the tree rotten, and its fruit rotten; for the tree is known and recognized and judged by its fruit.', 'Matthew 12:33');
INSERT INTO `scripturematerials` VALUES(102, 'Matthew', 12, 34, 'Matthew 12:34-You offspring of vipers! How can you speak good things when you are evil? For out of the abundance of the heart the mouth speaks.', 'Matthew 12:34');
INSERT INTO `scripturematerials` VALUES(103, 'Matthew', 12, 35, 'Matthew 12:35-The good man from his inner good treasure flings forth good things, and the evil man out of the inner evil storehouse flings forth evil things.', 'Matthew 12:35');
INSERT INTO `scripturematerials` VALUES(104, 'Matthew', 12, 36, 'Matthew 12:36-But I tell you, on the day of judgment men will have to give account for every idle word they speak.', 'Matthew 12:36');
INSERT INTO `scripturematerials` VALUES(105, 'Matthew', 12, 37, 'Matthew 12:37-For by your words you will be justified and acquitted, and by your words you will be condemned and sentenced.', 'Matthew 12:37');
INSERT INTO `scripturematerials` VALUES(106, 'Matthew', 12, 38, 'Matthew 12:38-Then some of the scribes and Pharisees said to Him, Teacher, we desire to see a sign or miracle from You.', 'Matthew 12:38');
INSERT INTO `scripturematerials` VALUES(107, 'Matthew', 12, 39, 'Matthew 12:39-But He replied to them, An evil and adulterous generation seeks and demands a sign; but no sign shall be given to it except the sign of the prophet Jonah.', 'Matthew 12:39');
INSERT INTO `scripturematerials` VALUES(108, 'Matthew', 12, 40, 'Matthew 12:40-For even as Jonah was three days and three nights in the belly of the sea monster, so will the Son of Man be three days and three nights in the heart of the earth.', 'Matthew 12:40');
INSERT INTO `scripturematerials` VALUES(109, 'Matthew', 12, 41, 'Matthew 12:41-The men of Nineveh will stand up at the judgment with this generation and condemn it; for they repented at the preaching of Jonah, and behold, Someone more and greater than Jonah is here!', 'Matthew 12:41');
INSERT INTO `scripturematerials` VALUES(110, 'Matthew', 12, 42, 'Matthew 12:42-The queen of the south will stand up at the judgment with this generation and condemn it; for she came from the ends of the earth to listen to the wisdom of Solomon, and behold, Someone greater than Solomon is here!', 'Matthew 12:42');
INSERT INTO `scripturematerials` VALUES(111, 'Matthew', 12, 43, 'Matthew 12:43-But when the unclean spirit has gone out of a man, it roams through dry places in search of rest, but it does not find any.', 'Matthew 12:43');
INSERT INTO `scripturematerials` VALUES(112, 'Matthew', 12, 44, 'Matthew 12:44-Then it says, I will go back to my house from which I came out. And when it arrives, it finds the place unoccupied, swept, put in order, and decorated.', 'Matthew 12:44');
INSERT INTO `scripturematerials` VALUES(113, 'Matthew', 12, 45, 'Matthew 12:45-Then it goes and brings with it seven other spirits more wicked than itself, and they go in and make their home there. And the last condition of that man becomes worse than the first. So also shall it be with this wicked generation.', 'Matthew 12:45');
INSERT INTO `scripturematerials` VALUES(114, 'Matthew', 12, 46, 'Matthew 12:46-Jesus was still speaking to the people, behold, His mother and brothers stood outside, seeking to speak to Him.', 'Matthew 12:46');
INSERT INTO `scripturematerials` VALUES(115, 'Matthew', 12, 47, 'Matthew 12:47-Someone said to Him, Listen! Your mother and Your brothers are standing outside, seeking to speak to You.', 'Matthew 12:47');
INSERT INTO `scripturematerials` VALUES(116, 'Matthew', 12, 48, 'Matthew 12:48-But He replied to the man who told Him, Who is My mother, and who are My brothers?', 'Matthew 12:48');
INSERT INTO `scripturematerials` VALUES(117, 'Matthew', 12, 49, 'Matthew 12:49-And stretching out His hand toward His disciples, He said, Here are My mother and My brothers.', 'Matthew 12:49');
INSERT INTO `scripturematerials` VALUES(118, 'Matthew', 12, 50, 'Matthew 12:50-For whoever does the will of My Father in heaven is My brother and sister and mother!', 'Matthew 12:50');
INSERT INTO `scripturematerials` VALUES(119, 'Luke', 11, 1, 'Luke 11:1-Then He was praying in a certain place; and when He stopped, one of His disciples said to Him, Lord, teach us to pray, as John taught his disciples.', 'Luke 11:1');
INSERT INTO `scripturematerials` VALUES(120, 'Luke', 11, 2, 'Luke 11:2-And He said to them, When you pray, say: Our Father Who is in heaven, hallowed be Your name, Your kingdom come. Your will be done on earth as it is in heaven.', 'Luke 11:2');
INSERT INTO `scripturematerials` VALUES(121, 'Luke', 11, 3, 'Luke 11:3-Give us day by day our daily bread.', 'Luke 11:3');
INSERT INTO `scripturematerials` VALUES(122, 'Luke', 11, 4, 'Luke 11:4-And forgive us our sins, for we ourselves also forgive everyone who is indebted to us. And bring us not into temptation but rescue us from evil.', 'Luke 11:4');
INSERT INTO `scripturematerials` VALUES(123, 'Luke', 11, 5, 'Luke 11:5-And He said to them, Which of you who has a friend will go to him at midnight and will say to him, Friend, lend me three loaves.', 'Luke 11:5');
INSERT INTO `scripturematerials` VALUES(124, 'Luke', 11, 6, 'Luke 11:6-For a friend of mine who is on a journey has just come, and I have nothing to put before him;', 'Luke 11:6');
INSERT INTO `scripturematerials` VALUES(125, 'Luke', 11, 7, 'Luke 11:7-And he from within will answer, Do not disturb me; the door is now closed, and my children are with me in bed; I cannot get up and supply you?', 'Luke 11:7');
INSERT INTO `scripturematerials` VALUES(126, 'Luke', 11, 8, 'Luke 11:8-I tell you, although he will not get up and supply him anything because he is his friend, yet because of his shameless persistence and insistence he will get up and give him as much as he needs.', 'Luke 11:8');
INSERT INTO `scripturematerials` VALUES(127, 'Luke', 11, 9, 'Luke 11:9-So I say to you, Ask and keep on asking and it shall be given you; seek and keep on seeking and you shall find; knock and keep on knocking and the door shall be opened to you.', 'Luke 11:9');
INSERT INTO `scripturematerials` VALUES(128, 'Luke', 11, 10, 'Luke 11:10-For everyone who asks and keeps on asking receives; and he who seeks and keeps on seeking finds; and to him who knocks and keeps on knocking, the door shall be opened.', 'Luke 11:10');
INSERT INTO `scripturematerials` VALUES(129, 'Luke', 11, 11, 'Luke 11:11-What father among you, if his son asks for a loaf of bread, will give him a stone; or if he asks for a fish, will instead of a fish give him a serpent?', 'Luke 11:11');
INSERT INTO `scripturematerials` VALUES(130, 'Luke', 11, 12, 'Luke 11:12-Or if he asks for an egg, will give him a scorpion?', 'Luke 11:12');
INSERT INTO `scripturematerials` VALUES(131, 'Luke', 11, 13, 'Luke 11:13-If you then, evil as you are, know how to give good gifts to your children, how much more will your heavenly Father give the Holy Spirit to those who ask Him!', 'Luke 11:13');
INSERT INTO `scripturematerials` VALUES(132, 'Luke', 11, 14, 'Luke 11:14-Now Jesus was driving out a demon that was dumb; and it occurred that when the demon had gone out, the dumb man spoke. And the crowds marveled.', 'Luke 11:14');
INSERT INTO `scripturematerials` VALUES(133, 'Luke', 11, 15, 'Luke 11:15-But some of them said, He drives out demons by Beelzebub, the prince of demons,', 'Luke 11:15');
INSERT INTO `scripturematerials` VALUES(134, 'Luke', 11, 16, 'Luke 11:16-While others, to try and test and tempt Him, demanded a sign of Him from heaven.', 'Luke 11:16');
INSERT INTO `scripturematerials` VALUES(135, 'Luke', 11, 17, 'Luke 11:17-But He, aware of their intent and purpose, said to them, Every kingdom split up against itself is doomed and brought to desolation, and so house falls upon house.', 'Luke 11:17');
INSERT INTO `scripturematerials` VALUES(136, 'Luke', 11, 18, 'Luke 11:18-And if satan also is divided against himself, how will his kingdom last? For you say that I expel demons with the help of and by Beelzebub.', 'Luke 11:18');
INSERT INTO `scripturematerials` VALUES(137, 'Luke', 11, 19, 'Luke 11:19-Now if I expel demons with the help of and by Beelzebub, with whose help and by whom do your sons drive them out? Therefore they shall be your judges.', 'Luke 11:19');
INSERT INTO `scripturematerials` VALUES(138, 'Luke', 11, 20, 'Luke 11:20-But if I drive out the demons by the finger of God, then the kingdom of God has already come upon you.', 'Luke 11:20');
INSERT INTO `scripturematerials` VALUES(139, 'Luke', 11, 21, 'Luke 11:21-When the strong man, fully armed, guards his own dwelling, his belongings are undisturbed.', 'Luke 11:21');
INSERT INTO `scripturematerials` VALUES(140, 'Luke', 11, 22, 'Luke 11:22-But when one stronger than he attacks him and conquers him, he robs him of his whole armor on which he had relied and divides up and distributes all his goods as plunder.', 'Luke 11:22');
INSERT INTO `scripturematerials` VALUES(141, 'Luke', 11, 23, 'Luke 11:23-He who is not with Me is against Me, and he who does not gather with Me, scatters.', 'Luke 11:23');
INSERT INTO `scripturematerials` VALUES(142, 'Luke', 11, 24, 'Luke 11:24-When the unclean spirit has gone out of a person, it roams through dry places in search of rest; and finding none it says, I will go back to my house from which I came.', 'Luke 11:24');
INSERT INTO `scripturematerials` VALUES(143, 'Luke', 11, 25, 'Luke 11:25-And when it arrives, it finds the place swept and put in order and furnished and decorated.', 'Luke 11:25');
INSERT INTO `scripturematerials` VALUES(144, 'Luke', 11, 26, 'Luke 11:26-And it goes and brings other spirits, seven of them, more wicked than itself, and they enter in, settle down, and dwell there; and the last state of that person is worse than the first.', 'Luke 11:26');
INSERT INTO `scripturematerials` VALUES(145, 'Luke', 11, 27, 'Luke 11:27-Now it occurred that as He was saying these things, a certain woman in the crowd raised her voice and said to Him, Blessed is the womb that bore You and the breasts that You sucked!', 'Luke 11:27');
INSERT INTO `scripturematerials` VALUES(146, 'Luke', 11, 28, 'Luke 11:28-But He said, Blessed rather are those who hear the Word of God and obey and practice it!', 'Luke 11:28');
INSERT INTO `scripturematerials` VALUES(147, 'Luke', 11, 29, 'Luke 11:29-Now as the crowds were increasingly thronging Him, He began to say, This present generation is a wicked one; it seeks and demands a sign, but no sign shall be given to it except the sign of Jonah.', 'Luke 11:29');
INSERT INTO `scripturematerials` VALUES(148, 'Luke', 11, 30, 'Luke 11:30-For just as Jonah became a sign to the people of Nineveh, so will also the Son of Man be a sign to this age and generation.', 'Luke 11:30');
INSERT INTO `scripturematerials` VALUES(149, 'Luke', 11, 31, 'Luke 11:31-The queen of the south will arise in the judgment with the people of this age and generation and condemn them; for she came from the ends of the earth to listen to the wisdom of Solomon, and behold, a greater than Solomon is here.', 'Luke 11:31');
INSERT INTO `scripturematerials` VALUES(150, 'Luke', 11, 32, 'Luke 11:32-The men of Nineveh will appear as witnesses at the judgment with this generation and will condemn it; for they repented at the preaching of Jonah, and behold, a greater than Jonah is here.', 'Luke 11:32');
INSERT INTO `scripturematerials` VALUES(151, 'Luke', 11, 33, 'Luke 11:33-No one after lighting a lamp puts it in a cellar or crypt or under a bushel measure, but on a lamp stand, that those who are coming in may see the light.', 'Luke 11:33');
INSERT INTO `scripturematerials` VALUES(152, 'Luke', 11, 34, 'Luke 11:34-Your eye is the lamp of your body; when your eye is sound and fulfilling its office, your whole body is full of light; but when it is not sound and is not fulfilling its office, your body is full of darkness.', 'Luke 11:34');
INSERT INTO `scripturematerials` VALUES(153, 'Luke', 11, 35, 'Luke 11:35-Be careful, therefore, that the light that is in you is not darkness.', 'Luke 11:35');
INSERT INTO `scripturematerials` VALUES(154, 'Luke', 11, 36, 'Luke 11:36-If then your entire body is illuminated, having no part dark, it will be wholly bright, as when a lamp with its bright rays gives you light.', 'Luke 11:36');
INSERT INTO `scripturematerials` VALUES(155, 'Luke', 11, 37, 'Luke 11:37-Now while Jesus was speaking, a Pharisee invited Him to take dinner with him, so He entered and reclined at table.', 'Luke 11:37');
INSERT INTO `scripturematerials` VALUES(156, 'Luke', 11, 38, 'Luke 11:38-The Pharisee noticed and was astonished to see that Jesus did not first wash before dinner.', 'Luke 11:38');
INSERT INTO `scripturematerials` VALUES(157, 'Luke', 11, 39, 'Luke 11:39-But the Lord said to him, Now you Pharisees clean the outside of the cup and of the plate, but inside you yourselves are full of greed and robbery and extortion and malice and wickedness.', 'Luke 11:39');
INSERT INTO `scripturematerials` VALUES(158, 'Luke', 11, 40, 'Luke 11:40-You senseless ones! Did not He who made the outside make the inside also?', 'Luke 11:40');
INSERT INTO `scripturematerials` VALUES(159, 'Luke', 11, 41, 'Luke 11:41-But give donations to the poor of those things as you have, and behold, everything is purified and clean for you.', 'Luke 11:41');
INSERT INTO `scripturematerials` VALUES(160, 'Luke', 11, 42, 'Luke 11:42-But woe to you, Pharisees! For you tithe mint and rue and every herb, but disregard and neglect justice and the love of God. These you ought to have done without leaving the others undone.', 'Luke 11:42');
INSERT INTO `scripturematerials` VALUES(161, 'Luke', 11, 43, 'Luke 11:43-Woe to you, Pharisees! For you love the best seats in the synagogues and to be greeted and bowed down to in the [public] marketplaces.', 'Luke 11:43');
INSERT INTO `scripturematerials` VALUES(162, 'Luke', 11, 44, 'Luke 11:44-Woe to you! For you are like graves which are not marked or seen, and men walk over them without being aware of it.', 'Luke 11:44');
INSERT INTO `scripturematerials` VALUES(163, 'Luke', 11, 45, 'Luke 11:45-One of the experts in the [Mosaic] Law answered him, Teacher, in saying this, You reproach and outrage and affront even us!', 'Luke 11:45');
INSERT INTO `scripturematerials` VALUES(164, 'Luke', 11, 46, 'Luke 11:46-But He said, Woe to you, the lawyers, also! For you load men with oppressive burdens hard to bear, and you do not personally touch the burdens with one of your fingers.', 'Luke 11:46');
INSERT INTO `scripturematerials` VALUES(165, 'Luke', 11, 47, 'Luke 11:47-Woe to you! For you are rebuilding and repairing the tombs of the prophets, whom your fathers killed.', 'Luke 11:47');
INSERT INTO `scripturematerials` VALUES(166, 'Luke', 11, 48, 'Luke 11:48-So you bear witness and give your full approval and consent to the deeds of your fathers; for they actually killed them, and you rebuild and repair monuments to them.', 'Luke 11:48');
INSERT INTO `scripturematerials` VALUES(167, 'Luke', 11, 49, 'Luke 11:49-For this reason also the wisdom of God said, I will send them prophets and apostles, [some] of whom they will put to death and persecute,', 'Luke 11:49');
INSERT INTO `scripturematerials` VALUES(168, 'Luke', 11, 50, 'Luke 11:50-So that the blood of all the prophets shed from the foundation of the world may be charged against and required of this age and generation,', 'Luke 11:50');
INSERT INTO `scripturematerials` VALUES(169, 'Luke', 11, 51, 'Luke 11:51-From the blood of Abel to the blood of Zechariah, who was slain between the altar and the sanctuary. Yes, I tell you, it shall be charged against and required of this age and generation.', 'Luke 11:51');
INSERT INTO `scripturematerials` VALUES(170, 'Luke', 11, 52, 'Luke 11:52-Woe to you, lawyers! For you have taken away the key to knowledge; you did not go in yourselves, and you hindered and prevented those who were entering.', 'Luke 11:52');
INSERT INTO `scripturematerials` VALUES(171, 'Luke', 11, 53, 'Luke 11:53-As He left there, the scribes and Pharisees began to be enraged with and set themselves violently against Him and to draw Him out and provoke Him to speak of many things,', 'Luke 11:53');
INSERT INTO `scripturematerials` VALUES(172, 'Luke', 11, 54, 'Luke 11:54-Secretly watching and plotting and lying in wait for Him, to seize upon something He might say [that they may accuse Him].', 'Luke 11:54');
INSERT INTO `scripturematerials` VALUES(173, 'Matthew', 13, 1, 'Matthew 13:1-That same day Jesus went out of the house and was sitting beside the sea.', 'Matthew 13:1');
INSERT INTO `scripturematerials` VALUES(174, 'Matthew', 13, 2, 'Matthew 13:2-But such great crowds gathered about Him that He got into a boat and remained sitting there, while all the throng stood on the shore.', 'Matthew 13:2');
INSERT INTO `scripturematerials` VALUES(175, 'Matthew', 13, 3, 'Matthew 13:3-And He told them many things in parables, saying, A sower went out to sow.', 'Matthew 13:3');
INSERT INTO `scripturematerials` VALUES(176, 'Matthew', 13, 4, 'Matthew 13:4-And as he sowed, some seeds fell by the roadside, and the birds came and ate them up.', 'Matthew 13:4');
INSERT INTO `scripturematerials` VALUES(177, 'Matthew', 13, 5, 'Matthew 13:5-Other seeds fell on rocky ground, where they had not much soil; and at once they sprang up, because they had no depth of soil.', 'Matthew 13:5');
INSERT INTO `scripturematerials` VALUES(178, 'Matthew', 13, 6, 'Matthew 13:6-But when the sun rose, they were scorched, and because they had no root, they dried up and withered away.', 'Matthew 13:6');
INSERT INTO `scripturematerials` VALUES(179, 'Matthew', 13, 7, 'Matthew 13:7-Other seeds fell among thorns, and the thorns grew up and choked them out.', 'Matthew 13:7');
INSERT INTO `scripturematerials` VALUES(180, 'Matthew', 13, 8, 'Matthew 13:8-Other seeds fell on good soil, and yielded grain-some a hundred times as much as was sown, some sixty times as much, and some thirty.', 'Matthew 13:8');
INSERT INTO `scripturematerials` VALUES(181, 'Matthew', 13, 9, 'Matthew 13:9-He who has ears [to hear], let him hear (listen, consider, perceive and comprehend).', 'Matthew 13:9');
INSERT INTO `scripturematerials` VALUES(182, 'Matthew', 13, 10, 'Matthew 13:10-Then the disciples came to Him and said, Why do You speak to them in parables?', 'Matthew 13:10');
INSERT INTO `scripturematerials` VALUES(183, 'Matthew', 13, 11, 'Matthew 13:11-And He replied to them, To you it has been given to know the secrets and mysteries of the kingdom of heaven, but to them it has not been given.', 'Matthew 13:11');
INSERT INTO `scripturematerials` VALUES(184, 'Matthew', 13, 12, 'Matthew 13:12-For whoever has [spiritual knowledge], to him will more be given and he will be furnished richly so that he will have abundance; but from him who has not, even what he has will be taken away.', 'Matthew 13:12');
INSERT INTO `scripturematerials` VALUES(185, 'Matthew', 13, 13, 'Matthew 13:13-This is the reason that I speak to them in parables: because having the power of seeing, they do not see; and having the power of hearing, they do not hear, nor do they grasp and understand.', 'Matthew 13:13');
INSERT INTO `scripturematerials` VALUES(186, 'Matthew', 13, 14, 'Matthew 13:14-And in them is fulfilled the prophecy of Isaiah, which says: You shall indeed hear and hear but never grasp and understand; and you shall indeed look but never see and perceive [Isaiah 6:9].', 'Matthew 13:14');
INSERT INTO `scripturematerials` VALUES(187, 'Matthew', 13, 15, 'Matthew 13:15-For this nation''s heart has grown gross (fat and dull), and their ears heavy and difficult of hearing, and their eyes they have tightly closed, lest they see and perceive with their eyes, and hear and comprehend the sense with their ears, and grasp and understand with their heart, and turn and I should heal them [Isaiah 6:9-10].', 'Matthew 13:15');
INSERT INTO `scripturematerials` VALUES(188, 'Matthew', 13, 16, 'Matthew 13:16-But blessed are your eyes because they do see, and your ears because they do hear.', 'Matthew 13:16');
INSERT INTO `scripturematerials` VALUES(189, 'Matthew', 13, 17, 'Matthew 13:17-Truly I tell you, many prophets and righteous men yearned to see what you see, and did not see it, and to hear what you hear, and did not hear it.', 'Matthew 13:17');
INSERT INTO `scripturematerials` VALUES(190, 'Matthew', 13, 18, 'Matthew 13:18-Listen then to the meaning of the parable of the sower:', 'Matthew 13:18');
INSERT INTO `scripturematerials` VALUES(191, 'Matthew', 13, 19, 'Matthew 13:19-When anyone hears the Word of the Kingdom and does not grasp and comprehend it, the evil one comes and snatches away what was sown in his heart. This is what was sown along the roadside.', 'Matthew 13:19');
INSERT INTO `scripturematerials` VALUES(192, 'Matthew', 13, 20, 'Matthew 13:20-As for what was sown on thin (rocky) soil, this is he who hears the Word and at once welcomes and accepts it with joy;', 'Matthew 13:20');
INSERT INTO `scripturematerials` VALUES(193, 'Matthew', 13, 21, 'Matthew 13:21-Yet it has no real root in him, but is temporary; and when affliction or trouble or persecution comes on account of the Word, at once he is caused to stumble [he is repelled and begins to distrust and desert Him Whom he ought to trust and obey] and he falls away.', 'Matthew 13:21');
INSERT INTO `scripturematerials` VALUES(194, 'Matthew', 13, 22, 'Matthew 13:22-As for what was sown among thorns, this is he who hears the Word, but the cares of the world and the pleasure and delight and glamour and deceitfulness of riches choke and suffocate the Word, and it yields no fruit.', 'Matthew 13:22');
INSERT INTO `scripturematerials` VALUES(195, 'Matthew', 13, 23, 'Matthew 13:23-As for what was sown on good soil, this is he who hears the Word and grasps and comprehends it; he indeed bears fruit and yields in one case a hundred times as much as was sown, in another sixty times as much, and in another thirty.', 'Matthew 13:23');
INSERT INTO `scripturematerials` VALUES(196, 'Matthew', 13, 24, 'Matthew 13:24-Another parable He set forth before them, saying, The Kingdom of Heaven is like a man who sowed good seed in his field.', 'Matthew 13:24');
INSERT INTO `scripturematerials` VALUES(197, 'Matthew', 13, 25, 'Matthew 13:25-But while men slept, his enemy came and sowed darnel (weeds resembling wheat) among the wheat, and went his way.', 'Matthew 13:25');
INSERT INTO `scripturematerials` VALUES(198, 'Matthew', 13, 26, 'Matthew 13:26-So when the plants sprouted and formed grain, the darnel (weeds) appeared also.', 'Matthew 13:26');
INSERT INTO `scripturematerials` VALUES(199, 'Matthew', 13, 27, 'Matthew 13:27-And the servants of the owner came to him and said, Sir, did you not sow good seed in your field? Then how does it have darnel shoots in it?', 'Matthew 13:27');
INSERT INTO `scripturematerials` VALUES(200, 'Matthew', 13, 28, 'Matthew 13:28-He replied to them, An enemy has done this. The servants said to him, Then do you want us to go and weed them out?', 'Matthew 13:28');
INSERT INTO `scripturematerials` VALUES(201, 'Matthew', 13, 29, 'Matthew 13:29-But he said, No, lest in gathering the wild wheat, you root up the true wheat along with it.', 'Matthew 13:29');
INSERT INTO `scripturematerials` VALUES(202, 'Matthew', 13, 30, 'Matthew 13:30-Let them grow together until the harvest; and at harvest time I will say to the reapers, Gather the darnel first and bind it in bundles to be burned, but gather the wheat into my granary.', 'Matthew 13:30');
INSERT INTO `scripturematerials` VALUES(203, 'Matthew', 13, 31, 'Matthew 13:31-Another story by way of comparison He set forth before them, saying, The Kingdom of Heaven is like a grain of mustard seed, which a man took and sowed in his field.', 'Matthew 13:31');
INSERT INTO `scripturematerials` VALUES(204, 'Matthew', 13, 32, 'Matthew 13:32-Of all the seeds it is the smallest, but when it has grown it is the largest of the garden herbs and becomes a tree, so that the birds of the air come and find shelter in its branches.', 'Matthew 13:32');
INSERT INTO `scripturematerials` VALUES(205, 'Matthew', 13, 33, 'Matthew 13:33-He told them another parable: The Kingdom of Heaven is like leaven which a woman took and covered over in three measures of meal or flour till all of it was leavened.', 'Matthew 13:33');
INSERT INTO `scripturematerials` VALUES(206, 'Matthew', 13, 34, 'Matthew 13:34-These things all taken together Jesus said to the crowds in parables; indeed, without a parable He said nothing to them.', 'Matthew 13:34');
...
INSERT INTO `sefunmiadewunmiscores` VALUES(68, '2017-07-28', 'Talent is Never Enough 1', 'Online Quiz', 'John C Maxwell', 250, 12, '20.825', 'sefunmiadewunmiscores', '832.677');
...
INSERT INTO `timilehinadeosunscores` VALUES(92, '2017-07-28', 'Talent is Never Enough 1', 'Online Quiz', 'John C Maxwell', 180, 14, '12.852', 'timilehinadeosunscores', '1524.794');
...
INSERT INTO `worshipquestions` VALUES(32, 'You called _______', 'Single Answer', 'out,forth', 'out');
INSERT INTO `worshipquestions` VALUES(33, 'into ________', 'Single Answer', 'light,darkness', 'darkness');
INSERT INTO `worshipquestions` VALUES(34, 'You reached ________', 'Single Answer', 'down,out', 'down');
INSERT INTO `worshipquestions` VALUES(35, 'To save _____', 'Single Answer', 'me,us', 'us');
INSERT INTO `worshipquestions` VALUES(36, 'You conquered the grave, you crossed ________', 'Single Answer', 'death,the divide', 'the divide');
INSERT INTO `worshipquestions` VALUES(37, 'Lost in our sin, You made us _______', 'Single Answer', 'anew,alive', 'alive');
INSERT INTO `worshipquestions` VALUES(38, 'How can we ever hold it inside, we can''t _______', 'Single Answer', 'deny,hold back', 'hold back');
INSERT INTO `worshipquestions` VALUES(39, 'We''re gonna lift You _______', 'Single Answer', 'higher,higher higher', 'higher higher');
INSERT INTO `worshipquestions` VALUES(40, 'Hearts burning like a _______', 'Single Answer', 'fire,fire fire', 'fire fire');
INSERT INTO `worshipquestions` VALUES(41, 'Voices unite, make it ______', 'Single Answer', 'louder,louder louder', 'louder louder');
INSERT INTO `worshipquestions` VALUES(42, 'We''re never gonna stop _________', 'Single Answer', 'dancing,singing,shouting', 'singing');
INSERT INTO `worshipquestions` VALUES(43, 'Set free, No longer bound ______', 'Single Answer', 'with chains,in chains', 'in chains');
INSERT INTO `worshipquestions` VALUES(44, 'You rescued me, and called ________', 'Single Answer', 'my name,me by name', 'me by name');
INSERT INTO `worshipquestions` VALUES(45, 'Every _______, every tongue, every heart will sing', 'Single Answer', 'culture,nation,tribe', 'tribe');
INSERT INTO `worshipquestions` VALUES(46, 'Ever knee, we will bow to the _________', 'Single Answer', 'resurrected King,risen King', 'risen King');
INSERT INTO `worshipquestions` VALUES(47, '_________, We''re never gonna stop singing', 'Single Answer', 'Lift Him up,Lift Him up Lift Him up', 'Lift Him up Lift Him up');
