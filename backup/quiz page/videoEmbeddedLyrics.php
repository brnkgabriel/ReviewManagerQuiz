				...
				<div class="panel-body"> 
					...
					<div id="myTabContent" class="tab-content"> 
						<div class="tab-pane fade table-responsive" id="worship">
							...
							<p>Title: <strong>Say the Word</strong></p>
							<p>By: <strong>Taya Smith</strong></p>
							<p>Location: <strong>Hillsong Church Australia</strong></p>
                            <p><iframe width="560" height="315" src="https://www.youtube-nocookie.com/embed/JDOoSzvILHs?list=PLFzgN2iKn8bT6SP4MGQ7FHDkT4s_Fj3Qp" frameborder="0" allowfullscreen></iframe></p>        								
						...
						<div class="tab-pane fade table-responsive" id="message">
							<?php 	if($quizSettings['details'] === 'Materials'){ ?>
                                <p>Title: <strong>The Stronghold of Faith</strong></p>
        						<p>By: <strong>Bishop David Oyedepo</strong></p>
                                <p>Type: <strong>Faith</strong></p> 
                                <p class="table-responsive"><iframe width="560" height="315" src="https://www.youtube-nocookie.com/embed/Ca7IHkS80rY?list=PLFzgN2iKn8bT6SP4MGQ7FHDkT4s_Fj3Qp" frameborder="0" allowfullscreen></iframe></p>																			
							<?php	}else if($quizSettings['details'] === 'Questions'){  // questions?>
							<div class="row">
								<div class="col-md-6 col-md-offset-3">
									<form id="messageForm"> 
