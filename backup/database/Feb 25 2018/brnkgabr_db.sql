...
--
-- Host: localhost
-- Generation Time: Feb 26, 2018 at 08:54 PM
...
(9963, 'The Pilgrim''s Progress was written in _______', 'Single Answer', '1657,1675,1775', '1675'),
(9964, '...by John Bunyan, a poor tradesman who was jailed in _______ for preaching the Word of God', 'Single Answer', 'Manchester England,Bedford England,Texas America', 'Bedford England'),
(9965, '<strong>Bunyan:</strong> I laid down in a place to sleep and as I slept, __________', 'Single Answer', 'I had a nightmare,I dreamed a dream', 'I dreamed a dream'),
(9966, '<strong>Bunyan:</strong> I saw a man with a great burden on his back reading _______', 'Single Answer', 'the bible,a book', 'a book'),
(9967, '<strong>Bunyan:</strong> I saw that visions of a coming fire haunted the man called _______', 'Single Answer', 'Hopeful,Christian,Faithful,Pliable', 'Christian'),
(9968, '<strong>Christian''s Wife:</strong> Are you still _______ that book?', 'Single Answer', 'into,reading', 'reading'),
(9969, '<strong>Christian:</strong> Actually, yes, it makes ________', 'Single Answer', 'a lot of sense,sense', 'a lot of sense'),
(9970, '<strong>Christian''s Wife:</strong> You told me that that book _______ you when, you''re still reading it I thought you were gonna stop.', 'Single Answer', 'disturbs,upsets,troubles', 'upsets'),
(9971, '<strong>Christian:</strong> I know I just can''t _________', 'Single Answer', 'drop it,put it down', 'put it down'),
(9972, '<strong>Christian''s Wife:</strong> So what did you ______ today?', 'Single Answer', 'study,read about,read', 'read about'),
(9973, '<strong>Christian:</strong> Well I know this is gonna sound a little crazy, and I wouldn''t say this unless I knew it to be ______,', 'Single Answer', 'true,the truth', 'the truth'),
(9974, '<strong>Christian:</strong> But today I read that <strong>our city is gonna be destroyed by fire.</strong> What bible verse verifies the highlighted phrase?', 'Single Answer', '2Peter 3:10,2Peter 3:12,all of the above', 'all of the above'),
(9975, '<strong>Christian:</strong> We''re all gonna die, unless, I find a way for us to escape. <strong>Salvation is the way for man to escape the corruption that is in the world through lust.</strong> What bible verse the highlighted statement?', 'Single Answer', '2Peter 1:4,Hebrews 2:3,all of the above', 'all of the above'),
(9976, '<strong>Christian:</strong> I love you all very much, more than anything, and I will not stop until I find this place of refuge, this place of ______ joy that this book talks about.', 'Single Answer', 'pure,real,true', 'pure'),
(9977, '<strong>Christian''s Wife:</strong> I want you to stop reading this book! It''s nothing but stories, ________, fairy tales. It''s not real.', 'Single Answer', 'novels,fictions,fantasies', 'fantasies'),
(9978, '<strong>Christian''s Wife:</strong> Christian, I am real, our children are real, and I don''t want you to upset them with this crazy talk about the ________', 'Single Answer', 'destruction of our city,end of the world', 'end of the world'),
(9979, '<strong>Christian:</strong> I am not gonna stand by here and wait for us to die. Right and this burden just gets bigger and bigger. The more an unsaved person finds out the knowledge of the Truth the more his heart (burden) gets heavier until he comes to the point of salvation. True or False?', 'Single Answer', 'True,False', 'True'),
(9980, '<strong>Christian:</strong> I have to find a way to ________, and to save our family, that''s the truth of this.', 'Single Answer', 'remove it,get it off,get rid of it', 'get rid of it'),
(9981, '<strong>Christian''s Wife:</strong> Then let us help you get rid of your burden. I have called ________ that I think that maybe you should talk to. The moment a person is on his way to salvation, his unsaved friends or family will offer him a compromise so he doesn''t leave them.', 'Single Answer', 'an expert,someone', 'someone'),
(9982, '<strong>John Bunyan:</strong> In my dream I saw that the great burden and the visions of the coming _______ made it difficult for Christian to sleep.', 'Single Answer', 'fire,destruction', 'destruction'),
(9983, '<strong>John Bunyan:</strong> Day after day, Christian walked the neighborhood, _______ his book. He prayed earnestly for the answer that would save them all.', 'Single Answer', 'meditating on,reading,studying', 'studying'),
(9984, '<strong>John Bunyan:</strong> In my dream, I saw that his family would not listen to him. His family refused to __________ the truth.', 'Single Answer', 'realize,open their eyes to', 'open their eyes to'),
(9985, '<strong>John Bunyan:</strong> In my dream, I saw that his family would not listen to him. His family refused to open their eyes to the truth. The Christian life is an individual walk. Each person will give account to God for the way he or she has lived his or her life, family absent?', 'Single Answer', 'True,False', 'True'),
(9986, '<strong>John Bunyan:</strong> Like so many, <strong>they were blinded by the things of this world.</strong> What bible verse verifies the highlighted statement?', 'Single Answer', '1Corinthians 4:4,2Corinthians 4:4,Romans 4:4', '2Corinthians 4:4'),
(9987, '<strong>Christian:</strong> What ________?', 'Single Answer', 'am I supposed to do,do You want me to do', 'do You want me to do'),
(9988, '<strong>Evangelist:</strong> What seems to be the ________?', 'Single Answer', 'challenge,problem,issue', 'problem'),
(9989, '<strong>Christian:</strong> I can''t find a way to save my family from the coming ________! We''re not ready to die.', 'Single Answer', 'destruction,fire,fires', 'fires'),
(9990, '<strong>Evangelist:</strong> Not ready to die? Well with all the evil in the world, wouldn''t it be _______, to get away from it all?', 'Single Answer', 'better,a good thing', 'a good thing'),
(9991, '<strong>Christian:</strong> If I die, my family dies, and this _______ is dragging me to hell.', 'Single Answer', 'weight,burden,heartache,guilt', 'burden'),
(9992, '<strong>Christian:</strong> Run from the wrath to come. What bible verse has the statement?', 'Single Answer', 'Matthew 3:7,Mark 3:7,Luke 3:7,John 3:7', 'Matthew 3:7'),
(9993, '<strong>Evangelist:</strong> Over there. You see the gate? If you look hard enough, you''ll see a ________.', 'Single Answer', 'beaming light,shining light,light', 'shining light'),
(9994, '<strong>Evangelist:</strong> Then run to it, and don''t look back. What bible verse talks about a person looking back when he makes his decision to seek the Kingdom of God.', 'Single Answer', 'Matthew 9:62,Mark 9:62,Luke 9:62,John 9:62', 'Luke 9:62'),
(9995, '<strong>John Bunyan:</strong> So Christian ran with all his might to the ______ that would lead him to the gate.', 'Single Answer', 'route,path,road', 'path'),
(9996, '<strong>By Stander:</strong> Keep running you freak. <strong>Those who live godly in Christ Jesus will suffer persecution</strong> because they refuse to fit in to the crowd. They''re lead by the Holy Spirit not by what everybody else is doing. What bible verse  has the highlighted statement?', 'Single Answer', '1Timothy 3:12,2Timothy 3:12,Titus 3:12', '2Timothy 3:12'),
(9997, '<strong>John Bunyan:</strong> But two of his friends, Obstinate and Pliable, were determined to bring him back. They caught up with him ________ he reached the path.', 'Single Answer', 'before,just before', 'just before'),
(9998, '<strong>Christian:</strong> Why are you _________ me?', 'Single Answer', 'disturbing,stopping', 'stopping'),
(9999, '<strong>Obstinate:</strong> Because, we want to try to talk ______ you!', 'Single Answer', 'to,some sense into', 'some sense into'),
(10000, '<strong>Christian:</strong> You want me to ________ to the city of Destruction?', 'Single Answer', 'return,go back', 'go back'),
(10001, '<strong>Christian:</strong> Now think about it, the _______ of our city should make you want to run with me!', 'Single Answer', 'name,very name', 'very name'),
(10002, '<strong>Obstinate:</strong> That''s nonsense! It''s a name Christian, that''s all it is, it''s a name. Listen I''ve heard all the stories too. Someone may have heard all about salvation, but if he hasn''t put what he heard into action he is not saved. What bible verse verifies this?', 'Single Answer', 'James 2:14,James 2:17,James 2:20,all of the above', 'all of the above'),
(10003, '<strong>Obstinate:</strong> You know you go wandering around back there, we go with you we''re all gonna die! People may have good intention, if they''re not following God''s Word they''ll lead us off the right path. Our safest guide in life is the bible. True or False?', 'Single Answer', 'True,False', 'True'),
(10004, '<strong>Christian:</strong> We''re all gonna die anyway, right? That''s the right way to think. Everybody is going to die. Therefore life is about how each person wants to die. True or False?', 'Single Answer', 'True,False', 'True'),
(10005, '<strong>Obstinate:</strong> Even if you got past the Swamp of ________, even if you got that far there are creatures out there that will rip the flesh from your bones,', 'Single Answer', 'Despond,Despair', 'Despond'),
(10006, '<strong>Obstinate:</strong> not to mention the king of all demons, ________', 'Single Answer', 'apollyon,devil,satan', 'apollyon'),
(10007, '<strong>Obstinate:</strong> You''ve got everything a person could ever want in this world, you''ve got a _______ home, you''ve got a wife that loves you, kids that adore you. Nothing in this world can satisfy that heart hunger in man except God. That''s why it''s like people never get satisfied. Always wanting more. They get content when they find God.', 'Single Answer', 'wonderful,beautiful', 'beautiful'),
(10008, '<strong>Christian:</strong> No no no wait, it''s a facade, okay? Come with me and you''ll experience real life, real joy, nothing will compare to what you''ll be rewarded with if you follow this path. Life is summarized into a decision to either satisfy the flesh or the spirit, not both. What bible verse verifies this?', 'Single Answer', '1Corinthians 5:17,Galatians 5:17,Romans 5:17', 'Galatians 5:17'),
(10009, '<strong>Obstinate:</strong> I''m not interested in the book, Christian! True believers are interested in what God''s Word says, because they know when it''s all said and done, <strong>the counsel (Word) of the LORD will stand.</strong> What bible verse has the highlighted statement?', 'Single Answer', 'Psalms 33:11,Proverbs 19:21,all of the above', 'all of the above'),
(10010, '<strong>Pliable:</strong> Can you tell me some more about this Kingdom we''re ________?', 'Single Answer', 'going to,headed towards', 'headed towards'),
(10011, '<strong>Pliable:</strong> What about that book? You really ________ everything that''s written in there is true?', 'Single Answer', 'think,believe,know', 'believe'),
(10012, '<strong>Christian:</strong> Like, we''re gonna be given eternal life in a kingdom of pure joy, we''ll be given crowns of ______, and clothes that will shine like the sun.', 'Single Answer', 'glory,honor', 'glory'),
(10013, '<strong>Christian:</strong> and there''ll be no more _____ for the owner of the place will wipe away every one.', 'Single Answer', 'tears,weeping,cries', 'tears'),
(10014, '<strong>Pliable:</strong> Will there be _______ there?', 'Single Answer', 'people,others,other people', 'others'),
(10015, '<strong>Christian:</strong> Oh, angels that will dazzle the eyes to look upon, thousands and thousands of others that will _______ before us that are loving and joyful.', 'Single Answer', 'be,have been there', 'have been there'),
(10016, '<strong>Pliable:</strong> But when we get there how do we ______?', 'Single Answer', 'get in,enter,gain access', 'get in'),
(10017, '<strong>Christian:</strong> Well, it says in this book that <strong>if we''re truly willing to receive it, it will be given to us freely. </strong> What bible verse verifies the highlighted statement?', 'Single Answer', 'Jeremiah 29:13,John 7:37-39,Isaiah 55:1,all of the above', 'all of the above'),
(10018, '<strong>John Bunyan:</strong> I saw Christian and Pliable press forward, talking of the wonders of the Celestial City, not paying __________ to the path, and where they were walking.', 'Single Answer', 'close attention,much attention,attention', 'much attention'),
(10019, '<strong>Christian:</strong> Why isn''t it more clearly marked or better _________?', 'Single Answer', 'developed,maintained,outlined', 'maintained'),
(10020, '<strong>Help:</strong> Sin! Those pipes are just full of it. But when the Spirit of God begins to awaken those to their sinful conditions, they''re overcome with fear, along with _________ discouraging thoughts,', 'Single Answer', 'a lot,numerous,countless', 'countless'),
(10021, '<strong>Help:</strong> and it all ends up right there. But the King has provided a way out. _______ on the path, you''re gonna be just fine.', 'Single Answer', 'Just stay,You just stay', 'You just stay'),
(10022, '<strong>Worldly Wise:</strong> I''ve got the solution, in fact instead of facing danger, you''ll have an easy path, friendship and contentment. <strong>Enter in at the narrow gate: for wide is the gate, and broad is the way, that leads to destruction, and many there are who go in through it: Because narrow is the gate, and narrow is the way, which leads to life, and there are few who find it.</strong> What bible portion is this?', 'Single Answer', 'Matthew 7:13,Matthew 7:14,Matthew 7:13-14', 'Matthew 7:13-14'),
(10023, '<strong>Evangelist:</strong> God says in His Word, <strong>that My just one shall live by faith.</strong> What bible verse has the highlighted statement?', 'Single Answer', 'Habakkuk 2:4,Romans 1:17,Galatians 3:11,Hebrews 10:38,all of the above', 'all of the above'),
(10024, '<strong>Evangelist:</strong> Strive to enter the narrow gate, because narrow is the gate that leads to life, and there are _______ that find it.', 'Single Answer', 'a few,few', 'few'),
(10025, '<strong>Evangelist:</strong> The King of Glory Himself said that <strong>he that will save his life, will lose it. But he that seeks after the Holy One, will save it.</strong> What bible verse verifies the highlighted statement?', 'Single Answer', 'Matthew 16:25,Mark 8:35,Luke 9:24,Luke 17:33,all of the above', 'all of the above'),
(10026, '<strong>Good-Will:</strong> This is the path. This is the way you must go. It was created by the _________, the prophets, Jesus and the disciples. It''s the only way to Heaven, the Celestial City.', 'Single Answer', 'men of God,patriarchs,saints', 'patriarchs'),
(10027, '<strong>Christian:</strong> Is it possible to get lost _______ the way?', 'Single Answer', 'on,along', 'along'),
(10028, '<strong>Good-Will:</strong> Oh there are many ways off the path, because there are so many _______. But you''ll know the right way from the wrong way, because you''ll always stay on the narrow path.', 'Single Answer', 'traps,temptations,tests', 'temptations'),
(10029, '<strong>Good-Will:</strong> as when you reach the place of _________, that burden will fall off by itself.', 'Single Answer', 'freedom,deliverance,salvation', 'deliverance'),
(10030, '<strong>Interpreter:</strong> this parlor represents the heart which has never been cleansed by the grace of the gospel. The grace of the gospel is the message that Jesus freely paid for our sin and offers us eternal life which is relationship with God. True or False?', 'Single Answer', 'True,False', 'True'),
(10031, '<strong>Interpreter:</strong> The dust is original sin which continues to corrupt and destroy the soul. The original sin is the lust which leads to the corruption in this world. What bible verse verifies this?', 'Single Answer', '1Peter 1:4,2Peter 1:4,1John 1:4', '2Peter 1:4'),
(10032, '<strong>Interpreter:</strong> The man represents the law, which instead of cleansing the heart only gives sin its strength. The reason the law gives sin it''s strength is because it focuses the attention of man on the sin and whatever we focus our attention on grows. That''s why the bible says <strong>magnify the LORD.</strong> We do that by focusing our attention on God. As we do, God becomes big in our perception of Him. What bible verse has the highlighted?', 'Single Answer', 'Ezekiel 38:23,Psalms 34:3,Zechariah 12:7', 'Psalms 34:3'),
(10033, '<strong>Interpreter:</strong> The woman who sprinkled the water represents the gospel which is able to overcome sin in our lives. Gospel is <strong>the goodness of God that leads people to repentance.</strong> What bible verse is the highlighted?', 'Single Answer', 'Ephesians 2:4,Romans 2:4,Philippians 2:4', 'Romans 2:4'),
(10034, '<strong>Interpreter:</strong> Once the heart is clean, it''s _______ for the King of Glory to come in and live.', 'Single Answer', 'acceptable,fit,suitable', 'fit'),
(10035, '<strong>Interpreter:</strong> The palace represents ________. There are few with the courage to face the challenge.', 'Single Answer', 'the Kingdom of God,Heaven,the Celestial City', 'Heaven'),
(10036, '<strong>Interpreter:</strong> Tell this man why you''re so __________', 'Single Answer', 'fretful,frightened,afraid', 'frightened'),
(10037, '<strong>Interpreter:</strong> So, what do you think of all ________?', 'Single Answer', 'you''ve seen,that I''ve shown you', 'that I''ve shown you'),
(10038, '<strong>Christian:</strong> That there''s _______ hope, and _______ fear.', 'Single Answer', 'serious-serious,great-great,enormous-enormous', 'great-great'),
(10039, '<strong>Interpreter:</strong> Store all of these things in your heart. And remember, the <strong>Comforter</strong> will always be there to guide you on your way to heaven. Another name for the <strong>Comforter</strong> is?', 'Single Answer', 'Jesus Christ,God the Father,The Holy Spirit', 'The Holy Spirit'),
(10040, '<strong>Christian:</strong> Thank You! You have given me rest by Your ________, and life by Your death', 'Single Answer', 'Son,sorrow', 'sorrow'),
(10041, '<strong>Angel:</strong> Peace be with you. Your sins are _________', 'Single Answer', 'forgiven,pardoned,remitted', 'forgiven'),
(10042, '<strong>Angel:</strong> Study these words, as they will give you strength for the journey. You must present this at the gates of __________. Guard it with your life.', 'Single Answer', 'the Kingdom of God,Heaven,the Celestial City', 'the Celestial City'),
(10043, '<strong>Angel:</strong> Study these words, as they will give you strength for the journey. You must present this at the gates of the Celestial City. Guard it with your life. When we are saved we''re given God''s Word and sealed with the Holy Spirit who is the earnest (assurance) of our salvation as represented by the sealed scroll. What bible portion verifies this?', 'Single Answer', '2Corinthians 1:22,2Corinthians 5:5,Ephesians 1:13-14,all of the above', 'all of the above'),
(10044, '<strong>John Bunyan:</strong> With his certificate in hand, he was sure of Heaven. <strong>The Holy Spirit bears witness with our spirit (which is our certificate) that we are the children of God.</strong> What bible verse is the highlighted?', 'Single Answer', 'Romans 8:1,Romans 8:16,Ephesians 8:16', 'Romans 8:16'),
(10045, '<strong>John Bunyan:</strong> Not far away, two men were also making their way to the path. He was about to stumble upon _________, and Hypocrisy.', 'Single Answer', 'Legalist,Formalist,Civilist', 'Formalist'),
(10046, '<strong>John Bunyan:</strong> ...two happy-go-lucky characters who were blazing their own path to Heaven. There''s just one path to Heaven. It''s a narrow path and obedience to God''s Word is the path. True or False?', 'Single Answer', 'True,False', 'True'),
(10047, '<strong>Christian:</strong> ...isn''t it written that those who don''t enter through the door will be seen as thieves and robbers? What bible portion verifies this?', 'Single Answer', 'Matthew 10:1,Mark 10:1,Luke 10:1,John 10:1', 'John 10:1'),
(10048, '<strong>Formalist:</strong> And if you knew how far it was to the gate, from where we live, you''d be taking the ________ as well.', 'Single Answer', 'easy road,shortcut', 'shortcut'),
(10049, '<strong>John Bunyan:</strong> Now Formalist and Hypocrisy were in the habit of taking what they thought would be the easy way. There''s no shortcut in life. True or False?', 'Single Answer', 'True,False', 'True'),
(10050, '<strong>Watchful:</strong> You have nothing to _______, they are here to test your faith. IF you stay on the path, you''ll be fine. Everyone''s faith in God will be tested, if we stay on the narrow path, we''ll be fine.', 'Single Answer', 'be scared of,fear,be afraid of', 'fear'),
(10051, '<strong>Watchful:</strong> This house was built by the Lord of the hill to provide relief for pilgrims on their journey to the Celestial City. The fellowship of believers was built by the Lord to provide relief for pilgrims on their journey to the Celestial City. The word relief means _______', 'Single Answer', 'release from anxiety,reassurance,release from distress,all of the above', 'all of the above'),
(10052, '<strong>Watchful:</strong> ...but whether or not you stay here depends on the ________ of the house. The names of the ______ of the house are: Discretion, Piety, Prudence & Charity (God''s kind of love)', 'Single Answer', 'men,ladies', 'ladies'),
(10053, '<strong>Discretion:</strong> Why did you become a _________', 'Single Answer', 'Christian,Pilgrim,Believer', 'Pilgrim'),
(10054, '<strong>Christian:</strong> To find a way for me and my family to escape the fires to come. Most people become believers to escape hell. That''s a good reason but the ultimate of a believer is to have eternal life (The abundant life, or God''s kind of life). What bible verse verifies this?', 'Single Answer', 'Matthew 3:16,Mark 3:16,Luke 3:16,John 3:16', 'John 3:16'),
(10055, '<strong>Piety:</strong> Is that the only reason that you seek __________, to escape the fires of hell?', 'Single Answer', 'the Kingdom of God,Heaven,the Celestial City', 'the Celestial City'),
(10056, '<strong>Christian:</strong> I wanted to see Him alive, who died for ________. I needed to get rid of the evil inside of me. I wanted to live forever in the company of those that sang holy, holy, holy is the Lord God Almighty.', 'Single Answer', 'my sins,the sins of the world', 'the sins of the world'),
(10057, '<strong>Charity:</strong> Where is your _______?', 'Single Answer', 'wife,family', 'family'),
(10058, '<strong>Christian:</strong> I tried to get them to come with me. I prayed earnestly for them. I told them how God was going to destroy the city, and that we''d all face judgment. They wouldn''t hear me. Sometimes the most difficult people to reach out to are our family members. What bible verse verifies this?', 'Single Answer', 'Mark 6:4,Matthew 10:36,all of the above', 'all of the above'),
(10059, '<strong>Prudence:</strong> I believe you did everything in your power to _______ your family to come with you on this journey.', 'Single Answer', 'persuade,tell,convince', 'convince'),
(10060, '<strong>John Bunyan:</strong> In my dream, I saw that it would not be long before Christian would have use for his ________, as he would enter the valley of humiliation.', 'Single Answer', 'kit,sword,armor,armor and sword', 'armor and sword'),
(10061, '<strong>Christian:</strong> Your wages are too great for any man, for the wages of sin is death. <strong>What bible verse has the highlighted statement</strong>?', 'Single Answer', 'Romans 3:23,Romans 6:23,Romans 8:23', 'Romans 6:23'),
(10062, '<strong>Apollyon:</strong> I don''t like to lose any of my subjects, and since you complain about the _______, I promise to pay you handsomely, if you turn and go back to my country. If the devil can''t stop us from getting saved, he''ll offer us a compromise to live the way we used to live before we got saved.', 'Single Answer', 'reward,wages,salary', 'wages'),
(10063, 'We need the whole armor of God to be able to withstand the wiles (deception) of the devil. What bible verse verifies this?', 'Single Answer', 'Ephesians 6:10,Ephesians 6:11,Ephesians 6:12', 'Ephesians 6:11'),
(10064, '<strong>Christian:</strong> The trials and tribulations are to test and ________ our faith.', 'Single Answer', 'increase,strengthen,toughen', 'strengthen'),
(10065, '<strong>Apollyon:</strong> To strengthen your faith? You''ve already been unfaithful to him from the very ________!', 'Single Answer', 'get go,start,beginning', 'beginning'),
(10066, '<strong>Apollyon:</strong> Do you not remember how you almost drowned in the Swamp of Despond? When the devil sees we''re not turning our back on God but choose to follow Him. He''ll remind us of the mistakes we made in our pursuit of God. True or False?', 'Single Answer', 'True,False', 'True'),
(10067, '...The Sword of the Spirit is the Word of God. It is our only offensive weapon. We can''t deal with the devil without an experiential or a working knowledge of God''s Word. What bible verse talks about God''s Word as the Sword of the Spirit?', 'Single Answer', 'Ephesians 6:16,Ephesians 6:17,Ephesians 6:18', 'Ephesians 6:17'),
(10068, 'We must remove turning back if we''re to make it to God''s Kingdom (Heaven or the Celestial City or our Rights and Privileges in God). What bible verse verifies this?', 'Single Answer', 'Luke 9:62,Matthew 24:13,all of the above', 'all of the above'),
(10069, '<strong>Christian:</strong> Yea, <strong>though I walk through the valley of the shadow of death...</strong> Again, a working knowledge of God''s Word is our only through the valley of the shadow of death. What bible verse has the highlighted portion?', 'Single Answer', 'Psalm 23:4,Psalms 23:1,Psalms 23:5,Psalms 23:4', 'Psalms 23:4'),
(10070, '... as we speak God''s Word, light comes from the Holy Spirit in our spirit to clear path for us. True or False?', 'Single Answer', 'True,False', 'True'),
(10071, '<strong>Faithful:</strong> I resisted her temptation by remembering the proverb, <strong>her feet go down to death, her steps take hold on hell.</strong> What bible verse is the highlighted?', 'Single Answer', 'Proverbs 5:1,Proverbs 5:5,Proverbs 10:5', 'Proverbs 5:5'),
(10072, '<strong>Faithful:</strong> I met a guy by the name of Adam the First. Most Adam the First people are natural minded people. If you filter their motive for doing things, it boils down to three things. Lust of the Flesh, Lust of the Eyes, Pride of Life. True or False?', 'Single Answer', 'True,False', 'True'),
(10073, '<strong>Faithful:</strong> ...put off the old man and his deeds. What bible verse has Faithful''s statement?', 'Single Answer', 'Colossians 3:9,Ephesians 4:22,all of the above', 'all of the above'),
(10074, '<strong>Faithful:</strong> I knew his _______ was to get me to his house, so that he could sell me into a life of slavery. Slavery is the end result of going for the Lust of the Flesh, the Lust of the Eyes and the Pride of life.', 'Single Answer', 'intention,goal,aim,purpose,motive', 'goal'),
(10075, '<strong>Evangelist:</strong> And remember, there is a crown of life laid out before you. So run that you may obtain it, and don''t give up. Where in the bible can we find the <strong>Crown of Life</strong>?', 'Single Answer', 'James 1:12,Revelation 2:10,all of the above', 'all of the above'),
(10076, '<strong>Evangelist:</strong> ...because the heart itself is desperately wicked. Which part of the heart is desperately wicked.', 'Single Answer', 'The Soul (the Renewed Mind),The Soul (the Unrenewed Mind),The Spirit (The Born-Again Spirit),The Spirit (The Dead Spirit),2nd and 4th options,all of the above', '2nd and 4th options'),
(10077, '<strong>Evangelist:</strong> ...because the heart itself is desperately wicked. What bible verse verifies this?', 'Single Answer', 'Isaiah 17:9,Jeremiah 17:9,Ezekiel 17:9', 'Jeremiah 17:9'),
(10078, '<strong>Evangelist:</strong> ...Remember you''ve got all the powers of Heaven and Earth on your side. What bible verse verifies this?', 'Single Answer', 'Matthew 28:17,Matthew 28:18,Matthew 28:19', 'Matthew 28:18'),
(10079, '<strong>Evangelist:</strong> ...but now you''re about to leave this ______, into a town that''s full of great enemies, that will do everything in their power, to kill you.', 'Single Answer', 'jungle,wilderness,forest', 'wilderness'),
(10080, '<strong>Evangelist:</strong> ...but now you''re about to leave this wilderness, into a town that''s full of great enemies, that will do everything in their power, to kill you. At salvation God takes us from Egypt (the World) into the Wilderness. The wilderness is designed by God to take away the mentality of the world from our mind so we can live in Canaan (Promised land). In Canaan we''re going to fight just like the Children of Israel did, that''s the reason David had to fight Goliath. True or False?', 'Single Answer', 'True,False', 'True'),
(10081, '<strong>Judge of Vanity Fair:</strong> ...which is strictly prohibited by the laws of _______, our prince.', 'Single Answer', 'apollyon,demon,beelzebub,satan', 'beelzebub'),
(10082, '<strong>Judge of Vanity Fair:</strong> ...which is strictly prohibited by the laws of beelzebub, our prince. beelzebub means lord of the flies (demons). Flies (demons) are attracted to pollution (ungodliness like bad attitudes and sin). True or False?', 'Single Answer', 'True,False', 'True'),
(10083, '<strong>Faithful:</strong> ...any worship that is built in the faith in oneself, and not in the faith in God, is worthless. Worship is giving one''s time, energy, resources and attention to something. If we''re giving more time, energy, resources and attention to ourselves instead of God, we''re worshiping ourselves and it''s worthless. True or False?', 'Single Answer', 'True,False', 'True'),
(10084, 'In the dark ages (within year 500-1500), the bible wasn''t available as it is today. People died to put it in print. They were burned with fire just like ________', 'Single Answer', 'Christian,Hopeful,Faithful', 'Faithful'),
(10085, '<strong>John Bunyan:</strong> Now in my dream, I saw that Christian and his new companion Hopeful were moving quickly along the path, until it became _______ on their feet. Rocky or hard ground represents resistance. On our way to live our lives for God, we''ll meet resistance. We shouldn''t seek the easy way out but endure till we get to our destination.', 'Single Answer', 'rocky,rocky and hard,hard', 'rocky and hard'),
(10086, '<strong>Christian:</strong> Hello. where does this way _______?', 'Single Answer', 'go,lead', 'lead'),
(10087, '<strong>Vain Confidence:</strong> To \n __________. Never get your information from a distance, you''ll get distorted information. If you don''t think the information is healthy or safe for you, then it''s not for you. Most people go to TV to get their news, forgetting that the information will have to pass through the imperfections (bias or prejudice) of the news caster before it get to them.', 'Single Answer', 'the Kingdom of Heaven,the Celestial City,Heaven', 'the Celestial City'),
(10088, '<strong>Hopeful:</strong> Let us not forget what God has done for us. <strong>Bless the LORD, O my soul, and forget not all His benefits.</strong> What bible verse is the highlighted?', 'Single Answer', 'Psalm 103:2,Psalms 103:2', 'Psalms 103:2'),
(10089, '<strong>Christian:</strong> This is the key called promise given to me at _______. When we pray, God reminds us of the promises He gave us in His Word which unlocks whatever stranded situation we may be in.', 'Single Answer', 'the cross,salvation', 'the cross'),
(10090, '<strong>Hopeful:</strong> Is the Celestial City ________ here?', 'Single Answer', 'close to,far from', 'far from'),
(10091, '<strong>Shepherd:</strong> It''s too far for some. But for those that really want to go there, it''s not. Even in the physical meeting place we often call church, the Kingdom of God and it''s demands appear far from some people. It shows up in the way they act and it tells they don''t really want to go there. True or False?', 'Single Answer', 'True,False', 'True'),
(10092, '<strong>Christian:</strong> Can you tell us what to expect ________ to come?', 'Single Answer', 'in the time,on the path', 'on the path'),
(10093, '<strong>Shepherd:</strong> It is safe for those who are true to Emmanuel, but it is death for those who are not. Being true or honest with God is the key to safety in our walk with God. Even when we make mistakes, if we''re honest, God will work the mistake together for our good. What bible verse verifies this?', 'Single Answer', 'Romans 6:28,Romans 8:28,Romans 10:28', 'Romans 8:28'),
(10094, '<strong>Shepherd:</strong> This is the mountain called _______?', 'Single Answer', 'Error,Mistake,Difficulty', 'Error'),
(10095, '<strong>Shepherd:</strong> They are examples, a warning to those that have lost their way because of the false teaching on the ________. Remember, that Jesus has risen indeed.', 'Single Answer', 'crucifixion,resurrection', 'resurrection'),
(10096, '<strong>Shepherd:</strong> Did you notice Bypass Meadow on your journey? Unfortunately they left the path, and took the meadow to ease their journey. They were captured by giant Despair. He blinded them, forcing them to walk among the tombs, thus fulfilling the proverb, <strong>a man who strays from the path of understanding, comes to rest in the company of the dead.</strong> What bible  verse is this?', 'Single Answer', 'Proverbs 21:15,Proverbs 21:16,Proverbs 21:17,none of the above', 'Proverbs 21:16'),
(10097, '<strong>Shepherd:</strong> This is a shortcut to hell. This is a path for hypocrites, like Esau who sold his birthright, like Judas who sold his Master, or Alexander, who blasphemed the gospel. The common thing among these people is the fact that they traded the spiritual for natural. Esau (birthright for food), Judas (Jesus for money). What bible portion talks about Alexander blaspheming the gospel?', 'Single Answer', '2Timothy 1:19-20,1Timothy 1:19-20,Titus 1:19-20', '1Timothy 1:19-20'),
(10098, '<strong>Christian:</strong> Oh, thanks for the ________. When a believer gets among the company of believers, they strengthen one another and they get their ______ (an understanding of the bible) via tools like messages, audio bibles etc. so they can safely navigate through to the Kingdom of God.', 'Single Answer', 'chart,map,graph,route', 'map'),
(10099, '<strong>John Bunyan:</strong> As I dreamed, I saw that Christian and Hopeful were now in the country called _______, where they were about to meet an eager young man named Ignorance, making his own way onto the path.', 'Single Answer', 'Deceit,Conceit', 'Conceit'),
(10100, '<strong>Ignorance:</strong> No I''ll be fine. I''ve lived a good life, prayed and tithed, given money to the poor, I even _________ everything in the country just to go to the Celestial City. God is not after our good works, no matter how good they are. He''s after total surrender to Him, giving Him our heart. That''s true salvation.', 'Single Answer', 'gave up,sacrificed,laid down', 'sacrificed'),
(10101, '...a person can do all the good works in the world and his <strong>heart far from God.</strong> We can tell by his unconscious actions. Study people''s actions when they''re not aware of what they''re doing, and you''ll be able to tell if their heart is given to God or not. What bible verse has the highlighted?', 'Single Answer', 'Ezekiel 29:13,Isaiah 29:13,Jeremiah 29:13', 'Isaiah 29:13'),
(10102, '<strong>Christian:</strong> Well uh, the journey starts at the gate. The journey to live really starts when we lay down our live and desires to seek God''s Kingdom because <strong> whosoever will save his life (seek to meet his desires) will lose it: and whosoever will lose his life for My sake will find it.</strong> What bible verse is the highlighted?', 'Single Answer', 'Matthew 16:25,Mark 16:25,Luke 16:25,John 16:25', 'Matthew 16:25'),
(10103, '<strong>Christian:</strong> Without one of these, you''re not gonna get in. Christian held a sealed scroll which is a symbol of the <strong>witness of the Holy Spirit in our heart that we are the Children of God.</strong> What bible verse verifies the highlighted?', 'Single Answer', 'Romans 8:14,Romans 8:16,Romans 8:18', 'Romans 8:16'),
(10104, '<strong>Christian:</strong> The shepherds told us to beware of Flatterers! Now I know what the proverb meant when it said that <strong>a man who flatters his neighbor prepares a net for his feet!</strong> We should beware of smooth talkers. What bible verse has the highlighted statement?', 'Single Answer', 'Proverbs 27:5,Proverbs 28:5,Proverbs 29:5', 'Proverbs 29:5'),
(10105, '<strong>Hopeful:</strong> If only we would have looked at the map! I bet the answer was there all along. We should always look into the bible to make our decisions. True or False?', 'Single Answer', 'True,False', 'True'),
(10106, '<strong>Atheist:</strong> ...But after searching for it for many years I''ve come to the ________ there is no city, and there is no God.', 'Single Answer', 'conclusion,summary,realization', 'realization'),
(10107, 'When people try to find God with their heads, they come to the conclusion of an atheist. The bible wasn''t written to our heads but to our hearts. It only makes sense when we humble ourselves to receive God''s Word like \n little children. That''s why <strong>Verily I say unto you, Whosoever shall not receive the kingdom of God as a little child, he shall not enter therein.</strong> What bible verse is the highlighted?', 'Single Answer', 'Matthew 10:15,Mark 10:15,Luke 10:15,John 10:15', 'Mark 10:15'),
(10108, '<strong>Hopeful:</strong> It''s true what the proverb says, <strong>two are better than one!</strong> What bible verse has the highlighted?', 'Single Answer', 'Proverbs 4:9,Ecclesiastes 4:9', 'Ecclesiastes 4:9'),
(10109, '<strong>Hopeful:</strong> ...you mean why I decided to care for my own soul. Obeying God is taking care of our soul. True or False?', 'Single Answer', 'True,False', 'True'),
(10110, '<strong>Hopeful:</strong> ...I really didn''t until I read in the Bible that you can''t get right with God through good works, but through ________ with Jesus Christ. We must not just know Him as our Savior, He must know us. We must be willing to let Him enter every aspect of our lives. That''s when He becomes our Lord.', 'Single Answer', 'relationship,a personal relationship', 'a personal relationship'),
(10111, '<strong>Jesus Christ:</strong> I am the end of the law of righteousness to everyone that believes. When a person believes, he is no longer under the law of righteousness which controls man externally like: You shall not kill, you shall not steal. But he''s under the higher law of love that controls man internally, <strong>for the love of God constrains us.</strong> What bible verse is the highlighted?', 'Single Answer', '1Corinthians 5:14,2Corinthians 5:14,1Timothy 5:14', '2Corinthians 5:14'),
(10112, '<strong>John Bunyan:</strong> They kept themselves awake, talking about the Lord Jesus and His great love. We as believers keep ourselves spiritually awake when we talk about the Lord Jesus and His great love. True or False?', 'Single Answer', 'True,False', 'True'),
(10113, '<strong>John Bunyan:</strong> But Hopeful remembered that Jesus made all things whole. His sins were washed away. <strong>He was a new creation.</strong> What bible verse verifies this?', 'Single Answer', '1Corinthians 5:17,2Corinthians 5:17', '2Corinthians 5:17'),
(10114, '... just the way Hopeful helped Christian out from under the water, we too should help our fellow believers when we see them under the waters of life. True or False?', 'Single Answer', 'True,False', 'True'),
(10115, '<strong>Angel With Wings:</strong> I am sent to minister to those who are to inherit salvation. What bible verse verifies this?', 'Single Answer', 'Romans 1:14,Hebrews 1:14,Philippians 1:14', 'Hebrews 1:14'),
(10116, '<strong>John Bunyan:</strong> As I looked upon these things, I looked back, and saw Ignorance being rowed across the river by Vain-hope with little difficulty. Sometimes we see people that don''t know God have it easy in life compared to believers. The devil doesn''t disturb those he knows can''t make it into the Kingdom of Heaven. He only attacks those who seek God''s Kingdom that''s why <strong>from the days of John the Baptist until now the Kingdom of Heaven suffers violence, and the violent take it by force.</strong> What bible verse is this?', 'Single Answer', 'Matthew 11:12,Mark 11:12,Luke 11:12,John 11:12', 'Matthew 11:12'),
(10117, '<strong>John Bunyan:</strong> Then, I saw that there was a way to hell, even from the ______ of Heaven. Going to church doesn''t make a person a believer. He must be born again and enter into a personal relationship with God. When a person is born again, there will be a change in his actions and a soberness or serious outlook to life.', 'Single Answer', 'Kingdom,gates', 'gates');
...
(25, 'Oluwanifemi', 'Fawale', '10', 'oluwanifemifawale@gmail.com', '5f1cf5af2ac6807754b1825d0250ee8be60ed712', '3798.419', '2nd', '48', 'ff0080', 'OF', 'pink_femi838', 'oluwanifemifawalescores', '', '{"cTab":"Message","wQAnswered":"18","wQGotten":"17","wQMissed":"1","mQAnswered":"61","mQGotten":"57","mQMissed":"4","sTyped":"2","sWordsTyped":"Proverbs 26:2-As the bird by wondering, as the swallow by flying, so the curse causeless shall not come.","sGotten":"1","sMissed":"1","tPoints":"690","eAForToday":"65.178","totalAggregate":"3798.419","email":"oluwanifemifawale@gmail.com","age":"10"}'),
(26, 'Bolu', 'Ayodele', '12', 'boluayodele@gmail.com', 'c83f1de735de8aac5000a7773b24bfb03674df08', '378.225', '25th', '0', '400040', 'BA', 'chris', 'boluayodelescores', '', ''),
(27, 'Oluwaseyi', 'Alofe', '10', 'oluwaseyialofe13@gmail.com', '9125a5ca7d2d99dec906b5548dec123f66da5711', '1204.92', '14th', '0', 'FF530C', 'OA', 'Lilshay', 'oluwaseyialofescores', '', '{"cTab":"Message","wQAnswered":"18","wQGotten":"18","wQMissed":"0","mQAnswered":"21","mQGotten":"21","mQMissed":"0","sTyped":"0","sWordsTyped":"","sGotten":"0","sMissed":"0","tPoints":"390","eAForToday":"39","totalAggregate":"1204.92","email":"oluwaseyialofe13@gmail.com","age":"10"}'),
...
(29, 'Prosper', 'Falodun', '11', 'prosperfalodun@gmail.com', '16254f13cea30be88237e04d059e57802a28b819', '1248.333', '13th', '0', '3a2805', 'PF', 'pros353', 'prosperfalodunscores', '', ''),
...
(34, 'Mofeolu', 'Odeneye', '11', 'mofeoluodeneye@gmail.com', 'ad5dbfebc446ef0e881a129fd01c57c88a79733a', '129.101', '37th', '0', 'e8800c', 'MO', 'mo', 'mofeoluodeneyescores', '', ''),
...
(36, 'Temiloluwa', 'Bakre', '12', 'kemibakre2@gmail.com', '7d475e5a9d1058982c734b4e3e27d91b8ea41438', '96.89', '39th', '0', '000000', 'TB', 'TBabe', 'temiloluwabakrescores', '', ''),
(37, 'James', 'Otokiti', '12', 'jamesotokiti@gmail.com', 'caf9ceb956dfc1bdca4783f2a851ce7051e149c1', '315.482', '26th', '0', '205523', 'JO', '7th Hokage', 'jamesotokitiscores', '', ''),
(38, 'Adebayo', 'Inioluwa', '11', 'adebayoinioluwa@gmail.com', '0a301781fc9fa0f094ef9fb1781e26f70daabe7e', '1472.846', '9th', '0', '000000', 'AI', 'ini', 'adebayoinioluwascores', '', '{"cTab":"Message","wQAnswered":"18","wQGotten":"18","wQMissed":"0","mQAnswered":"155","mQGotten":"143","mQMissed":"12","sTyped":"1","sWordsTyped":"Proverbs 26:1-As snow in summer, and as rain in harvest, so in honor is not seemly for a fool.","sGotten":"0","sMissed":"1","tPoints":"1480","eAForToday":"134.532","totalAggregate":"1491.026","email":"adebayoinioluwa@gmail.com","age":"11"}'),
(39, 'Adebayo', 'Omolade', '18', 'adebayoomolade@gmail.com', '957afdf565bcf7c16174f04309f9f5f5aa07f33d', '136.422', '36th', '0', '400040', 'AO', 'lade', 'adebayoomoladescores', '', ''),
(40, 'Adebayo', 'Oluwatunbukunmi', '14', 'adebayooluwatunbukunmi@gmail.com', 'a53fc2b89ed768b53708b933ae6cf8648ba60041', '391.572', '23rd', '0', '2b002b', 'AO', 'Lizzy', 'adebayooluwatunbukunmiscores', '', '{"cTab":"Message","wQAnswered":"18","wQGotten":"18","wQMissed":"0","mQAnswered":"155","mQGotten":"141","mQMissed":"14","sTyped":"0","sWordsTyped":"Proverbs 26:1-As snow in summer, and as rain in harvest, so honor is not seemly for a fool. ","sGotten":"0","sMissed":"0","tPoints":"1440","eAForToday":"103.568","totalAggregate":"391.572","email":"adebayooluwatunbukunmi@gmail.com","age":"14"}'),
(41, 'Adebayo', 'Temiloluwa', '16', 'temiloluwabdy@gmail.com', '7083c7b0ca2977fedbd65ac2889410763c7c9f9f', '250.25', '30th', '0', '800000', 'AT', 'Mac-Switch', 'adebayotemiloluwascores', '', '{"cTab":"Worship","wQAnswered":"6","wQGotten":"6","wQMissed":"0","mQAnswered":"0","mQGotten":"0","mQMissed":"0","sTyped":"0","sWordsTyped":"","sGotten":"0","sMissed":"0","tPoints":"60","eAForToday":"3.75","totalAggregate":"250.25","email":"temiloluwabdy@gmail.com","age":"16"}'),
...
(43, 'Kolawole', 'Otokiti', '10', 'kolawoleotokiti@gmail.com', 'fb76b9af8c64358dcdbe8636dd8b189ed98cd5a7', '169.75', '33rd', '0', '000040', 'KO', 'Emmanuel', 'kolawoleotokitiscores', '', ''),
(45, 'Oyin', 'Adewumi', '10', 'oyinadewumi@gmail.com', '01b7c2aaf5578c13c48a55a8b02193e845fe296e', '116.8', '38th', '0', '2e112d', 'OA', 'Valentina', 'oyinadewumiscores', '', '{"cTab":"Scripture","wQAnswered":"18","wQGotten":"17","wQMissed":"1","mQAnswered":"0","mQGotten":"0","mQMissed":"0","sTyped":"4","sWordsTyped":"Proverbs 26:4-Answer not a fool according to his folly, lest you also be like him.","sGotten":"4","sMissed":"0","tPoints":"200","eAForToday":"20","totalAggregate":"116.8","email":"oyinadewumi@gmail.com","age":"10"}'),
(46, 'Folawe', 'Fawale', '10', 'folawefawale@gmail.com', '102594edcfdc8e60c49f902b30e5ba2f41d91d04', '382.978', '24th', '0', 'FF00FF', 'FF', 'Pinky123', 'folawefawalescores', '', '{"cTab":"Scripture","wQAnswered":"18","wQGotten":"17","wQMissed":"1","mQAnswered":"155","mQGotten":"134","mQMissed":"21","sTyped":"9","sWordsTyped":"Proverbs 26:9-As a thorn goes up into the hand of a drunkard, so is a parable in the mouth of fools.","sGotten":"5","sMissed":"4","tPoints":"1300","eAForToday":"126.178","totalAggregate":"3859.419","email":"folawefawale@gmail.com","age":"10"}'),
(47, 'Oluwasegun', 'Makanjuola', '10', 'oluwasegunmakanjuola@gmail.com', '853620dc95629e7f4174aa8dd37b0342a23d305d', '42.8', '42nd', '0', 'ff0000', 'OM', 'Shay', 'oluwasegunmakanjuolascores', '', '{"cTab":"Message","wQAnswered":"18","wQGotten":"12","wQMissed":"6","mQAnswered":"23","mQGotten":"16","mQMissed":"7","sTyped":"0","sWordsTyped":"","sGotten":"0","sMissed":"0","tPoints":"150","eAForToday":"15","totalAggregate":"42.8","email":"oluwasegunmakanjuola@gmail.com","age":"10"}'),
(48, 'Iyanu', 'Olawunmi', '12', 'iyanuolawunmi@gmail.com', '39b774470ac087df0941cd9c87f933af1bb27071', '58.615', '41st', '0', '800000', 'IO', 'Lampard', 'iyanuolawunmiscores', '', '{"cTab":"Message","wQAnswered":"18","wQGotten":"17","wQMissed":"1","mQAnswered":"155","mQGotten":"98","mQMissed":"57","sTyped":"2","sWordsTyped":"Proverbs 26:2-As the bird by wandering, as the swallow by flying, so the curse causeless shall not come","sGotten":"0","sMissed":"2","tPoints":"550","eAForToday":"45.815","totalAggregate":"58.615","email":"iyanuolawunmi@gmail.com","age":"12"}'),
(49, 'Shina', 'Olawunmi', '10', 'shinaolawunmi@gmail.com', 'd0d7128a16a7b74501c73c4ffd69dd8b2d63da8c', '87.8', '40th', '0', '004000', '', 'Shinene', 'shinaolawunmiscores', '', '{"cTab":"Message","wQAnswered":"18","wQGotten":"17","wQMissed":"1","mQAnswered":"155","mQGotten":"107","mQMissed":"48","sTyped":"0","sWordsTyped":"","sGotten":"0","sMissed":"0","tPoints":"750","eAForToday":"75","totalAggregate":"87.8","email":"shinaolawunmi@gmail.com","age":"10"}'),
(50, 'Peace', 'Falodun', '9', 'peacefalodun@gmail.com', '9ef2a0ef19799fcbc29471d4002a8d0dc550a478', '293.883', '29th', '0', '0000ff', 'PF', 'wonder', 'peacefalodunscores', '', '{"cTab":"Message","wQAnswered":"3","wQGotten":"1","wQMissed":"2","mQAnswered":"61","mQGotten":"55","mQMissed":"6","sTyped":"13","sWordsTyped":"Proverbs 26:13-The sloth (lazy) man says, there is a lion in the way; a lion is in the streets.","sGotten":"11","sMissed":"2","tPoints":"570","eAForToday":"63.327","totalAggregate":"293.883","email":"peacefalodun@gmail.com","age":"9"}');
...
(1, 'quiz', 'Materials', '2018-02-23 23:59:00');
...
(743, 'Proverbs', 26, 1, 'Proverbs 26:1-As snow in summer, and as rain in harvest, so honor is not seemly for a fool.', 'Proverbs 26:1'),
(744, 'Proverbs', 26, 2, 'Proverbs 26:2-As the bird by wandering, as the swallow by flying, so the curse causeless shall not come.', 'Proverbs 26:2'),
(745, 'Proverbs', 26, 3, 'Proverbs 26:3-A whip for the horse, a bridle for the ass, and a rod for the fool''s back.', 'Proverbs 26:3'),
(746, 'Proverbs', 26, 4, 'Proverbs 26:4-Answer not a fool according to his folly, lest you also be like him.', 'Proverbs 26:4'),
(747, 'Proverbs', 26, 5, 'Proverbs 26:5-Answer a fool according to his folly, lest he be wise in his own conceit.', 'Proverbs 26:5'),
(748, 'Proverbs', 26, 6, 'Proverbs 26:6-He that sends a message by the hand of a fool cuts off the feet, and drinks damage.', 'Proverbs 26:6'),
(749, 'Proverbs', 26, 7, 'Proverbs 26:7-The legs of the lame are not equal: so is a parable in the mouth of fools.', 'Proverbs 26:7'),
(750, 'Proverbs', 26, 8, 'Proverbs 26:8-As he that binds a stone in a sling, so is he that gives honor to a fool.', 'Proverbs 26:8'),
(751, 'Proverbs', 26, 9, 'Proverbs 26:9-As a thorn goes up into the hand of a drunkard, so is a parable in the mouth of fools.', 'Proverbs 26:9'),
(752, 'Proverbs', 26, 10, 'Proverbs 26:10-The great God that formed all things both rewards the fool, and rewards transgressors.', 'Proverbs 26:10'),
(753, 'Proverbs', 26, 11, 'Proverbs 26:11-As a dog returns to his vomit, so a fool returns to his folly.', 'Proverbs 26:11'),
(754, 'Proverbs', 26, 12, 'Proverbs 26:12-Do you see a man wise in his own eyes? There is more hope for a fool than for him.', 'Proverbs 26:12'),
(755, 'Proverbs', 26, 13, 'Proverbs 26:13-The slothful (lazy) man says, there is a lion in the way; a lion is in the streets.', 'Proverbs 26:13'),
(756, 'Proverbs', 26, 14, 'Proverbs 26:14-As the door turns upon his hinges, so does the slothful (lazy) upon his bed.', 'Proverbs 26:14'),
(757, 'Proverbs', 26, 15, 'Proverbs 26:15-The slothful (lazy) hides his hand in his bosom; it grieves him to bring it again to his mouth.', 'Proverbs 26:15'),
(758, 'Proverbs', 26, 16, 'Proverbs 26:16-The sluggard (lazy) is wiser in his own conceit (pride) than seven men that can render a reason.', 'Proverbs 26:16'),
(759, 'Proverbs', 26, 17, 'Proverbs 26:17-He that passes by, and meddles with strife belonging not to him, is like one that takes a dog by the ears.', 'Proverbs 26:17'),
(760, 'Proverbs', 26, 18, 'Proverbs 26:18-As a mad man who casts firebrands, arrows, and death,', 'Proverbs 26:18'),
(761, 'Proverbs', 26, 19, 'Proverbs 26:19-So is the man that deceives his neighbor, and says, am I not joking?', 'Proverbs 26:19'),
(762, 'Proverbs', 26, 20, 'Proverbs 26:20-Where no wood is, there the fire goes out: so where there is no talebearer, the strife ceases.', 'Proverbs 26:20'),
(763, 'Proverbs', 26, 21, 'Proverbs 26:21-As coals are to burning coals, and wood to fire; so is a contentious man to kindle strife.', 'Proverbs 26:21'),
(764, 'Proverbs', 26, 22, 'Proverbs 26:22-The words of a talebearer are as wounds, and they go down into the innermost parts of the belly.', 'Proverbs 26:22'),
(765, 'Proverbs', 26, 23, 'Proverbs 26:23-Burning lips and a wicked heart are like broken pieces of pottery covered with silver waste.', 'Proverbs 26:23'),
(766, 'Proverbs', 26, 24, 'Proverbs 26:24-He who hates pretends with his lips and stores up deceit within him.', 'Proverbs 26:24'),
(767, 'Proverbs', 26, 25, 'Proverbs 26:25-When he makes his voice gracious, do not believe him; for seven hateful things are in his heart.', 'Proverbs 26:25'),
(768, 'Proverbs', 26, 26, 'Proverbs 26:26-He whose hatred is covered by deceit, his wickedness shall be shown before the congregation.', 'Proverbs 26:26'),
(769, 'Proverbs', 26, 27, 'Proverbs 26:27-Whoever digs a pit shall fall into it; and he who rolls a stone, it will turn back to him.', 'Proverbs 26:27'),
(770, 'Proverbs', 26, 28, 'Proverbs 26:28-A lying tongue hates those afflicted by it, and a flattering mouth works ruin.', 'Proverbs 26:28'),
(771, 'Proverbs', 27, 1, 'Proverbs 27:1-Do not boast yourself of tomorrow, for you do not know what a day may bring forth.', 'Proverbs 27:1'),
(772, 'Proverbs', 27, 2, 'Proverbs 27:2-Let another man praise you, and not your mouth; a stranger, and not your lips.', 'Proverbs 27:2'),
(773, 'Proverbs', 27, 3, 'Proverbs 27:3-A stone is heavy, and sand is heavy; but a fool''s wrath (anger) is heavier than them both.', 'Proverbs 27:3'),
(774, 'Proverbs', 27, 4, 'Proverbs 27:4-Wrath (anger) is cruel, and anger is overwhelming; but who is able to stand before envy (jealousy)?', 'Proverbs 27:4'),
(775, 'Proverbs', 27, 5, 'Proverbs 27:5-Open rebuke is better than secret love.', 'Proverbs 27:5'),
(776, 'Proverbs', 27, 6, 'Proverbs 27:6-Faithful are the wounds of a friend; but the kisses of an enemy are deceitful.', 'Proverbs 27:6'),
(777, 'Proverbs', 27, 7, 'Proverbs 27:7-The full soul despises a honeycomb; but to the hungry soul every bitter thing is sweet.', 'Proverbs 27:7'),
(778, 'Proverbs', 27, 8, 'Proverbs 27:8-As a bird that wanders from her nest, so is a man who wanders from his place.', 'Proverbs 27:8'),
(779, 'Proverbs', 27, 9, 'Proverbs 27:9-Ointment and perfume rejoice the heart; so does the sweetness of one''s friend by advice from the heart.', 'Proverbs 27:9'),
(780, 'Proverbs', 27, 10, 'Proverbs 27:10-Your own friend, and your father''s friend, do not forsake them; nor go to your brother''s house in the day of your trouble; better is a neighbor that is near than a brother far off.', 'Proverbs 27:10'),
(781, 'Proverbs', 27, 11, 'Proverbs 27:11-My son, be wise, and make my heart glad, so that I may answer him who shames me.', 'Proverbs 27:11'),
(782, 'Proverbs', 27, 12, 'Proverbs 27:12-A prudent man foresees the evil and hides himself, but the simple pass on and are punished.', 'Proverbs 27:12'),
(783, 'Proverbs', 27, 13, 'Proverbs 27:13-Take his garment that is surety (security) for a stranger, and take a pledge of him for a strange woman.', 'Proverbs 27:13'),
(784, 'Proverbs', 27, 14, 'Proverbs 27:14-He that blesses his friend with a loud voice, rising early in the morning, it shall be counted a curse to him.', 'Proverbs 27:14'),
(785, 'Proverbs', 27, 15, 'Proverbs 27:15-A continual dropping in a very rainy day and a contentious woman are alike.', 'Proverbs 27:15'),
(786, 'Proverbs', 27, 16, 'Proverbs 27:16-Whosoever hides her hides the wind, and his right hand encounters slippery oil.', 'Proverbs 27:16'),
(787, 'Proverbs', 27, 17, 'Proverbs 27:17-Iron sharpens iron; so a man sharpens the countenance of his friend.', 'Proverbs 27:17'),
(788, 'Proverbs', 27, 18, 'Proverbs 27:18-Whoso keeps the fig tree shall eat the fruit thereof: so he that waits on his master shall be honored.', 'Proverbs 27:18'),
(789, 'Proverbs', 27, 19, 'Proverbs 27:19-As in water face answers to face, so the heart of man to man.', 'Proverbs 27:19'),
(790, 'Proverbs', 27, 20, 'Proverbs 27:20-Hell and destruction are never full; so the eyes of man are never satisfied.', 'Proverbs 27:20'),
(791, 'Proverbs', 27, 21, 'Proverbs 27:21-As the fining pot for silver, and the furnace for gold; so is a man to his praise.', 'Proverbs 27:21'),
(792, 'Proverbs', 27, 22, 'Proverbs 27:22-Though you should pound a fool in a mortar among wheat with a pestle, his foolishness will not depart from him.', 'Proverbs 27:22'),
(793, 'Proverbs', 27, 23, 'Proverbs 27:23-Know well the face of your flocks; set your heart on your herds.', 'Proverbs 27:23'),
(794, 'Proverbs', 27, 24, 'Proverbs 27:24-For riches are not forever; nor the crown from generation to generation.', 'Proverbs 27:24'),
(795, 'Proverbs', 27, 25, 'Proverbs 27:25-When the hay is removed, and the tender grass is seen, and mountain-plants are gathered,', 'Proverbs 27:25'),
(796, 'Proverbs', 27, 26, 'Proverbs 27:26-the lambs are for your clothing, and the goats are the price of the field.', 'Proverbs 27:26'),
(797, 'Proverbs', 27, 27, 'Proverbs 27:27-And you shall have goats'' milk enough for your food, for the food of your household, and a living for your young women.', 'Proverbs 27:27'),
(798, 'Proverbs', 28, 1, 'Proverbs 28:1-The wicked flee when no man pursues; but the righteous are bold as a lion.', 'Proverbs 28:1'),
(799, 'Proverbs', 28, 2, 'Proverbs 28:2-Because of the transgression of a land, many are its rulers; but it is prolonged by a man of discernment who knows right.', 'Proverbs 28:2'),
(800, 'Proverbs', 28, 3, 'Proverbs 28:3-A poor man who crushes the poor is like a sweeping rain which leaves no food.', 'Proverbs 28:3'),
(801, 'Proverbs', 28, 4, 'Proverbs 28:4-Those who forsake the law praise the wicked; but those who keep the law plead against them.', 'Proverbs 28:4'),
(802, 'Proverbs', 28, 5, 'Proverbs 28:5-Evil men do not understand judgment; but those who seek God understand all things.', 'Proverbs 28:5'),
(803, 'Proverbs', 28, 6, 'Proverbs 28:6-Better is the poor that walks in his uprightness, than he that is perverse in his ways, though he be rich.', 'Proverbs 28:6'),
(804, 'Proverbs', 28, 7, 'Proverbs 28:7-Whoso keeps the law is a wise son: but he that is a companion of riotous men shames his father.', 'Proverbs 28:7'),
(805, 'Proverbs', 28, 8, 'Proverbs 28:8-He who increases his wealth by interest and unjust gain, he shall gather it for him who will pity the poor.', 'Proverbs 28:8'),
(806, 'Proverbs', 28, 9, 'Proverbs 28:9-He that turns away his ear from hearing the law, even his prayer shall be an abomination.', 'Proverbs 28:9'),
(807, 'Proverbs', 28, 10, 'Proverbs 28:10-Whoso causes the righteous to go astray in an evil way, he shall fall himself into his own pit: but the upright shall have good things in possession.', 'Proverbs 28:10'),
(808, 'Proverbs', 28, 11, 'Proverbs 28:11-The rich man is wise in his own conceit (pride); but the poor that has understanding searches him out.', 'Proverbs 28:11'),
(809, 'Proverbs', 28, 12, 'Proverbs 28:12-When righteous men do rejoice, there is great glory: but when the wicked rise, a man is hidden.', 'Proverbs 28:12'),
(810, 'Proverbs', 28, 13, 'Proverbs 28:13-He that covers his sins shall not prosper: but whoso confesses and forsakes them shall have mercy.', 'Proverbs 28:13'),
(811, 'Proverbs', 28, 14, 'Proverbs 28:14-Happy is the man that fears God: but he that hardens his heart will fall into mischief.', 'Proverbs 28:14'),
(812, 'Proverbs', 28, 15, 'Proverbs 28:15-As a roaring lion, and a ranging bear; so is a wicked ruler over the poor people.', 'Proverbs 28:15'),
(813, 'Proverbs', 28, 16, 'Proverbs 28:16-The prince that wants understanding is also a great oppressor: but he that hates covetousness shall prolong his days.', 'Proverbs 28:16'),
(814, 'Proverbs', 28, 17, 'Proverbs 28:17-A man that does violence to the blood of any person shall flee to the pit; let no man stay him.', 'Proverbs 28:17'),
(815, 'Proverbs', 28, 18, 'Proverbs 28:18-Whoso walks uprightly shall be saved: but he that is perverse in his ways shall fall at once.', 'Proverbs 28:18'),
(816, 'Proverbs', 28, 19, 'Proverbs 28:19-He that tills his land shall have plenty of bread: but he that follows after vain persons shall have poverty enough.', 'Proverbs 28:19'),
(817, 'Proverbs', 28, 20, 'Proverbs 28:20-A faithful man shall abound with blessings: but he that makes haste to be rich shall not be innocent.', 'Proverbs 28:20'),
(818, 'Proverbs', 28, 21, 'Proverbs 28:21-To have respect for persons is not good: for for a piece of bread that man will transgress.', 'Proverbs 28:21'),
(819, 'Proverbs', 28, 22, 'Proverbs 28:22-He that hastes to be rich has an evil eye, and considers not that poverty shall come upon him.', 'Proverbs 28:22'),
(820, 'Proverbs', 28, 23, 'Proverbs 28:23-He that rebukes a man afterwards shall find more favor than he that flatters with the tongue.', 'Proverbs 28:23'),
(821, 'Proverbs', 28, 24, 'Proverbs 28:24-Whoso robs his father or his mother, and says, it is no transgression, the same is the companion of a destroyer.', 'Proverbs 28:24'),
(822, 'Proverbs', 28, 25, 'Proverbs 28:25-He that is of a proud heart stirs up strife: but he that puts his trust in the LORD shall be made fat.', 'Proverbs 28:25'),
(823, 'Proverbs', 28, 26, 'Proverbs 28:26-He that trusts in his own heart is a fool: but whoso walks wisely, he shall be delivered.', 'Proverbs 28:26'),
(824, 'Proverbs', 28, 27, 'Proverbs 28:27-He that gives to the poor shall not lack: but he that hides his eyes shall have many a curse.', 'Proverbs 28:27'),
(825, 'Proverbs', 28, 28, 'Proverbs 28:28-When the wicked rise, men hide themselves: but when they perish, the righteous increase.', 'Proverbs 28:28');
...
(184, 'Your ______ is enough, more than I need', 'Single Answer', 'grace,love,favor', 'grace'),
(185, 'At Your Word I will _______', 'Single Answer', 'walk,believe,live', 'believe'),
(186, 'I wait for You _______ near again', 'Single Answer', 'come,draw', 'draw'),
(187, 'Let Your _______ make me new', 'Single Answer', 'Word,Spirit,love', 'Spirit'),
(188, 'And I will ______ at Your feet, I will ______ at Your feet', 'Single Answer', 'fall,worship,praise,honor', 'fall'),
(189, 'And I will _________ You here', 'Single Answer', 'honor,worship,praise', 'worship'),
(190, 'Your presence in me, Jesus ______ the way', 'Single Answer', 'light,show,lead', 'light'),
(191, 'By the power of Your _______', 'Single Answer', 'grace,Word', 'Word'),
(192, 'I am restored, I am _______', 'Single Answer', 'born again,renewed,redeemed', 'redeemed'),
(193, 'By Your Spirit I am _____', 'Single Answer', 'released,free', 'free'),
(194, '_______ fall at Your feet, I will fall at Your feet', 'Single Answer', 'And we will,And I will', 'And I will'),
(195, 'And I will worship Yo_____', 'Single Answer', 'here,u here', 'u here'),
(196, 'Freely You ______ it all for us', 'Single Answer', 'provided,gave,sacrificed', 'gave'),
(197, '________ Your life upon that cross', 'Single Answer', 'Sacrificed,Surrendered', 'Surrendered'),
(198, 'Great is the love, poured out for all, this is our _______', 'Single Answer', 'Lord,God', 'God'),
(199, 'Lifted on high from ______ to life', 'Single Answer', 'death,the grave', 'death'),
(200, 'Forever our God is _______', 'Single Answer', 'magnified,glorified', 'glorified'),
(201, '______ and King, rescued the world, this is our God', 'Single Answer', 'Savior,Servant', 'Servant');
...
--
ALTER TABLE `messagequestions`
  MODIFY `id` mediumint(9) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=10118;
--
