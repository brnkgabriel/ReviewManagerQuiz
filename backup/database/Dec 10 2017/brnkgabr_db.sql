...
--
-- Host: localhost
-- Generation Time: Dec 11, 2017 at 01:37 PM
...
) ENGINE=InnoDB AUTO_INCREMENT=8620 DEFAULT CHARSET=latin1;
...
(8529, '... a banquet connotes __________ where you take what you want and as much as you want', 'Single Answer', 'a dinner,an open table', 'an open table'),
(8530, '...it is possible to live a financially stress free life. True or False?', 'Single Answer', 'True,False', 'True'),
(8531, '...it is possible to stay on top of all financial __________', 'Single Answer', 'issues,concerns,situations', 'concerns'),
(8532, '...and when ______ went with Abraham, every blessing on Abraham began to speak in the life of ______', 'Single Answer', 'Sarah,Lot,Isaac', 'Lot'),
(8533, '________ also came in the midst of the prophets and he began to prophesy.', 'Single Answer', 'David,Saul,Daniel', 'Saul'),
(8534, '...because environment is ordained to _______ on the life of individuals who are connected to it.', 'Single Answer', 'reflect,impact', 'impact'),
(8535, '..._________ is contagious', 'Single Answer', 'spiritual environment,environment', 'spiritual environment'),
(8536, '...financial dominion is our ________ in redemption', 'Single Answer', 'right,heritage', 'heritage'),
(8537, '<strong>For you know the grace of our Lord Jesus Christ, that, though he was rich, yet for your sake He became poor, that you through His poverty might be rich.</strong> What bible verse is this?', 'Single Answer', '1Corinthians 8:9,2Corinthians 8:9,1Thessalonians 8:9', '2Corinthians 8:9'),
(8538, '<strong>And God is able to make all grace abound toward you; that you, always having all sufficiency in all things, may abound to every good work:</strong> What bible verse is this?', 'Single Answer', '2Corinthians 8:9,2Corinthains 9:8,2Corinthians 9:8', '2Corinthians 9:8'),
(8539, '...#2 financial dominion is our heritage in _______', 'Single Answer', 'redemption,the Abrahamic covenant', 'the Abrahamic covenant'),
(8540, '<strong>And in your seed shall all the nations of the earth be blessed; because you have obeyed My voice.</strong> What bible verse is the highlighted?', 'Single Answer', 'Genesis 22:17-18,Genesis 22:18,Genesis 22:17', 'Genesis 22:18'),
(8541, '<strong>And if you are Christ''s, then are you Abraham''s seed, and heirs according to the promise.</strong> What bible verse is the highlighted?', 'Single Answer', 'Ephesians 3:29,Galatians 3:29,Romans 3:29', 'Galatians 3:29'),
(8542, '...every child of God is a _______ of Abraham and is ordained to be a blessing to his world.', 'Single Answer', 'child,seed', 'seed'),
(8543, '...we also discovered, it is the core blessing of the _______', 'Single Answer', 'law,Word', 'law'),
(8544, '<strong>The LORD shall open unto you his good treasure, the heaven to give the rain to your land in his season, and to bless all the work of your hand: and you shalt lend to many nations, and you shalt not borrow.</strong> What bible verse is this?', 'Single Answer', 'Deuteronomy 28:12,Deuteronomy 28:30', 'Deuteronomy 28:12'),
(8545, '<strong>And the LORD shall make you the head, and not the tail; and you shalt be above only, and you shalt not be beneath; if that you hearken unto the commandments of the LORD your God, which I command you this day, to observe and to do them: </strong> What bible verse is this?', 'Single Answer', 'Deuteronomy 28:14,Deuteronomy 28:13,Deuteronomy 28:12', 'Deuteronomy 28:13'),
(8546, '...I saw myself lending to nations _______ when there was nothing in the immediate environment that I lived in', 'Single Answer', '1983,1981,1989', '1981'),
(8547, '...it''s also important to note that financial dominion is God''s ________ for the end time.', 'Single Answer', 'program,agenda', 'agenda'),
(8548, '<strong>And you shall eat in plenty, and be satisfied, and praise the name of the LORD your God, that has dealt wondrously with you: and My people shall never be ashamed.</strong> What bible verse is this?', 'Single Answer', 'Joel 2:34,Joel 2:24,Joel 2:26', 'Joel 2:26'),
(8549, '...the last days began in the __________', 'Single Answer', 'last supper room,upper room', 'upper room'),
(8550, '...what we believe is what we are ________ to become.', 'Single Answer', 'going,empowered', 'empowered'),
(8551, '<strong>But as many as received Him, to them gave He power to become the sons of God, even to them that believe on his name:</strong> What bible verse is this?', 'Single Answer', 'John 1:14,John 1:12,John 1:2', 'John 1:12'),
(8552, '...we''ll be examining the financial wonders from the ________ platform', 'Single Answer', 'prophetic,wisdom,love', 'love'),
(8553, '...all revelations in the Word on financial dominion is rooted in _______', 'Single Answer', 'sowing,giving', 'giving'),
(8554, '...nothing is permitted to multiply until it is ______ as a seed', 'Single Answer', 'given,sown', 'sown'),
(8555, '...anything we don''t ______ never multiplies', 'Single Answer', 'sow,give', 'sow'),
(8556, '...anything we don''t invest _________, only what we invest multiplies', 'Single Answer', 'dwindles,diminishes,finishes', 'diminishes'),
(8557, '<strong>While the earth remains, seedtime and harvest, and cold and heat, and summer and winter, and day and night shall not cease.</strong> What bible verse is this?', 'Single Answer', 'Genesis 8:1,Genesis 8:2,Genesis 8:22', 'Genesis 8:22'),
(8558, '...it is _____ that empowers a giving life.', 'Single Answer', 'faith,love,hope', 'love'),
(8559, '_________ is the foundation for financial dominion.', 'Single Answer', 'Sowing,Giving', 'Giving'),
(8560, '<strong>For God so loved the world, that he gave his only begotten Son, that whosoever believes in Him should not perish, but have everlasting life.</strong> What bible verse is this?', 'Single Answer', 'John 3:16,John 3:5', 'John 3:16'),
(8561, '...addiction to giving is empowered by _______', 'Single Answer', 'grace,faith,love', 'love'),
(8562, '...when we become addicted to _______, God is committed to empowering us for financial dominion.', 'Single Answer', 'sowing,giving', 'giving'),
(8563, '...it is only addicted givers that walk _________ financial dominion', 'Single Answer', 'in,supernaturally in', 'supernaturally in'),
(8564, '...it is only love that empowers a man to give willingly, cheerfully, sacrificially, continuously and _______', 'Single Answer', 'all the time,tirelessly', 'tirelessly'),
(8565, '...it is impossible to walk in financial dominion without a giving life. True or False?', 'Single Answer', 'True,False', 'True'),
(8566, '...I have never known a downturn since I got on this high way March _____ 1982', 'Single Answer', '23,22,21', '22'),
(8567, '...______ is the platform that empowers our giving life and that provides access to this realm we''re talking about', 'Single Answer', 'faith,love,hope', 'love'),
(8568, '...all great lovers of God in scriptures walked in financial dominion. #1 ________', 'Single Answer', 'David,Abraham', 'Abraham'),
(8569, '<strong>And the scripture was fulfilled which says, Abraham believed God, and it was imputed unto him for righteousness: and he was called the Friend of God.</strong> What bible verse is this?', 'Single Answer', 'James 2:23,Romans 4:17,Hebrews 11:13', 'James 2:23'),
(8570, '________ is the cord of friendship.', 'Single Answer', 'Faith,Hope,Love', 'Love'),
(8571, '<strong>And Abraham was old, and well stricken in age: and the LORD had blessed Abraham in all things.</strong> What bible verse is this?', 'Single Answer', 'Genesis 8:1,Genesis 23:1,Genesis 24:1', 'Genesis 24:1'),
(8572, '...because God is not a ________, He means what He says and He says what He means.', 'Single Answer', 'jester,joker,comedian', 'joker'),
(8573, '...Abraham was a ________, Genesis 14:19-21', 'Single Answer', 'giver,tither', 'tither'),
(8574, '<strong>And Abram was very rich in cattle, in silver, and in gold.</strong> What bible verse is this?', 'Single Answer', 'Genesis 13:1,Genesis 13:2', 'Genesis 13:2'),
(8575, '...whatever we hold in our hand that God cannot have, defines the limit that God can take us. True or False?', 'Single Answer', 'True,False', 'True'),
(8576, '<strong>Moreover, because I have set my affection to the house of my God, I have of mine own proper good, of gold and silver, which I have given to the house of my God, over and above all that I have prepared for the holy house.</strong> What bible portion is the highlighted?', 'Single Answer', '2Chronicles 29:3,1Chronicles 29:3', '1Chronicles 29:3'),
(8577, '<strong>That you be not lazy, but followers of them who through faith and patience inherit the promises</strong> What bible portion is the highlighted?', 'Single Answer', 'Hebrews 11:12,Hebrews 6:1,Hebrews 6:12', 'Hebrews 6:12'),
(8578, '...we can''t pray our way out of poverty. We can only give our way out of it. True or False?', 'Single Answer', 'True,False', 'True'),
(8579, '<strong>If they obey and serve Him, they shall spend their days in prosperity, and their years in pleasures.</strong> What bible verse is this?', 'Single Answer', 'Genesis 8:11,Job 36:11,Jude 1:11', 'Job 36:11'),
(8580, '...God blesses us _______ so we can be a blessing to the Kingdom and to the world around us.', 'Single Answer', 'solely,essentially,primarily', 'primarily'),
(8581, '<strong>And I will make of thee a great nation, and I will bless thee, and make thy name great; and thou shalt be a blessing:</strong> What bible verse is this?', 'Single Answer', 'Genesis 12:1,Genesis 12:2,Genesis 12:3', 'Genesis 12:2'),
(8582, '...our name cannot be greater than how great we are committed to being a blessing. True or False?', 'Single Answer', 'True,False', 'True'),
(8583, '...anywhere people put us is _________', 'Single Answer', 'temporal,temporary', 'temporal'),
(8584, '...wherever God puts us is eternal, as long as we keep by the rules and constitution of the Kingdom. True or False?', 'Single Answer', 'True,False', 'True'),
(8585, '...God will not bless anyone beyond his commitment to the promotion of ________', 'Single Answer', 'His Kingdom,the Kingdom of God', 'the Kingdom of God'),
(8586, '<strong>But seek ye first the kingdom of God, and his righteousness; and all these things shall be added unto you.</strong> What bible verse is this?', 'Single Answer', 'Matthew 6:25,Matthew 6:34,Matthew 6:33', 'Matthew 6:33'),
(8587, '...Kingdom promotion addiction is ______ to walking in financial dominion', 'Single Answer', 'crucial,vital', 'vital'),
(8588, '<strong>Bring you all the tithes into the storehouse, that there may be meat in mine house, and prove me now herewith, says the LORD of hosts, if I will not open you the windows of heaven, and pour you out a blessing, that there shall not be room enough to receive it.</strong> What bible verse is this?', 'Single Answer', 'Malachi 3:6,Malachi 3:10,Malachi 3:13', 'Malachi 3:10'),
(8589, '...Kingdom priority ________ is a mystery behind financial dominion', 'Single Answer', 'mindset,mentality', 'mentality'),
(8590, '...God will not bless anyone beyond his commitment to blessing the needy around him. True or False?', 'Single Answer', 'True,False', 'True'),
(8591, '<strong>He that gives unto the poor shall not lack: but he that hides his eyes shall have many a curse.</strong> What bible verse is this?', 'Single Answer', 'Proverbs 19:17,Proverbs 28:27', 'Proverbs 28:27'),
(8592, '<strong>As I was in the days of my youth, when the secret of God was upon my tabernacle;</strong> What bible verse is this?', 'Single Answer', 'Job 28:4,Job 27:4,Job 29:4', 'Proverbs 29:4'),
(8593, '<strong>When I washed my steps with butter, and the rock poured me out rivers of oil;</strong> What bible verse is this?', 'Single Answer', 'Job 29:5,Job 29:6,Job 29:7', 'Job 29:6'),
(8594, '<strong>Because I delivered the poor that cried, and the fatherless, and him that had none to help him.</strong> What bible verse is this?', 'Single Answer', 'Job 29:11,Job 29:12,Job 29:13', 'Job 29:12'),
(8595, '...ministering to the needy around us is a ________ for changing levels.', 'Single Answer', 'platform,covenant platform', 'covenant platform'),
(8596, '...seek _______ to put a smile on somebody''s face', 'Single Answer', 'avenues,opportunities', 'opportunities'),
(8597, '...God will not bless any man beyond his commitment to giving towards the well being of ________.', 'Single Answer', 'humanity,man kind', 'man kind'),
(8598, '...God will not bless any man beyond his commitment to impacting the nations with his _________.', 'Single Answer', 'wealth,fortune', 'fortune'),
(8599, '...givers are exempted from ________, because God needs them to keep blessing their world.', 'Single Answer', 'illness,sickness', 'sickness'),
(8600, '...when giving becomes a lifestyle, we enjoy health, vitality and ________ which money cannot buy.', 'Single Answer', 'long life,longevity', 'longevity'),
(8601, '... but giving must be done with _______', 'Single Answer', 'wisdom,discretion,understanding', 'discretion'),
(8602, '<strong>A good man shows favor, and lends: he will guide his affairs with discretion.</strong> What bible verse is this?', 'Single Answer', 'Palms 112:5,Psalms 112:5', 'Psalms 112:5'),
(8603, 'Discretion is having a covenant understanding of giving priorities. True or False?', 'Single Answer', 'True,False', 'True'),
(8604, '...for instance, #1 is ________', 'Single Answer', 'offering,tithing', 'tithing'),
(8605, '<strong>Three times in a year shall all your males appear before the LORD your God in the place which He shall choose; in the feast of unleavened bread, and in the feast of weeks, and in the feast of tabernacles: and they shall not appear before the LORD empty:</strong> What bible verse is the highlighted?', 'Single Answer', 'Deuteronomy 16:16-17,Deuteronomy 16:16,Deuteronomy 16:17', 'Deuteronomy 16:16'),
(8606, '<strong>Children, obey your parents in the Lord: for this is right. Honor thy father and mother; (which is the first commandment with promise)</strong> What bible portion is the highlighted?', 'Single Answer', 'Ephesians 6:1,Ephesians 6:2,Ephesians 6:1-2', 'Ephesians 6:1-2'),
(8607, '<strong>Therefore does My Father love me, because I lay down my life, that I might take it again.</strong> What bible portion is the highlighted?', 'Single Answer', 'John 10:17,John 10:18,John 10:17-18', 'John 10:17'),
(8608, '...so don''t tell anybody that you''re poor, that''s why you''re not giving. You may die in poverty. True or False?', 'Single Answer', 'True,False', 'True'),
(8609, '...there is nothing small that cannot become ______', 'Single Answer', 'big,great', 'great'),
(8610, '...and there''s nothing great that cannot become greater. It _______ on what you do with the small.', 'Single Answer', 'hinges,depends,is dependent', 'depends'),
(8611, '...until you do the right thing with the small, it will never ______ big.', 'Single Answer', 'grow,become', 'become'),
(8612, '...until you keep doing the right thing with the big, it will never become _______', 'Single Answer', 'bigger,great', 'bigger'),
(8613, '...it is ______ that makes small to become big', 'Single Answer', 'sowing,giving', 'giving'),
(8614, '...it is greater giving that makes it become __________.', 'Single Answer', 'greater,bigger', 'bigger'),
(8615, '...nobody is counting the volume. It is the cost to you that ________ the value of your seed (what you give).', 'Single Answer', 'defines,determines', 'defines'),
(8616, '...what they give us is not what _______ us. It is what we give is what ________ us.', 'Single Answer', 'increases,enriches', 'enriches'),
(8617, '<strong>By the blessing of the upright the city is exalted: but it is overthrown by the mouth of the wicked.</strong> What bible verse is this?', 'Single Answer', 'Proverbs 11:10,Proverbs 11:11,Proverbs 11:12', 'Proverbs 11:11'),
(8618, '...there is the ________ of love', 'Single Answer', 'spirit,anointing', 'anointing'),
(8619, '...there are those that have ________. God will bless them to the level that will not overflow the _______', 'Single Answer', 'canals,channels', 'channels');
...
(27, 'Oluwaseyi', 'Alofe', '10', 'oluwaseyialofe13@gmail.com', '9125a5ca7d2d99dec906b5548dec123f66da5711', '742.92', '14th', '0', 'FF530C', 'OA', 'Lilshay', 'oluwaseyialofescores', '', '{"cTab":"Scripture","wQAnswered":"40","wQGotten":"40","wQMissed":"0","mQAnswered":"0","mQGotten":"0","mQMissed":"0","sTyped":"2","sWordsTyped":"To another prophecy. We see the importance of this gift from 1Chorithians 14:1, where we are told to follow after love,","sGotten":"1","sMissed":"1","tPoints":"400","eAForToday":"40","totalAggregate":"742.92","email":"oluwaseyialofe13@gmail.com","age":"10"}'),
...
(29, 'Prosper', 'Falodun', '11', 'prosperfalodun@gmail.com', '16254f13cea30be88237e04d059e57802a28b819', '963.816', '12th', '0', '3a2805', 'PF', 'pros353', 'prosperfalodunscores', '', '{"cTab":"Scripture","wQAnswered":"40","wQGotten":"39","wQMissed":"1","mQAnswered":"0","mQGotten":"0","mQMissed":"0","sTyped":"3","sWordsTyped":"and desire spiritual gifts, but rather that we may prophesy.","sGotten":"3","sMissed":"0","tPoints":"410","eAForToday":"37.269","totalAggregate":"963.816","email":"prosperfalodun@gmail.com","age":"11"}'),
...
(37, 'James', 'Otokiti', '13', 'jamesotokiti@gmail.com', 'caf9ceb956dfc1bdca4783f2a851ce7051e149c1', '180.324', '29th', '0', '205523', 'JO', '7th Hokage', 'jamesotokitiscores', '', ''),
(38, 'Adebayo', 'Inioluwa', '11', 'adebayoinioluwa@gmail.com', '0a301781fc9fa0f094ef9fb1781e26f70daabe7e', '475.66', '19th', '0', '000000', 'AI', 'ini', 'adebayoinioluwascores', '', '{"cTab":"Message","wQAnswered":"40","wQGotten":"38","wQMissed":"2","mQAnswered":"49","mQGotten":"41","mQMissed":"8","sTyped":"1","sWordsTyped":"In 1Corintians 12:10, speaking of diversities of gifts by the same Spirit, Paul writes,","sGotten":"0","sMissed":"1","tPoints":"680","eAForToday":"61.812","totalAggregate":"475.66","email":"adebayoinioluwa@gmail.com","age":"11"}'),
...
(41, 'Adebayo', 'Temiloluwa', '16', 'temiloluwabdy@gmail.com', '7083c7b0ca2977fedbd65ac2889410763c7c9f9f', '193.375', '28th', '0', '800000', 'AT', 'Mac-Switch', 'adebayotemiloluwascores', '', '{"cTab":"Message","wQAnswered":"40","wQGotten":"35","wQMissed":"5","mQAnswered":"4","mQGotten":"3","mQMissed":"1","sTyped":"0","sWordsTyped":"","sGotten":"0","sMissed":"0","tPoints":"320","eAForToday":"20","totalAggregate":"193.375","email":"temiloluwabdy@gmail.com","age":"16"}'),
...
(1, 'quiz', 'Materials', '2017-12-08 23:59:00');
...
(1492, 'Ever Increasing Faith', 16, 1, 'In 1Corinthians 12:10, speaking of diversities of gifts by the same Spirit, Paul writes,', 'Ever Increasing Faith 16:1'),
(1493, 'Ever Increasing Faith', 16, 2, 'To another prophecy. We see the importance of this gift from 1Corinthians 14:1, where we are told to follow after love,', 'Ever Increasing Faith 16:2'),
(1494, 'Ever Increasing Faith', 16, 3, 'and desire spiritual gifts, but rather that we may prophesy.', 'Ever Increasing Faith 16:3'),
(1495, 'Ever Increasing Faith', 16, 4, 'We see also that he that prophesies speaks to man to edification, and exhortation and comfort.', 'Ever Increasing Faith 16:4'),
(1496, 'Ever Increasing Faith', 16, 5, 'How important it is then that we should have the gift in manifestation in the church in order that the saints might be built up and made strong and filled with the comfort of God.', 'Ever Increasing Faith 16:5'),
(1497, 'Ever Increasing Faith', 16, 6, 'But with this as all other gifts we should see that it is operated by the Spirit''s power and brought forth in the unction of the Spirit;', 'Ever Increasing Faith 16:6'),
(1498, 'Ever Increasing Faith', 16, 7, 'so that everyone who shall hear prophecy, as it is brought forth by the Spirit of God, shall know that it is God who is bringing forth that which is for the edification of those who hear.', 'Ever Increasing Faith 16:7'),
(1499, 'Ever Increasing Faith', 16, 8, 'It is the Spirit of God who takes of the deep things of God and reveals them,', 'Ever Increasing Faith 16:8'),
(1500, 'Ever Increasing Faith', 16, 9, 'and unctionizes the prophet to give forth, that which is a revelation of the things of God.', 'Ever Increasing Faith 16:9'),
(1501, 'Ever Increasing Faith', 16, 10, 'Utterance in prophecy has a real lifting power and gives real light on the truth to those who hear.', 'Ever Increasing Faith 16:10'),
(1502, 'Ever Increasing Faith', 16, 11, 'Prophecy is never a mind reflection; it is something far deeper than this.', 'Ever Increasing Faith 16:11'),
(1503, 'Ever Increasing Faith', 16, 12, 'By means of prophecy we receive that which is the mind of the Lord;', 'Ever Increasing Faith 16:12'),
(1504, 'Ever Increasing Faith', 16, 13, 'and as we received these blessed, fresh utterances through the Spirit of the Lord the whole assembly is lifted into the realm of the spiritual.', 'Ever Increasing Faith 16:13'),
(1505, 'Ever Increasing Faith', 16, 14, 'Our hearts and minds and whole bodies receive a quickening through the Spirit-given word.', 'Ever Increasing Faith 16:14'),
(1506, 'Ever Increasing Faith', 16, 15, 'As the Spirit brings forth prophecy we find there is healing and salvation and power in every line.', 'Ever Increasing Faith 16:15'),
(1507, 'Ever Increasing Faith', 16, 16, 'For this reason it is one of the gifts that we ought to covet.', 'Ever Increasing Faith 16:16'),
(1508, 'Ever Increasing Faith', 16, 17, 'While we appreciate true prophecy, we must not forget that the Scriptures warn us in no uncertain manner concerning that which is false.', 'Ever Increasing Faith 16:17'),
(1509, 'Ever Increasing Faith', 16, 18, 'In 1John 4:1 we are told, Beloved, believe not every spirit, but try the spirits whether they are of God: because many false prophets are gone out into the world.', 'Ever Increasing Faith 16:18'),
(1510, 'Ever Increasing Faith', 16, 19, 'And John tells us how we can tell the difference between the true and the false,', 'Ever Increasing Faith 16:19'),
(1511, 'Ever Increasing Faith', 16, 20, 'This is how you know the Spirit of God: every spirit that confesses that Jesus Christ came in the flesh is of God:', 'Ever Increasing Faith 16:20'),
(1512, 'Ever Increasing Faith', 16, 21, 'and every spirit that confesses that Jesus Christ did not come in the flesh is not of God;', 'Ever Increasing Faith 16:21'),
(1513, 'Ever Increasing Faith', 16, 22, 'but this is that spirit of antichrist whereof you have heard that it should come.', 'Ever Increasing Faith 16:22'),
(1514, 'Ever Increasing Faith', 16, 23, 'There are voices which seem like prophecy and some have got into terrible darkness and bondage through listening to these counterfeits of the true gift of prophecy.', 'Ever Increasing Faith 16:23'),
(1515, 'Ever Increasing Faith', 16, 24, 'True prophecy is always Christ exalting, magnifying the Son of God, exalting the blood of Jesus Christ,', 'Ever Increasing Faith 16:24'),
(1516, 'Ever Increasing Faith', 16, 25, 'encouraging the saints to praise and worship the true God.', 'Ever Increasing Faith 16:25'),
(1517, 'Ever Increasing Faith', 16, 26, 'False prophecy deals with things that do not edify and is designed to puff up its hearers and to lead them into error.', 'Ever Increasing Faith 16:26'),
(1518, 'Ever Increasing Faith', 16, 27, 'Many picture satan as a great, ugly monster with great ears, eyes and a tail; but the Scriptures give us no such picture of him.', 'Ever Increasing Faith 16:27'),
(1519, 'Ever Increasing Faith', 16, 28, 'He was a being of great beauty whose heart became lifted up. He is manifesting himself everywhere today as an angel of light.', 'Ever Increasing Faith 16:28'),
(1520, 'Ever Increasing Faith', 16, 29, 'He is full of pride, and if you don''t watch he will try to make you think you are somebody.', 'Ever Increasing Faith 16:29'),
(1521, 'Ever Increasing Faith', 16, 30, 'This is the weakness of most preachers and most men-the idea of being somebody!', 'Ever Increasing Faith 16:30'),
(1522, 'Ever Increasing Faith', 16, 31, 'There is none of us who is anything, and the more we know we are nothing, the more God can make us a channel of His power.', 'Ever Increasing Faith 16:31'),
(1523, 'Ever Increasing Faith', 16, 32, 'May the dear Lord save us from all these pride sidelines-they are the devil''s traps.', 'Ever Increasing Faith 16:32'),
(1524, 'Ever Increasing Faith', 16, 33, 'True prophecy will show you that Christ is all in all, and that you are in yourself less than nothing and vanity.', 'Ever Increasing Faith 16:33'),
(1525, 'Ever Increasing Faith', 16, 34, 'False prophecy will not magnify Christ but will make you think that after all you are going to be some great one.', 'Ever Increasing Faith 16:34'),
(1526, 'Ever Increasing Faith', 16, 35, 'You may be sure that such is inspired by the chief of the sons of pride.', 'Ever Increasing Faith 16:35'),
(1527, 'Ever Increasing Faith', 16, 36, 'I want to warn you against the foolishness of continually seeking to hear voices. Look in the Bible. Here we have the voice of God,', 'Ever Increasing Faith 16:36'),
(1528, 'Ever Increasing Faith', 16, 37, 'who at sundry times and in divers manners, spoke in time past unto the fathers by the prophets, and has in these last days spoken to us by His Son (Hebrews 1:1-2).', 'Ever Increasing Faith 16:37'),
(1529, 'Ever Increasing Faith', 16, 38, 'Don''t run away with anything else. If you hear the voice of God it will be on the line of the Scriptures of truth given in the inspired Word.', 'Ever Increasing Faith 16:38'),
(1530, 'Ever Increasing Faith', 16, 39, 'In Revelation 22:18-19, we see the danger of attempting to add to or take from the prophecy of this Book.', 'Ever Increasing Faith 16:39'),
(1531, 'Ever Increasing Faith', 16, 40, 'True prophecy, as it comes forth in the power of the Spirit of God, will neither take from nor add to the Scriptures,', 'Ever Increasing Faith 16:40'),
(1532, 'Ever Increasing Faith', 16, 41, 'but will intensify and quicken that which already has been given to us of God.', 'Ever Increasing Faith 16:41'),
(1533, 'Ever Increasing Faith', 16, 42, 'The Holy Ghost will bring to our remembrance all the things that Jesus said and did.', 'Ever Increasing Faith 16:42'),
(1534, 'Ever Increasing Faith', 16, 43, 'True prophecy will bring forth things new and old out of the Scriptures of truth and will make them living and powerful to us.', 'Ever Increasing Faith 16:43'),
(1535, 'Ever Increasing Faith', 16, 44, 'Some may ask, If we have the Scriptures, why do we need prophecy?', 'Ever Increasing Faith 16:44'),
(1536, 'Ever Increasing Faith', 16, 45, 'The Scriptures themselves answer this question. God has said that in the last days He will pour out His Spirit upon all flesh,', 'Ever Increasing Faith 16:45'),
(1537, 'Ever Increasing Faith', 16, 46, 'and your sons and your daughters shall prophecy (Joel 2:28).', 'Ever Increasing Faith 16:46'),
(1538, 'Ever Increasing Faith', 16, 47, 'The Lord knew that in these last days prophecy would be a real means of blessing to us, and that is why we can count on Him giving us,', 'Ever Increasing Faith 16:47'),
(1539, 'Ever Increasing Faith', 16, 48, 'by means of the Spirit, through his servants and his handmaids, true prophetic messages.', 'Ever Increasing Faith 16:48'),
(1540, 'Ever Increasing Faith', 16, 49, 'I want to give you a warning concerning listening to voices.', 'Ever Increasing Faith 16:49'),
(1541, 'Ever Increasing Faith', 16, 50, 'I was at a meeting in Paisley in Scotland and came in touch with two young women.', 'Ever Increasing Faith 16:50'),
(1542, 'Ever Increasing Faith', 16, 51, 'One of them wore a white blouse but it was smeared with blood. They were in a great state of excitement.', 'Ever Increasing Faith 16:51'),
(1543, 'Ever Increasing Faith', 16, 52, 'These two girls were telegraph operators and were precious young women, having received the Baptism in the Spirit.', 'Ever Increasing Faith 16:52'),
(1544, 'Ever Increasing Faith', 16, 53, 'They were both longing to be missionaries. But whatever our spirit state is, we are subject to temptations.', 'Ever Increasing Faith 16:53'),
(1545, 'Ever Increasing Faith', 16, 54, 'An evil power came to one of these young women and said, If you will obey me, I will make you one of the most wonderful missionaries that ever went out.', 'Ever Increasing Faith 16:54'),
(1546, 'Ever Increasing Faith', 16, 55, 'This was just the devil or one of his agents acting as an angel of light.', 'Ever Increasing Faith 16:55'),
(1547, 'Ever Increasing Faith', 16, 56, 'One of these young women was captured immediately and she became so excited that her sister saw there was something wrong and asked the overseer to allow them to be free for a time.', 'Ever Increasing Faith 16:56'),
(1548, 'Ever Increasing Faith', 16, 57, 'As she took her into a room, the power of satan endeavoring to imitate the Spirit of God, manifested itself in a voice, and led this young woman to believe that the missionary enterprise would be unfolded that night if she would obey.', 'Ever Increasing Faith 16:57'),
(1549, 'Ever Increasing Faith', 16, 58, 'This evil spirit said, Don''t tell anybody but your sister. I reckon that everything of God can be told everybody.', 'Ever Increasing Faith 16:58'),
(1550, 'Ever Increasing Faith', 16, 59, 'If you cannot preach what you live, your life is wrong.', 'Ever Increasing Faith 16:59'),
(1551, 'Ever Increasing Faith', 16, 60, 'If you are afraid of telling what you do in secret, some day it will be told from the housetop.', 'Ever Increasing Faith 16:60'),
(1552, 'Ever Increasing Faith', 16, 61, 'Don''t think you will get out of it. That which is pure comes to the light.', 'Ever Increasing Faith 16:61'),
(1553, 'Ever Increasing Faith', 16, 62, 'He that does truth comes to the light that his deeds may be made manifest, that they are wrought in God.', 'Ever Increasing Faith 16:62'),
(1554, 'Ever Increasing Faith', 16, 63, 'The evil power went on to say to this girl, You go to the railroad station tonight, and there will be a train coming at 7:32.', 'Ever Increasing Faith 16:63'),
(1555, 'Ever Increasing Faith', 16, 64, 'Buy a ticket for yourself and your sister. Then you will have six pence left. You will find a woman in a carriage dressed as a nurse,', 'Ever Increasing Faith 16:64'),
(1556, 'Ever Increasing Faith', 16, 65, 'and opposite her will be a gentleman who has all the money you need.', 'Ever Increasing Faith 16:65'),
(1557, 'Ever Increasing Faith', 16, 66, 'She bought her ticket and had just six pence left. The first thing came right. Next, the train came exactly 7:32.', 'Ever Increasing Faith 16:66'),
(1558, 'Ever Increasing Faith', 16, 67, 'But the next thing did not come.', 'Ever Increasing Faith 16:67'),
(1559, 'Ever Increasing Faith', 16, 68, 'They ran from the top to the bottom of that railroad train before it moved out and nothing turned out as they had been told.', 'Ever Increasing Faith 16:68'),
(1560, 'Ever Increasing Faith', 16, 69, 'As soon as the train moved out the same voice came and said, Over on the other platform.', 'Ever Increasing Faith 16:69'),
(1561, 'Ever Increasing Faith', 16, 70, 'All that night until 9:30 these two young women were rushed from platform to platform.', 'Ever Increasing Faith 16:70'),
(1562, 'Ever Increasing Faith', 16, 71, 'As soon as it was 9:30 this same evil power said, Now that I know you will obey me, I will make you the greatest missionaries.', 'Ever Increasing Faith 16:71'),
(1563, 'Ever Increasing Faith', 16, 72, 'Always something big! They might have known it was all wrong.', 'Ever Increasing Faith 16:72'),
(1564, 'Ever Increasing Faith', 16, 73, 'The evil power said, This gentleman will take you to a certain bank at a corner in Glasgow where he will put all the money in for you.', 'Ever Increasing Faith 16:73'),
(1565, 'Ever Increasing Faith', 16, 74, 'Banks are not open at that time of night in Glasgow. If she had gone to the street this evil spirit mentioned, there probably would not have been a bank there.', 'Ever Increasing Faith 16:74'),
(1566, 'Ever Increasing Faith', 16, 75, 'All they needed was a little common sense and they would have seen that it was not the Lord.', 'Ever Increasing Faith 16:75'),
(1567, 'Ever Increasing Faith', 16, 76, 'If you have your heart open for these kinds of voices you will soon get into a trap. We must ever remember that there are many evil spirits in the world.', 'Ever Increasing Faith 16:76'),
(1568, 'Ever Increasing Faith', 16, 77, 'Were these two people delivered? Yes, after terrible travail with God, they were perfectly delivered. Their eyes were opened to see that this thing was not of God but of the devil.', 'Ever Increasing Faith 16:77'),
(1569, 'Ever Increasing Faith', 16, 78, 'These two sisters are now laboring for the Lord in China and doing a blessed work for Him.', 'Ever Increasing Faith 16:78'),
(1570, 'Ever Increasing Faith', 16, 79, 'If you do get into error on these lines, praise God there is a way out.', 'Ever Increasing Faith 16:79'),
(1571, 'Ever Increasing Faith', 16, 80, 'I praise God that He will break us down till all pride leaves us. The worst pride we can have is the pride of exaltation of self.', 'Ever Increasing Faith 16:80'),
(1572, 'Ever Increasing Faith', 16, 81, 'Paul wrote at the commandment of the Lord, Let the prophets speak two or three, and let the others judge.', 'Ever Increasing Faith 16:81'),
(1573, 'Ever Increasing Faith', 16, 82, 'If anything be revealed to another that sits by, let the first hold his peace (1Corinthians 14:29-30).', 'Ever Increasing Faith 16:82'),
(1574, 'Ever Increasing Faith', 16, 83, 'For you may all prophesy one by one, that all may learn, and all may be comforted. If you are not humble enough to allow your prophecy to be judged, it is as surely wrong as you are wrong.', 'Ever Increasing Faith 16:83'),
(1575, 'Ever Increasing Faith', 16, 84, 'Prophecy has to be judged. A meeting such as this one that Paul suggests would certainly be the greatest meeting you ever had.', 'Ever Increasing Faith 16:84'),
(1576, 'Ever Increasing Faith', 16, 85, 'Praise God, the tide will rise to this. It will all come into perfect order when the church is bathed and lost in the great ideal of only glorifying Jesus.', 'Ever Increasing Faith 16:85'),
(1577, 'Ever Increasing Faith', 16, 86, 'Then things will come to pass that will be worthwhile.', 'Ever Increasing Faith 16:86'),
(1578, 'Ever Increasing Faith', 16, 87, 'Coupled with prophecy you will have the fruit of the Spirit that is goodness.', 'Ever Increasing Faith 16:87'),
(1579, 'Ever Increasing Faith', 16, 88, 'They were holy men who spoke in prophecy in days of old as the Holy Ghost prompted them,', 'Ever Increasing Faith 16:88'),
(1580, 'Ever Increasing Faith', 16, 89, 'and so today the prophet who can be trusted is a man that is full of goodness, that goodness which is the fruit of the Spirit.', 'Ever Increasing Faith 16:89'),
(1581, 'Ever Increasing Faith', 16, 90, 'But when he gets out of this position, and rests upon his own individuality, he is in danger of being puffed up and becoming an instrument for the enemy.', 'Ever Increasing Faith 16:90'),
(1582, 'Ever Increasing Faith', 16, 91, 'I know some people who had a wonderful farm, very productive, in a very good neighborhood.', 'Ever Increasing Faith 16:91'),
(1583, 'Ever Increasing Faith', 16, 92, 'They listened to voices telling them to sell everything and go to Africa.', 'Ever Increasing Faith 16:92'),
(1584, 'Ever Increasing Faith', 16, 93, 'These voices so unhinged them that they had scarcely had time to sell out.', 'Ever Increasing Faith 16:93'),
(1585, 'Ever Increasing Faith', 16, 94, 'They sold their property at a ridiculous price. The same voices told them of a certain ship they were to sail on.', 'Ever Increasing Faith 16:94'),
(1586, 'Ever Increasing Faith', 16, 95, 'When they got to the port they found there wasn''t a ship of that name.', 'Ever Increasing Faith 16:95'),
(1587, 'Ever Increasing Faith', 16, 96, 'The difficulty was this, to get them not to believe these false voices.', 'Ever Increasing Faith 16:96'),
(1588, 'Ever Increasing Faith', 16, 97, 'They said perhaps it was the mind of the Lord to give them another ship, and the voice soon gave them the name of another ship.', 'Ever Increasing Faith 16:97'),
(1589, 'Ever Increasing Faith', 16, 98, 'When they reached Africa they knew no language that was spoken there. But the voice did not let them stop.', 'Ever Increasing Faith 16:98'),
(1590, 'Ever Increasing Faith', 16, 99, 'They had to come back, brokenhearted, shaken through, and having lost all confidence in everything.', 'Ever Increasing Faith 16:99'),
(1591, 'Ever Increasing Faith', 16, 100, 'If these people had had sense to go to some men of God who were filled with the Spirit and seek their counsel, they would soon have been persuaded that these voices were not of God.', 'Ever Increasing Faith 16:100'),
(1592, 'Ever Increasing Faith', 16, 101, 'But listening to these voices always brings about a spiritual pride that makes a man or woman think that they are superior to their brethren,', 'Ever Increasing Faith 16:101'),
(1593, 'Ever Increasing Faith', 16, 102, 'and that they are above taking counsel of men who they think are not so filled with the Spirit as they are.', 'Ever Increasing Faith 16:102'),
(1594, 'Ever Increasing Faith', 16, 103, 'If you hear any voices that make you think that you are superior to those whom God has put in the church to rule the church, watch out, that is surely the devil.', 'Ever Increasing Faith 16:103'),
(1595, 'Ever Increasing Faith', 16, 104, 'We read in the book of Revelation that the testimony of Jesus is the spirit of prophecy.', 'Ever Increasing Faith 16:104'),
(1596, 'Ever Increasing Faith', 16, 105, 'You will find that true prophetic utterance always exalts the Lamb of God.', 'Ever Increasing Faith 16:105'),
(1597, 'Ever Increasing Faith', 16, 106, 'No prophetic touch is of any good unless there is fire in it.', 'Ever Increasing Faith 16:106'),
(1598, 'Ever Increasing Faith', 16, 107, 'I never expect to be used of God till the fire burns. I feel that if I ever speak, it must be by the Spirit.', 'Ever Increasing Faith 16:107'),
(1599, 'Ever Increasing Faith', 16, 108, 'At the same time remember that the prophet must prophesy according to the measure of faith.', 'Ever Increasing Faith 16:108'),
(1600, 'Ever Increasing Faith', 16, 109, 'If you rise up in your weakness, but rise up in love because you want to honor God, and just begin, you will find the presence of the Lord upon you. Act in faith and the Lord will meet you.', 'Ever Increasing Faith 16:109'),
(1601, 'Ever Increasing Faith', 16, 110, 'May God take us on and on into the glorious fact of faith, that we may be so in the Holy Ghost that God will work through us on the line of the miraculous and on the lines of prophecy,', 'Ever Increasing Faith 16:110'),
(1602, 'Ever Increasing Faith', 16, 111, 'where we shall always know that it is no longer we but He who is working through us, bringing forth that which is in His own divine good pleasure.', 'Ever Increasing Faith 16:111');
...
(172, 'Who is God that He would take our _______', 'Single Answer', 'place,frame', 'frame'),
(173, 'The ______ inside the ______', 'Single Answer', 'porter-clay,artisan-paint', 'artisan-paint'),
(174, 'Or ________ the very air His breath sustains', 'Single Answer', 'breath,breathe', 'breathe'),
(175, 'The ________ inside the plan', 'Single Answer', 'builder,architect', 'architect'),
(176, 'Oh come now hail His ________', 'Single Answer', 'presence,arrival', 'arrival'),
(177, 'The God of ________', 'Single Answer', 'all creation,creation', 'creation'),
(178, 'Royalty robed in the flesh He _______', 'Single Answer', 'made,created', 'created'),
(179, 'Jesus the ______ has made Himself known', 'Single Answer', 'creator,maker', 'maker'),
(180, 'All hail the _______ infant God', 'Single Answer', 'immortal,infinite', 'infinite'),
(181, 'The One who had no start and _______ no end', 'Single Answer', 'has,knows', 'knows'),
(182, 'Became ________ in time and tense', 'Single Answer', 'restricted,confined', 'confined'),
(183, 'The ________ God', 'Single Answer', 'Almighty,Everlasting', 'Everlasting'),
(184, 'The Great ________', 'Single Answer', 'Yahweh,I Am', 'I Am'),
(185, 'In the mercy of a ________ hands', 'Single Answer', 'mother,mother''s', 'mother''s'),
(186, 'The One who holds the ________', 'Single Answer', 'galaxies,stars', 'stars'),
(191, 'In the ________ of His hands', 'Single Answer', 'palms,creases', 'creases'),
(192, 'Is the One who holds my ______', 'Single Answer', 'life,heart', 'heart'),
(193, 'Like a _______ once held Him', 'Single Answer', 'father,mother', 'mother'),
(194, 'The One who knows what ______', 'Single Answer', 'waits,lies', 'lies'),
(195, 'Where space has run its ________', 'Single Answer', 'duration,course', 'course'),
(196, 'Embraced a _______ mind', 'Single Answer', 'child''s,baby''s', 'baby''s'),
(197, 'And now I can know my _______', 'Single Answer', 'Lord,God', 'God'),
(198, 'The monarch of the ______', 'Single Answer', 'galaxies,stars', 'stars'),
(199, 'The King above all ______', 'Single Answer', 'kings,lords', 'kings'),
(200, 'The ruler of my _______', 'Single Answer', 'life,heart', 'heart'),
(201, 'And the _______ for my sins', 'Single Answer', 'Redeemer,Savior', 'Savior'),
(202, 'The One who sees wha_____', 'Single Answer', 'lies,t lies', 't lies'),
(203, 'In each and every ______', 'Single Answer', 'heart,soul', 'soul'),
(204, 'Embraced our finite ______', 'Single Answer', 'sight,eyes', 'eyes'),
(205, 'And now we can see our ______', 'Single Answer', 'Lord,God', 'God'),
(206, 'The holy Word of God ________ by name', 'Single Answer', 'called,defined', 'defined'),
(207, 'The author ________ inside the page', 'Single Answer', 'came,climbed', 'climbed'),
(208, 'God embraced our ________', 'Single Answer', 'nature,frame', 'frame'),
(209, 'When He ________ the world He made', 'Single Answer', 'loved,graced', 'graced'),
(210, 'All hail the Divine in a _______', 'Single Answer', 'stable,manger', 'manger'),
(211, 'Love embraced our _____', 'Single Answer', 'faith,fate', 'fate'),
(212, 'When the playwright took the _______', 'Single Answer', 'scene,stage', 'stage'),
(213, 'All hail the arrival of our ______', 'Single Answer', 'Lord,King,Maker', 'Maker'),
(214, 'All hail the arrival of ou ______', 'Single Answer', 'r Maker,r Savior', 'r Savior'),
(215, 'All hail the arrival of o______', 'Single Answer', 'ur Savior,ur Maker,Maker', 'ur Maker');
...
--
ALTER TABLE `messagequestions`
  MODIFY `id` mediumint(9) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=8620;
--
...
--
ALTER TABLE `scripturematerials`
  MODIFY `id` mediumint(9) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=1603;
--
...
--
ALTER TABLE `worshipquestions`
  MODIFY `id` mediumint(9) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=216;
