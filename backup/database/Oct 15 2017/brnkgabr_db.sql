...
--
-- Host: localhost
-- Generation Time: Oct 16, 2017 at 05:45 AM
...
) ENGINE=InnoDB AUTO_INCREMENT=7822 DEFAULT CHARSET=latin1;
...
(7732, '...divorce is as old as _______', 'Single Answer', 'man,the fall,Jesus time', 'the fall'),
(7733, '__________ was the first person we know in history to do something officially about marital disintegration.', 'Single Answer', 'John the Baptist,Jesus Christ,Moses', 'Moses'),
(7734, '...a problem has to do with a cause, a symptom has to do with a _________', 'Single Answer', 'effect,result,sign', 'sign'),
(7735, '...divorce is _______ than death', 'Single Answer', 'better,worse', 'worse'),
(7736, '...__________ is used in military when a person have committed themselves to fight for an army or a cause...', 'Single Answer', 'divorce,defection', 'defection'),
(7737, 'Armies are motivated by ________', 'Single Answer', 'life,death', 'death'),
(7738, '...that''s why marriages ________. We keep getting married for life.', 'Single Answer', 'work,fail,don''t work', 'don''t work'),
(7739, 'What do we do when a soldier defects?', 'Single Answer', 'We Court Marshall the Soldier,We kill the soldier', 'We kill the soldier'),
(7740, 'Divorce is worse than physical death because when a person dies there''s closure to the relationship but with divorce, the relationship ends but the people keep resurrecting. True or False?', 'Single Answer', 'True,False', 'True'),
(7741, '<strong>therefore whatever God joins together let no man put asunder.</strong> What bible verse is this?', 'Single Answer', 'Matthew 19:1,Matthew I9:6,Matthew 19:6', 'Matthew 19:6'),
(7742, '<strong>therefore whatever God joins together let no man put asunder.</strong> From this statement, does God join everybody together?', 'Single Answer', 'Yes,No', 'No'),
(7743, '...the people that God joins together are _________', 'Single Answer', 'people who feel like getting married,people who feel they''re old enough,the beginning male and female', 'the beginning male and female'),
(7744, '...anyone who''s building anything, the first thing they lay is the ________', 'Single Answer', 'roof,structure,foundation,windows', 'foundation'),
(7745, '...the foundation is usually never seen after it''s laid. It''s quiet. It''s always underneath the building. Men are supposed to be that way because they''re the foundation of the family. True or False?', 'Single Answer', 'True,False', 'True'),
(7746, '...the Engineer will calculate the entire building before he gives the specifications for the foundation. Who is the Engineer?', 'Single Answer', 'The Man''s parent,The Man,God', 'God'),
(7747, '...the male man was built to carry _____ weight of the family', 'Single Answer', 'the,all the', 'all the'),
(7748, '...most males are not aware of this, so they _______ responsibility.', 'Single Answer', 'avoid that,run away from,evade', 'run away from'),
(7749, '________ is the father of the male', 'Single Answer', 'A man''s father,God', 'God'),
(7750, '________ is the father of the female', 'Single Answer', 'the woman''s father,the male,God', 'the male'),
(7751, '...before we marry someone, we''ve got to check them against the checklist of the _________', 'Single Answer', 'source,beginning,foundation', 'beginning'),
(7752, '...we shouldn''t just marry anybody, we should make sure we marry the right __________', 'Single Answer', 'person,ingredients,material', 'ingredients'),
(7753, '<p><code>what kind of male is the beginning male</code></p><p>#1. He had a clear ________</p>', 'Single Answer', 'image,picture,self concept,self image', 'self image'),
(7754, '<p><code>what kind of male is the beginning male</code></p><p>#2. God took this man and placed him in the Garden of Eden. The word <strong>Eden</strong> means __________</p>', 'Single Answer', 'Garden,State,Presence', 'Presence'),
(7755, '<p><code>what kind of male is the beginning male</code></p><p>#3. The male man was given the first command, that is _________</p>', 'Single Answer', 'look for a job,work,cultivate', 'work'),
(7756, '<p><code>what kind of male is the beginning male</code></p><p>#4. God told him to ________</p>', 'Single Answer', 'protect,work,cultivate', 'cultivate'),
(7757, '<p><code>what kind of male is the beginning male</code></p><p>#5. God told the man to _________</p>', 'Single Answer', 'guard,cultivate,work', 'guard'),
(7758, '...a true male ________ females', 'Single Answer', 'defends,protects', 'protects'),
(7759, '...a real man _______ everything under his care', 'Single Answer', 'protects,guards,defends', 'protects'),
(7760, '<p><code>what kind of male is the beginning male</code></p><p>#6. A real man is the man whom God says _____________ </p>', 'Single Answer', 'keep My Word,do not touch the tree', 'do not touch the tree'),
(7761, '_______ was given the Word of God', 'Single Answer', 'the male,the female', 'the male'),
(7762, '...the male was designed by God to be the ________ of the Word.', 'Single Answer', 'preacher,teacher,pastor', 'teacher'),
(7763, '...a real man knows this book called the bible back to front. True or False?', 'Single Answer', 'True,False', 'True'),
(7764, '...a man must be like Adam to guarantee a good home. True or False?', 'Single Answer', 'True,False', 'True'),
(7765, '... if you study the Word of God, all the priests who worship were _______', 'Single Answer', 'male,female', 'male'),
(7766, '...real men ________', 'Single Answer', 'praise,worship,reverence', 'worship'),
(7767, 'An altar is a _________', 'Single Answer', 'platform,worship center', 'worship center'),
(7768, '...that means if a man doesn''t know who he is, is not in God''s presence, cannot cultivate, cannot protect, cannot teach God''s Word. It is good for that man to be _________', 'Single Answer', 'married,single,alone', 'alone'),
(7769, '...don''t read into the bible, read out of the bible. This means we shouldn''t read the bible to support our ideas but drop our ideas and read what the bible has to say. True or False?', 'Single Answer', 'True,False', 'True'),
(7770, 'Did God bring Adam a wife?', 'Single Answer', 'Yes,No', 'No'),
(7771, '...the man is a spirit the woman is __________', 'Single Answer', 'flesh,a spirit,a female', 'a spirit'),
(7772, '...the man is has no gender because he is a spirit. The woman has no gender because she is a spirit. True or False?', 'Single Answer', 'True,False', 'True'),
(7773, '...the man is has no gender because he is a spirit. The woman has no gender because she is a spirit because Man is the spirit, male is the body that houses the man. Wo-man is a spirit, female is the body that houses the woman. True or False?', 'Single Answer', 'True,False', 'True'),
(7774, '...every female has a ________ on the inside, a spirit being', 'Single Answer', 'woman,man', 'man'),
(7775, 'Who did Jesus leave God''s Word in the hands of?', 'Single Answer', 'a man,a woman', 'a woman'),
(7776, 'The name of this woman is __________', 'Single Answer', 'Mary Magdalene,Mary the mother of Jesus,Joanna,The Church', 'The Church'),
(7777, '...inside this _______ is a man, she''s a spirit being. That''s why the male and female are equal but different. What makes them different is their bodies. The house they live in.', 'Single Answer', 'female,woman', 'female'),
(7778, '...the female like the male is _________', 'Single Answer', 'a spirit,dirt,invisible,invincible,physical,spiritual', 'physical'),
(7779, '...the male is ________, the female is _______. In other words, their bodies operate on senses', 'Single Answer', 'acute,sharp,sensual,perceptive', 'sensual'),
(7780, '<strong>...the male is the temple of the Spirit. the female is the temple of the Spirit.</strong> What bible verse verifies this?', 'Single Answer', '1Corinthians 16:9,1Corinthians 6:19', '1Corinthians 6:19'),
(7781, '...the _______was placed in the garden first', 'Single Answer', 'female,male', 'male'),
(7782, '...a lady should always marry a man she meets in the Garden (Presence of the Lord). True or False?', 'Single Answer', 'True,False', 'True'),
(7783, '...as a lady, you don''t go out of the Presence of the Lord to find a man to marry and try to get him back in the Presence of the Lord. There''s a reason the man is out of the Presence of the Lord. If you do, you''ll spend your entire marriage fighting this reason. True or False?', 'Single Answer', 'True,False', 'True'),
(7784, '...the man was given the Word first. But she was not given the Word directly. She is ______ to be the recipient of the Word through the male.', 'Single Answer', 'meant,supposed', 'supposed'),
(7785, '...the male is the responsible head. Head doesn''t mean better, it means _________', 'Single Answer', 'worker,better,responsible', 'responsible'),
(7786, '...the male is the provider, he''s the source. She is supposed to be the __________', 'Single Answer', 'receiver,incubator', 'incubator'),
(7787, '...he''s the cultivator, she''s supposed to be the ________', 'Single Answer', 'producer,provider', 'producer'),
(7788, '...he''s the giver, she''s supposed to be the _________', 'Single Answer', 'taker,receiver', 'receiver'),
(7789, '...he''s the protector, she''s supposed to be the ________', 'Single Answer', 'gatekeeper,encourager', 'encourager'),
(7790, '...he''s the developer, she''s supposed to be the ________', 'Single Answer', 'caretaker,nurturer', 'nurturer'),
(7791, '...he''s the source as the teacher, she''s supposed to be the resource-the one who gives the ________ after she learns them from her husband.', 'Single Answer', 'instructions,commands', 'commands'),
(7792, '...he''s the teacher but she''s the ___________', 'Single Answer', 'priestess,prophetess', 'prophetess'),
(7793, '...as a man, you don''t want to marry a woman who comes to tell you how to run your life. You''re supposed to get how to run your life from God. True or False?', 'Single Answer', 'True,False', 'True'),
(7794, '...a ________ woman helps her husband achieve', 'Single Answer', 'smart,wise,prudent', 'wise'),
(7795, '...a good woman studies her husband. She doesn''t irritate him, she doesn''t criticize him. She keeps _______', 'Single Answer', 'studying him,asking him questions', 'asking him questions'),
(7796, '...the Holy Spirit is called the very same thing the woman is called ___________', 'Single Answer', 'comforter,helper,paracletus,all of the above', 'all of the above'),
(7797, '...men make sure you have _________ before you invite a woman into your life.', 'Single Answer', 'an assignment,a vision', 'a vision'),
(7798, '...women, if you meet a man with a vision, don''t create _________ in the house', 'Single Answer', 'division,two visions', 'two visions'),
(7799, '...the prefix _____ means two', 'Single Answer', 'bi,di', 'di'),
(7800, '_______ is the word for divorce (Hint: 54:57)', 'Single Answer', 'division,defection', 'division'),
(7801, '...God designed the woman to be _________, her whole body is __________', 'Single Answer', 'a producer-production,an incubator-incubation', 'an incubator-incubation'),
(7802, '...no wonder why Peter says, <strong>...women, be like Sarah. Live a quiet life, have a quiet spirit, don''t be noisy, don''t be gossipers...</strong> What bible verse verifies this?', 'Single Answer', '2Peter 1:1-6,1Peter 3:1-6,1Peter 3:7-12', '1Peter 3:1-6'),
(7803, '...a man is a protector, a woman is __________', 'Single Answer', 'a defender,an encourager', 'an encourager'),
(7804, '<strong>The heart of her husband does safely trust in her, so that he shall have no need of spoil.</strong> What bible verse is this?', 'Single Answer', 'Proverbs 31:1,Proverbs 31:2,Proverbs 31:1I,none of the above', 'none of the above'),
(7805, '...a female is ________ that means she receives information, she expands it and she gives it back to you.', 'Single Answer', 'an encourager,an incubator', 'an incubator'),
(7806, '<strong>And it shall come to pass afterward, that I will pour out my spirit upon all flesh; and your sons and your daughters shall prophesy, your old men shall dream dreams, your young men shall see visions:</strong> What bible verse is this?', 'Single Answer', 'Joel 2:11,Joel 2:28', 'Joel 2:28'),
(7807, '...the #1 need of a male is ________', 'Single Answer', 'love,sex,respect,affection', 'sex'),
(7808, '...the #1 need of a man is ________', 'Single Answer', 'sex,love,affection,God', 'God'),
(7809, '...the #1 need of a male is sex. Because the male is designed by God to be a ________', 'Single Answer', 'generator,progenerator', 'progenerator'),
(7810, '...a need is something that helps you _________', 'Single Answer', 'operate,function', 'function'),
(7811, '...a woman''s #1 need is ________', 'Single Answer', 'sex,love,affection', 'affection'),
(7812, '...women have _____ seasons', 'Single Answer', '2,3,4', '4'),
(7813, '...a good marriage is built on a man who understands sensitivity, and a woman who understands the need of a man. True or False?', 'Single Answer', 'True,False', 'True'),
(7814, '<strong>Marriage is honourable in all, and the bed undefiled: but whoremongers and adulterers God will judge.</strong> What bible verse is this?', 'Single Answer', 'Hebrews 12:4,Hebrews 13:4,Hebrews 11:4', 'Hebrews 13:4'),
(7815, '________ is a multiplication of families', 'Single Answer', 'a nation,a community', 'a community'),
(7816, '________ is a multiplication of communities', 'Single Answer', 'a country,a nation,a family', 'a nation'),
(7817, '<strong>And he shall turn the heart of the fathers to the children, and the heart of the children to their fathers...</strong> What bible verse has the highlighted?', 'Single Answer', 'Malachi 4:6,Malichi 4:6,Milachi 4:6', 'Malachi 4:6'),
(7818, '...a woman is as good as the man makes her. True or False?', 'Single Answer', 'True,False', 'True'),
(7819, '...a marriage is as good as the male and female in it. True or False?', 'Single Answer', 'True,False', 'True'),
(7820, '...singleness is more important than marriage, because our marriage is only as good as our singleness. True or False?', 'Single Answer', 'True,False', 'True'),
(7821, '...________ don''t keep company with people who are failing, because you will incubate their failure and bring it into your own house.', 'Single Answer', 'men,ladies', 'ladies');
...
(25, 'Oluwanifemi', 'Fawale', '11', 'oluwanifemifawale@gmail.com', '5f1cf5af2ac6807754b1825d0250ee8be60ed712', '1860.701', '4th', '34', 'ff0080', 'OF', 'pink_femi838', 'oluwanifemifawalescores', '', '{"cTab":"Scripture","wQAnswered":"48","wQGotten":"48","wQMissed":"0","mQAnswered":"90","mQGotten":"90","mQMissed":"0","sTyped":"43","sWordsTyped":"His Word cannot fail. God''s Word is true and when we rest in the fact of its truth what might results we can get.","sGotten":"36","sMissed":"7","tPoints":"1670","eAForToday":"151.803","totalAggregate":"1860.701","email":"oluwanifemifawale@gmail.com","age":"11"}'),
(26, 'Bolu', 'Ayodele', '12', 'boluayodele@gmail.com', 'c83f1de735de8aac5000a7773b24bfb03674df08', '316.583', '21st', '0', '400040', 'BA', 'chris', 'boluayodelescores', '', ''),
(27, 'Oluwaseyi', 'Alofe', '10', 'oluwaseyialofe13@gmail.com', '9125a5ca7d2d99dec906b5548dec123f66da5711', '496.92', '16th', '0', 'FF530C', 'OA', 'Lilshay', 'oluwaseyialofescores', '', '{"cTab":"Scripture","wQAnswered":"48","wQGotten":"48","wQMissed":"0","mQAnswered":"0","mQGotten":"0","mQMissed":"0","sTyped":"13","sWordsTyped":"That is God''s purpose, and as we by faith lay hold on the purpose we shall be ever conscious of the fact that greater is He that is in us than he that is in the world-1John 4:4.","sGotten":"9","sMissed":"4","tPoints":"530","eAForToday":"53","totalAggregate":"496.92","email":"oluwaseyialofe13@gmail.com","age":"10"}'),
...
(29, 'Prosper', 'Falodun', '11', 'prosperfalodun@gmail.com', '16254f13cea30be88237e04d059e57802a28b819', '682.935', '13th', '0', '3a2805', 'PF', 'pros353', 'prosperfalodunscores', '', '{"cTab":"Worship","wQAnswered":"48","wQGotten":"47","wQMissed":"1","mQAnswered":"0","mQGotten":"0","mQMissed":"0","sTyped":"0","sWordsTyped":"","sGotten":"0","sMissed":"0","tPoints":"460","eAForToday":"41.814","totalAggregate":"682.935","email":"prosperfalodun@gmail.com","age":"11"}'),
...
(35, 'Muyiwa', 'Ayodele', '10', 'muyiwaayodele699@gmail.com', 'd8710eaa45154bbc0f10f48f4e3d27d3a0fccc82', '165.25', '26th', '0', 'e60000', 'MA', 'Trevor', 'muyiwaayodelescores', '', ''),
...
(37, 'James', 'Otokiti', '13', 'jamesotokiti@gmail.com', 'caf9ceb956dfc1bdca4783f2a851ce7051e149c1', '157.254', '27th', '0', '205523', 'JO', '7th Hokage', 'jamesotokitiscores', '', '{"cTab":"Worship","wQAnswered":"48","wQGotten":"47","wQMissed":"1","mQAnswered":"0","mQGotten":"0","mQMissed":"0","sTyped":"0","sWordsTyped":"","sGotten":"0","sMissed":"0","tPoints":"460","eAForToday":"35.374","totalAggregate":"157.254","email":"jamesotokiti@gmail.com","age":"13"}'),
(38, 'Adebayo', 'Inioluwa', '11', 'adebayoinioluwa@gmail.com', '0a301781fc9fa0f094ef9fb1781e26f70daabe7e', '53.884', '35th', '0', '000000', 'AI', 'ini', 'adebayoinioluwascores', '', ''),
(39, 'Adebayo', 'Omolade', '18', 'adebayoomolade@gmail.com', '957afdf565bcf7c16174f04309f9f5f5aa07f33d', '50.242', '36th', '0', '400040', 'AO', 'lade', 'adebayoomoladescores', '', ''),
(40, 'Adebayo', 'Oluwatunbukunmi', '14', 'adebayooluwatunbukunmi@gmail.com', 'a53fc2b89ed768b53708b933ae6cf8648ba60041', '78.088', '32nd', '0', '2b002b', 'AO', 'Lizzy', 'adebayooluwatunbukunmiscores', '', '{"cTab":"Worship","wQAnswered":"28","wQGotten":"23","wQMissed":"5","mQAnswered":"0","mQGotten":"0","mQMissed":"0","sTyped":"0","sWordsTyped":"","sGotten":"0","sMissed":"0","tPoints":"180","eAForToday":"12.852","totalAggregate":"78.088","email":"adebayooluwatunbukunmi@gmail.com","age":"14"}'),
(41, 'Adebayo', 'Temiloluwa', '16', 'temiloluwabdy@gmail.com', '7083c7b0ca2977fedbd65ac2889410763c7c9f9f', '61.5', '34th', '0', '800000', 'AT', 'Mac-Switch', 'adebayotemiloluwascores', '', '{"cTab":"Message","wQAnswered":"48","wQGotten":"37","wQMissed":"11","mQAnswered":"2","mQGotten":"1","mQMissed":"1","sTyped":"0","sWordsTyped":"","sGotten":"0","sMissed":"0","tPoints":"260","eAForToday":"16.25","totalAggregate":"61.5","email":"temiloluwabdy@gmail.com","age":"16"}'),
...
(43, 'Kolawole', 'Otokiti', '10', 'kolawoleotokiti@gmail.com', 'fb76b9af8c64358dcdbe8636dd8b189ed98cd5a7', '67.75', '33rd', '0', '000040', 'KO', 'Emmanuel', 'kolawoleotokitiscores', '', '{"cTab":"Worship","wQAnswered":"48","wQGotten":"40","wQMissed":"8","mQAnswered":"0","mQGotten":"0","mQMissed":"0","sTyped":"0","sWordsTyped":"","sGotten":"0","sMissed":"0","tPoints":"320","eAForToday":"32","totalAggregate":"67.75","email":"kolawoleotokiti@gmail.com","age":"10"}'),
...
(1, 'quiz', 'Materials', '2017-10-13 23:59:00');
...
(371, 'Ever Increasing Faith', 8, 1, 'It is written of our blessed Lord, You have loved righteousness, and hated iniquity; therefore God, even Your God has anointed You with the oil of gladness above Your fellows (Hebrews 1:9).', 'Ever Increasing Faith 8:1'),
(372, 'Ever Increasing Faith', 8, 2, 'It is the purpose of God that we, as we are indwelt by the Spirit of His Son, should likewise love righteousness and hate iniquity.', 'Ever Increasing Faith 8:2'),
(373, 'Ever Increasing Faith', 8, 3, 'I see that there is a place for us in Christ Jesus where we are no longer under condemnation but where the heavens are always open to us.', 'Ever Increasing Faith 8:3'),
(374, 'Ever Increasing Faith', 8, 4, 'I see that God has a realm of divine life opening up to us where there are boundless possibilities, where there is limitless power, where there are untold resources, where we have victory over all the power of the devil.', 'Ever Increasing Faith 8:4'),
(375, 'Ever Increasing Faith', 8, 5, 'I believe that, as we are filled with the desire to press on into this life of true holiness, desiring only the glory of God, there is nothing that can hinder our true advancement.', 'Ever Increasing Faith 8:5'),
(376, 'Ever Increasing Faith', 8, 6, 'Peter commences his second epistle with these words, Simon Peter, a servant and an apostle of Jesus Christ, to them that have obtained like precious faith with us through the righteousness of God and our Savior Jesus Christ-2Peter 1:1.', 'Ever Increasing Faith 8:6'),
(377, 'Ever Increasing Faith', 8, 7, 'It is through faith that we realize that we have a blessed and glorious union with our risen Lord.', 'Ever Increasing Faith 8:7'),
(378, 'Ever Increasing Faith', 8, 8, 'When He was on earth Jesus told us, I am in the Father and the Father in me-John 14:10.', 'Ever Increasing Faith 8:8'),
(379, 'Ever Increasing Faith', 8, 9, 'The Father that dwells in Me, He does the works.', 'Ever Increasing Faith 8:9'),
(380, 'Ever Increasing Faith', 8, 10, 'And He prayed to His Father, not only for His disciples but for those who should believe on Him through their word, That they all may be one; as You Father, art in Me, and I in Thee, that they also may be one in us:', 'Ever Increasing Faith 8:10'),
(381, 'Ever Increasing Faith', 8, 11, 'that the world may believe that You have sent Me.', 'Ever Increasing Faith 8:11'),
(382, 'Ever Increasing Faith', 8, 12, 'Oh what an inheritance is ours when the very nature, the very righteousness, the very power of the Father and the Son are made real in us.', 'Ever Increasing Faith 8:12'),
(383, 'Ever Increasing Faith', 8, 13, 'That is God''s purpose, and as we by faith lay hold on the purpose we shall be ever conscious of the fact that greater is He that is in us than he that is in the world-1John 4:4.', 'Ever Increasing Faith 8:13'),
(384, 'Ever Increasing Faith', 8, 14, 'The purpose of all Scripture is to move us on to this wonderful and blessed elevation of faith where our constant experience is the manifestation of God''s life and power through us.', 'Ever Increasing Faith 8:14'),
(385, 'Ever Increasing Faith', 8, 15, 'Peter goes on writing to these who have obtained like precious faith, saying, Grace and peace be multiplied unto you through the knowledge of God, and of Jesus our Lord-2Peter 1:2.', 'Ever Increasing Faith 8:15'),
(386, 'Ever Increasing Faith', 8, 16, 'We can have the multiplication of this grace and peace only as we live in the realm of faith.', 'Ever Increasing Faith 8:16'),
(387, 'Ever Increasing Faith', 8, 17, 'Abraham attained to the place where he became a friend of God, on no other line than that of believing God.', 'Ever Increasing Faith 8:17'),
(388, 'Ever Increasing Faith', 8, 18, 'He believed God and God counted that to him for righteousness.', 'Ever Increasing Faith 8:18'),
(389, 'Ever Increasing Faith', 8, 19, 'Righteousness was imputed to him on no other ground than that he believed God.', 'Ever Increasing Faith 8:19'),
(390, 'Ever Increasing Faith', 8, 20, 'Can this be true of anybody else? Yes, every person in the whole wide world who is saved by faith is blessed with faithful Abraham.', 'Ever Increasing Faith 8:20'),
(391, 'Ever Increasing Faith', 8, 21, 'The promise, which came to him because he believed God, was that in Him all the families of the earth should be blessed.', 'Ever Increasing Faith 8:21'),
(392, 'Ever Increasing Faith', 8, 22, 'When we believe God there is no knowing where the blessing of our faith will end.', 'Ever Increasing Faith 8:22'),
(393, 'Ever Increasing Faith', 8, 23, 'Some are tied up because, when they are prayed for, the thing that they are expecting does not come off the same night.', 'Ever Increasing Faith 8:23'),
(394, 'Ever Increasing Faith', 8, 24, 'They say they believe, but you can see that they are really in turmoil of unbelief.', 'Ever Increasing Faith 8:24'),
(395, 'Ever Increasing Faith', 8, 25, 'Abraham believed God. You can hear him saying to Sarah, Sarah, there is no life in you and there is nothing in me, but God has promised us a son and I believe God.', 'Ever Increasing Faith 8:25'),
(396, 'Ever Increasing Faith', 8, 26, 'And that kind of faith is a joy to our Father in heaven.', 'Ever Increasing Faith 8:26'),
(397, 'Ever Increasing Faith', 8, 27, 'One day I was having a meeting in Bury, in Lancashire, England. A young woman was present who came from a place called Ramsbottom, to be healed of goiter.', 'Ever Increasing Faith 8:27'),
(398, 'Ever Increasing Faith', 8, 28, 'Before she came, she said, I am going to be healed of this goiter, mother.', 'Ever Increasing Faith 8:28'),
(399, 'Ever Increasing Faith', 8, 29, 'After one meeting she came forward and was prayed for.', 'Ever Increasing Faith 8:29'),
(400, 'Ever Increasing Faith', 8, 30, 'The next meeting she got up and testified that she had been wonderfully healed, and she said, I shall be so happy to go and tell mother that I have been wonderfully healed.', 'Ever Increasing Faith 8:30'),
(401, 'Ever Increasing Faith', 8, 31, 'She went to her home and testified how wonderfully she had been healed, and the next year when we were having the convention she came again.', 'Ever Increasing Faith 8:31'),
(402, 'Ever Increasing Faith', 8, 32, 'To the natural view it looked as though the goiter was just as big as ever; but that young woman was believing God and she was soon on her feet giving her testimony,', 'Ever Increasing Faith 8:32'),
(403, 'Ever Increasing Faith', 8, 33, 'and saying, I was here last year and the Lord wonderfully healed me. I want to tell you that this has been the best year of my life.', 'Ever Increasing Faith 8:33'),
(404, 'Ever Increasing Faith', 8, 34, 'She seemed to be greatly blessed in that meeting and she went home to testify more strongly than ever that the Lord had healed her.', 'Ever Increasing Faith 8:34'),
(405, 'Ever Increasing Faith', 8, 35, 'She believed God. The third year she was at the meeting again, and some people who looked at her said, How big that goiter has become.', 'Ever Increasing Faith 8:35'),
(406, 'Ever Increasing Faith', 8, 36, 'But when the time came for testimony she was up on her feet and testified. Two years ago the Lord graciously healed me of goiter.', 'Ever Increasing Faith 8:36'),
(407, 'Ever Increasing Faith', 8, 37, 'Oh I had a most wonderful healing. It is grand to be healed by the power of God.', 'Ever Increasing Faith 8:37'),
(408, 'Ever Increasing Faith', 8, 38, 'That day someone remonstrated with her and said, People will think there is something the matter with you.', 'Ever Increasing Faith 8:38'),
(409, 'Ever Increasing Faith', 8, 39, 'Why don''t you look in the glass? You will see that your goiter is bigger than ever.', 'Ever Increasing Faith 8:39'),
(410, 'Ever Increasing Faith', 8, 40, 'That good woman went to the Lord about it and said, Lord, you so wonderfully healed me two years ago. Won''t you show all the people that you healed me?', 'Ever Increasing Faith 8:40'),
(411, 'Ever Increasing Faith', 8, 41, 'She went to sleep peacefully that night still believing God and when she came down the next day there was not a trace or a mark of that goiter.', 'Ever Increasing Faith 8:41'),
(412, 'Ever Increasing Faith', 8, 42, 'God''s Word is from everlasting to everlasting.', 'Ever Increasing Faith 8:42'),
(413, 'Ever Increasing Faith', 8, 43, 'His Word cannot fail. God''s Word is true and when we rest in the fact of its truth what mighty results we can get.', 'Ever Increasing Faith 8:43'),
(414, 'Ever Increasing Faith', 8, 44, 'Faith never looks in the glass. Faith has a glass into which it can look. It is the glass of the perfect law of liberty (the Word of God).', 'Ever Increasing Faith 8:44'),
(415, 'Ever Increasing Faith', 8, 45, 'Whoso looks into the perfect law of liberty, and continues therein, he being not a forgetful hearer, but a doer of the work, this man shall be blessed in his deed-James 1:25.', 'Ever Increasing Faith 8:45'),
(416, 'Ever Increasing Faith', 8, 46, 'To the man who looks into this perfect law of God all darkness is removed and he sees his completeness in Christ.', 'Ever Increasing Faith 8:46'),
(417, 'Ever Increasing Faith', 8, 47, 'There is no darkness in faith. There is only darkness in nature. Darkness only exists when the natural is put in the place of the divine.', 'Ever Increasing Faith 8:47'),
(418, 'Ever Increasing Faith', 8, 48, 'Not only is grace multiplied to us through knowledge of God and of Jesus Christ, but peace also.', 'Ever Increasing Faith 8:48'),
(419, 'Ever Increasing Faith', 8, 49, 'As we really know our God and Jesus Christ whom He has sent, we will have peace multiplied to us even in the multiplied fires of ten thousand Nebuchadnezzars.', 'Ever Increasing Faith 8:49'),
(420, 'Ever Increasing Faith', 8, 50, 'It will be multiplied to us even though we are put into the den of lions, and we will live with joy in the midst of the whole thing.', 'Ever Increasing Faith 8:50'),
(421, 'Ever Increasing Faith', 8, 51, 'What was the difference between Daniel and the king that night when Daniel was put into the den of lions?', 'Ever Increasing Faith 8:51'),
(422, 'Ever Increasing Faith', 8, 52, 'Daniel knew, but the king was experimenting. Oh Daniel, servant of the living God, is your God, whom you serve continually, able to deliver you from the lions?', 'Ever Increasing Faith 8:52'),
(423, 'Ever Increasing Faith', 8, 53, 'Daniel answered, My God has sent His angel, and has shut the lions'' mouths-Daniel 6:22.', 'Ever Increasing Faith 8:53'),
(424, 'Ever Increasing Faith', 8, 54, 'The thing was done. It was done when Daniel prayed with his windows open toward heaven.', 'Ever Increasing Faith 8:54'),
(425, 'Ever Increasing Faith', 8, 55, 'All our victories are won before we go into the fight. Prayer links us on to our lovely God, our abounding God, our multiplying God. Oh I love Him! He is so wonderful!', 'Ever Increasing Faith 8:55'),
(426, 'Ever Increasing Faith', 8, 56, 'You will note, as you read these first two verses of the first chapter of the second epistle of Peter, that this grace and peace is multiplied through the knowledge of God, but that first our faith comes through the righteousness of God.', 'Ever Increasing Faith 8:56'),
(427, 'Ever Increasing Faith', 8, 57, 'Note that righteousness comes first and knowledge afterwards.', 'Ever Increasing Faith 8:57'),
(428, 'Ever Increasing Faith', 8, 58, 'It cannot be otherwise. If you expect any revelation of God apart from holiness you will have only a mixture.', 'Ever Increasing Faith 8:58'),
(429, 'Ever Increasing Faith', 8, 59, 'Holiness opens the door to all the treasures of God. He must first bring us to the place where we, like our Lord, love righteousness and hate iniquity, before He opens up to us these good treasures.', 'Ever Increasing Faith 8:59'),
(430, 'Ever Increasing Faith', 8, 60, 'When we regard iniquity in our hearts the Lord will not hear us-Psalms 66:18, and it is only as we are made righteous and pure and holy through the precious blood of God''s Son that we can enter into this life of holiness and righteousness in the Son.', 'Ever Increasing Faith 8:60'),
(431, 'Ever Increasing Faith', 8, 61, 'It is the righteousness of our Lord Himself made real in us as our faith is stayed in Him.', 'Ever Increasing Faith 8:61'),
(432, 'Ever Increasing Faith', 8, 62, 'After I was baptized with the Holy Ghost the Lord gave me a blessed revelation.', 'Ever Increasing Faith 8:62'),
(433, 'Ever Increasing Faith', 8, 63, 'I saw Adam and Eve turned out of the garden for their disobedience and unable to partake of the tree of life, for the cherubim with flaming sword kept them away from this tree.', 'Ever Increasing Faith 8:63'),
(434, 'Ever Increasing Faith', 8, 64, 'When I was baptized I saw that I had begun to eat of this tree of life and I saw that the flaming sword was all round about.', 'Ever Increasing Faith 8:64'),
(435, 'Ever Increasing Faith', 8, 65, 'It was there to keep the devil away. Oh, what privileges are ours when we are born of God. How marvelously He keeps us so that the wicked one touches us not.', 'Ever Increasing Faith 8:65'),
(436, 'Ever Increasing Faith', 8, 66, 'I see a place in God where satan dare not come. Hidden in God. And He invites us all to come and share this wonderful hidden place where our lives are hid with Christ in God-Colossians 3:3,', 'Ever Increasing Faith 8:66'),
(437, 'Ever Increasing Faith', 8, 67, 'where we dwell in the secret place of the Most High and abide under the shadow of the Almighty. God has this place for you in this blessed realm of grace.', 'Ever Increasing Faith 8:67'),
(438, 'Ever Increasing Faith', 8, 68, 'Peter goes on to say, According as His divine power has given unto us all things that pertain unto life and godliness, through the knowledge of Him that has called us to glory and virtue-2Peter 1:3.', 'Ever Increasing Faith 8:68'),
(439, 'Ever Increasing Faith', 8, 69, 'God is calling us to this realm of glory and virtue where, as we feed on His exceeding great and precious promises, we are made partakers of the divine nature.', 'Ever Increasing Faith 8:69'),
(440, 'Ever Increasing Faith', 8, 70, 'Faith is the substance of things hoped for right here in this life-Hebrews 11:1. It is right here that God would have us partake of His divine nature.', 'Ever Increasing Faith 8:70'),
(441, 'Ever Increasing Faith', 8, 71, 'It is nothing less than the life of the Lord Himself imparted and flowing into our whole being, so that our very body is quickened,', 'Ever Increasing Faith 8:71'),
(442, 'Ever Increasing Faith', 8, 72, 'so that every tissue and every drop of blood and our bones and joints and marrow receive this divine life.', 'Ever Increasing Faith 8:72'),
(443, 'Ever Increasing Faith', 8, 73, 'I believe that the Lord wants this divine life to flow right into our natural bodies, this law of the spirit of life in Christ Jesus that makes us free from the law of sin and death-Romans 8:2.', 'Ever Increasing Faith 8:73'),
(444, 'Ever Increasing Faith', 8, 74, 'God wants to establish our faith so that we shall lay hold on this divine life, this divine nature of the Son of God,', 'Ever Increasing Faith 8:74'),
(445, 'Ever Increasing Faith', 8, 75, 'so that our spirit and soul and body will be sanctified wholly and preserved unto the coming of the Lord Jesus Christ.', 'Ever Increasing Faith 8:75'),
(446, 'Ever Increasing Faith', 8, 76, 'When that woman was healed of the issue of blood, Jesus perceived that power had gone out of Him.', 'Ever Increasing Faith 8:76'),
(447, 'Ever Increasing Faith', 8, 77, 'The woman''s faith laid hold and this power was imparted and immediately the woman''s being was surcharged with life and her weakness departed.', 'Ever Increasing Faith 8:77'),
(448, 'Ever Increasing Faith', 8, 78, 'The impartation of this power produces everything you need; but it comes only as our faith moves out for its impartation. Faith is the victory. If you can believe, it is yours.', 'Ever Increasing Faith 8:78'),
(449, 'Ever Increasing Faith', 8, 79, 'I suffered for many years from piles, till my whole body was thoroughly weak; the blood used to gush from me.', 'Ever Increasing Faith 8:79'),
(450, 'Ever Increasing Faith', 8, 80, 'One day I got desperate and I took a bottle of oil and anointed myself. I said to the Lord, Do what you want to, quickly.', 'Ever Increasing Faith 8:80'),
(451, 'Ever Increasing Faith', 8, 81, 'I was healed at that very moment. God wants us to have an activity of faith that dares to believe God.', 'Ever Increasing Faith 8:81'),
(452, 'Ever Increasing Faith', 8, 82, 'There is what seems like faith, an appearance of faith, but real faith believes God right to the end.', 'Ever Increasing Faith 8:82'),
(453, 'Ever Increasing Faith', 8, 83, 'What was the difference between Zacharias and Mary? The angel came to Zacharias and told him, Your wife Elizabeth will bear you a son.', 'Ever Increasing Faith 8:83'),
(454, 'Ever Increasing Faith', 8, 84, 'Zacharias was there in the holy place, but he began to question this message, saying, I am an old man, my wife is well stricken in years.', 'Ever Increasing Faith 8:84'),
(455, 'Ever Increasing Faith', 8, 85, 'Gabriel rebuked him for his unbelief and told him, You will be dumb, and not able to speak, until the day that these things will be performed, because you did not believe my words.', 'Ever Increasing Faith 8:85'),
(456, 'Ever Increasing Faith', 8, 86, 'But note the contrast when the angel came to Mary. She said, Behold the handmaid of the Lord; be it unto me according to your word.', 'Ever Increasing Faith 8:86'),
(457, 'Ever Increasing Faith', 8, 87, 'And Elizabeth greeted Mary with the words, Blessed is she that believed: for there will be a performance of those things which were told her from the Lord.', 'Ever Increasing Faith 8:87'),
(458, 'Ever Increasing Faith', 8, 88, 'God would have us to lay hold on His Word in like manner. He would have us to come with boldness of faith declaring, You have promised it, Lord. Now do it.', 'Ever Increasing Faith 8:88'),
(459, 'Ever Increasing Faith', 8, 89, 'God rejoices when we manifest a faith that holds Him to His Word. Can we get there?', 'Ever Increasing Faith 8:89'),
(460, 'Ever Increasing Faith', 8, 90, 'The Lord has called us to this glory and virtue; and, as our faith lays hold on Him, we shall see this in manifestation.', 'Ever Increasing Faith 8:90'),
(461, 'Ever Increasing Faith', 8, 91, 'I remember one day I was holding an open-air meeting. My uncle came to that meeting and said, Aunt Mary would like to see Smith before she dies.', 'Ever Increasing Faith 8:91'),
(462, 'Ever Increasing Faith', 8, 92, 'I went to see her and she was assuredly dying. I said, Lord, can''t you do something? All I did was this, to stretch out my hands and lay them on her.', 'Ever Increasing Faith 8:92'),
(463, 'Ever Increasing Faith', 8, 93, 'It seemed as though there was an immediate impartation of the glory and virtue of the Lord. Aunt Mary cried, It is going all over my body. And that day she was made perfectly whole.', 'Ever Increasing Faith 8:93'),
(464, 'Ever Increasing Faith', 8, 94, 'One day I was preaching and a man brought a boy who was done up in bandages.', 'Ever Increasing Faith 8:94'),
(465, 'Ever Increasing Faith', 8, 95, 'The boy was in irons and it was impossible for him to walk and it was difficult for them to get him to the platform.', 'Ever Increasing Faith 8:95'),
(466, 'Ever Increasing Faith', 8, 96, 'They passed him over about six seats. The power of the Lord was present to heal and it entered right into the child as I placed my hands on him.', 'Ever Increasing Faith 8:96'),
(467, 'Ever Increasing Faith', 8, 97, 'The child cried, Daddy, it is going all over me. They stripped the boy and found nothing imperfect in him.', 'Ever Increasing Faith 8:97'),
(468, 'Ever Increasing Faith', 8, 98, 'The Lord would have us to be walking epistles of His Word. Jesus is the Word and is the power in us, and it is His desire to work in and through us His own good pleasure.', 'Ever Increasing Faith 8:98'),
(469, 'Ever Increasing Faith', 8, 99, 'We must believe that He is in us.', 'Ever Increasing Faith 8:99'),
(470, 'Ever Increasing Faith', 8, 100, 'There are boundless possibilities for us if we dare to act in God and dare to believe that the wonderful virtue of our living Christ shall be made manifest through us as we lay our hands on the sick in His name.', 'Ever Increasing Faith 8:100'),
(471, 'Ever Increasing Faith', 8, 101, 'The exceeding great and precious promises of the Word are given to us that we might be partakers of the divine nature.', 'Ever Increasing Faith 8:101'),
(472, 'Ever Increasing Faith', 8, 102, 'I feel the Holy Ghost is grieved with us because, when we know these things, we do not do greater exploits for God.', 'Ever Increasing Faith 8:102'),
(473, 'Ever Increasing Faith', 8, 103, 'Does not the Holy Ghost show us wide-open doors of opportunity? Shall we not let God take us on to greater things?', 'Ever Increasing Faith 8:103'),
(474, 'Ever Increasing Faith', 8, 104, 'Shall we not believe God to take us on to greater manifestations of His power?', 'Ever Increasing Faith 8:104'),
(475, 'Ever Increasing Faith', 8, 105, 'His call for us is to forget the things that are behind, and reach forth unto the things, which are before and to press toward the mark for the prize of the high calling of God in Christ Jesus-Philippians 3:13-14.', 'Ever Increasing Faith 8:105');
...
(126, 'God of _________', 'Single Answer', 'all creation,creation', 'creation'),
(127, 'There at the ________', 'Single Answer', 'beginning,start', 'start'),
(128, 'Before the beginning of _______', 'Single Answer', 'the age,time', 'time'),
(129, 'With no _________', 'Single Answer', 'beginning,point of reference', 'point of reference'),
(130, 'You spoke to the ________', 'Single Answer', 'darkness,dark', 'dark'),
(131, 'And fleshed out the __________ of light', 'Single Answer', 'splendor,wonder', 'wonder'),
(132, 'And as You _____', 'Single Answer', 'said,speak', 'speak'),
(133, 'A _________ galaxies are born', 'Single Answer', 'billion,hundred billion', 'hundred billion'),
(134, 'In the vapor of Your breath the _______ form', 'Single Answer', 'universe,planets', 'planets'),
(135, 'If the _______ were made to worship so will I', 'Single Answer', 'planets,stars', 'stars'),
(136, 'I can see Your _______ in everything You''ve made', 'Single Answer', 'eyes,heart', 'heart'),
(137, 'Every burning star a signal fire of ______', 'Single Answer', 'love,grace', 'grace'),
(138, 'If _______ sings Your praises so will I', 'Single Answer', 'all creation,creation', 'creation'),
(139, 'God of Your ________', 'Single Answer', 'covenant,promise', 'promise'),
(140, 'You don''t speak in vain, no syllable empty or _______', 'Single Answer', 'vain,void', 'void'),
(141, 'For once You _______', 'Single Answer', 'said,have spoken', 'have spoken'),
(142, 'All nature and science follow the sound of Your _____', 'Single Answer', 'Word,voice', 'voice'),
(143, 'An_________ You speak', 'Single Answer', 'as,d as', 'd as'),
(144, 'A hundred billion ________ catch Your breath', 'Single Answer', 'creature,creatures', 'creatures'),
(145, 'Evolving in ________ of what You said', 'Single Answer', 'the direction,pursuit', 'pursuit'),
(146, 'If it all ________ Your nature so will I', 'Single Answer', 'declares,reveals', 'reveals'),
(147, 'I can see You heart in everything You _______', 'Single Answer', 'made,say', 'say'),
(148, 'Every painted sky a canvas of Your ______', 'Single Answer', 'love,grace', 'grace'),
(149, 'If creation still ______ You so will I', 'Single Answer', 'manifest,worship,obeys', 'obeys'),
(150, 'If the _________ were made to worship so will I', 'Single Answer', 'stars,galaxies,suns', 'stars'),
(151, 'If the mountains bow in ________ so will I', 'Single Answer', 'adoration,reverence', 'reverence'),
(152, 'If the _______ roar Your greatness so will I', 'Single Answer', 'seas,oceans', 'oceans'),
(153, 'For if everything ______ to lift You high so will I', 'Single Answer', 'lives,exists', 'exists'),
(154, 'If the _______ goes where You send it so will I', 'Single Answer', 'clouds,wind', 'wind'),
(155, 'If the _______ cry out in silence so will I', 'Single Answer', 'earth,rocks', 'rocks'),
(156, 'If the sum of all our __________ still falls shy', 'Single Answer', 'worship,praises', 'praises'),
(157, 'Then we''ll sing again a hundred _______ times.', 'Single Answer', 'million,billion', 'billion'),
(158, 'God of salvation, You chased down my _______', 'Single Answer', 'soul,heart', 'heart'),
(159, 'Through all of my _______ and pride', 'Single Answer', 'faults,failure', 'failure'),
(160, 'On a hill You _______', 'Single Answer', 'made,created', 'created'),
(161, 'The light of the world _________ in darkness to die', 'Single Answer', 'ignored,abandoned', 'abandoned'),
(162, 'And as You speak a hundred billion ________ disappear', 'Single Answer', 'faults,sins,failures', 'failures'),
(163, 'Where You lost Your life so I could ______ it here', 'Single Answer', 'have,find', 'find'),
(164, 'If You left ________ behind You so will I', 'Single Answer', 'death,the grave', 'the grave'),
(165, 'I can see Your heart in everything You''v ______', 'Single Answer', 'created,done,e done', 'e done'),
(166, 'Every part designed in a work of art called _______', 'Single Answer', 'hope,faith,love,grace', 'love'),
(167, 'If You gladly ______ surrender so will I', 'Single Answer', 'left,chose,choose', 'chose'),
(168, 'I can see Your heart 8 billion different ways. What creation is represented by the number <strong>8 billion</strong>?', 'Single Answer', 'Living things,Man,Fish', 'Man'),
(169, 'Every precious one a _______ You died to save', 'Single Answer', 'life,soul,child', 'child'),
(170, 'If You gave Your life to ______ them so will I', 'Single Answer', 'cherish,love', 'love'),
(171, 'Like You would again a hundred _______ times', 'Single Answer', 'million,billion', 'billion'),
(172, 'But what ________ could amount to You desire', 'Single Answer', 'count,measure', 'measure'),
(173, 'You''re the _______ who never leaves the one behind', 'Single Answer', 'Lord,One', 'One');
...
--
ALTER TABLE `messagequestions`
  MODIFY `id` mediumint(9) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=7822;
--
...
--
ALTER TABLE `scripturematerials`
  MODIFY `id` mediumint(9) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=476;
--
...
--
ALTER TABLE `timilehinadeosunscores`
  MODIFY `id` mediumint(9) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=102;
--
...
--
ALTER TABLE `worshipquestions`
  MODIFY `id` mediumint(9) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=174;
