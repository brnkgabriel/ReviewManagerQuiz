...
--
-- Host: localhost
-- Generation Time: Jan 08, 2018 at 07:59 AM
...
) ENGINE=InnoDB AUTO_INCREMENT=9196 DEFAULT CHARSET=latin1;
...
(9086, '<strong>He was wounded for our transgressions, crushed for our iniquities;\n by His wounds we are healed.</strong> What bible verse has the highlighted?', 'Single Answer', 'Isaiah 53:1,Isaiah 53:3,Isaiah 53:5', 'Isaiah 53:5'),
(9087, '<strong>Jesus Christ:</strong> _________ you could not watch even one hour with me?', 'Single Answer', 'Peter,James,John', 'Peter'),
(9088, '<strong>Pharisee:</strong> _________, Judas. That was the agreement between me... and you?', 'Single Answer', 'Twenty,Thirty,Forty', 'Thirty'),
(9089, 'What bible verses show Jesus Christ betrayed for 30 pieces of silver?', 'Single Answer', 'Matthew 26:15,Matthew 27:3,Matthew 27:9,all of the above', 'all of the above'),
(9090, '<strong>satan:</strong> Do you really believe that one man can bear the full ______ of sin?', 'Single Answer', 'weight,burden,load', 'burden'),
(9091, '<strong>satan:</strong> No one ______ can carry this burden, I tell you.', 'Single Answer', 'man,person', 'man'),
(9092, '<strong>satan:</strong> it is far too heavy. Saving their _______ is too costly', 'Single Answer', 'spirits,life,souls', 'souls'),
(9093, '<strong>Jesus Christ:</strong> Father, you can do all things. <strong>If it is possible, let this chalice pass from me. But let your will be done, not mine.</strong> What bible verse has the highlighted?', 'Single Answer', 'Jeremiah 13:6,Matthew 26:39,Matthew 26:42', 'Matthew 26:39'),
(9094, '<strong>Jesus Christ:</strong> Judas, you betray the Son of Man with a kiss? What bible verse has this statement?', 'Single Answer', '1Peter 5:14,Luke 22:48,Matthew 26:48,Mark 14:4', 'Luke 22:48'),
(9095, '<strong>Jesus Christ:</strong> Peter, put it down. <strong>Those who live by the sword shall die by the sword.</strong> What bible verse has the highlighted?', 'Single Answer', 'Luke 22:1,Matthew 26:52,Matthew 27:1', 'Matthew 26:52'),
(9096, '<strong>Mary:</strong> Listen... Why is this night different from _______?', 'Single Answer', 'every other night,other nights', 'every other night'),
(9097, '<strong>Woman caught in adultery (<i>rescued by Jesus</i>):</strong> Because once we were _______ and we are _______ no longer', 'Single Answer', 'slaves,sinners', 'slaves'),
(9098, '<strong>John:</strong> They''ve _______ Him.', 'Single Answer', 'arrested,seized', 'seized'),
(9099, 'Jesus has no problem with sinners because they''re honest. The people he condemned were the religious leaders who claim to be righteous but inside their works are evil. That''s the reason they had Him crucified. What bible verse verifies this?', 'Single Answer', 'Matthew 23:13,Matthew 23:15,Matthew 23:23,Luke 11:42,all of the above', 'all of the above'),
(9100, '<strong>Roman Soldier:</strong> Hey, What''s ______ here?', 'Single Answer', 'happening,going on', 'going on'),
(9101, '<strong>Woman caught in adultery (<i>rescued by Jesus</i>):</strong> In there ! Stop them! They''ve _____ Him! In secret! In the night! To hide their crime from you! Stop them', 'Single Answer', 'seized,arrested', 'seized'),
(9102, '<strong>Roman Soldier:</strong> What are you ______ about, woman?', 'Single Answer', 'talking,yelling,ranting', 'yelling'),
(9103, '<strong>Roman Soldier:</strong> Who have they _______?', 'Single Answer', 'seized,arrested', 'arrested'),
(9104, 'Jesus was a carpenter. What bible verse verifies this?', 'Single Answer', 'Matthew 6:3,Mark 6:3,Luke 6:3,John 6:3', 'Mark 6:3'),
(9105, '<strong>Mary:</strong> Jesus... Jesus... Are you _______', 'Single Answer', 'thirsty,hungry', 'hungry'),
(9106, '<strong>Jesus Christ:</strong> ______', 'Single Answer', 'Yes,Yes I am', 'Yes I am'),
(9107, '<strong>Mary:</strong> This is certainly a _____ table', 'Single Answer', 'big,tall,huge', 'tall'),
(9108, '<strong>Mary:</strong> Who _______?', 'Single Answer', 'is it for,owns it', 'is it for'),
(9109, '<strong>Jesus Christ:</strong> A ______ man', 'Single Answer', 'certain,rich', 'rich'),
(9110, '<strong>Mary:</strong> Does he like to eat _______?', 'Single Answer', 'on his feet,standing up', 'standing up'),
(9111, '<strong>Mary:</strong> It has begun, ______. So be it.', 'Single Answer', 'Adonai,Lord', 'Lord'),
(9112, '<strong>Abenader:</strong> Sir, there''s ________ at...', 'Single Answer', 'problem,trouble', 'trouble'),
(9113, '<strong>Pilate:</strong> What, ________, Abenader?', 'Single Answer', 'at midnight,in the middle of the night', 'in the middle of the night'),
(9114, '<strong>Abenader:</strong> Trouble within the walls. _______ had some prophet arrested', 'Single Answer', 'Annas,Caiphas', 'Caiphas'),
(9115, '<strong>Claudia:</strong> A ______? Who are you talking about?', 'Single Answer', 'Nazarene,Galilean', 'Galilean'),
(9116, 'When there''s something happening in an area. Believers in tune with the Spirit will know; in dreams or by perception, just like Claudia was. True or False?', 'Single Answer', 'True,False', 'True'),
(9117, '<strong>Jesus Christ:</strong> I have spoken openly to everyone. I''ve taught in the temple where we all gather. Ask those who have heard what I have to say. What bible verse has Jesus'' statement?', 'Single Answer', 'Matthew 18:20-21,John 18:20-21,Luke 18:20-21', 'John 18:20-21'),
(9118, '<strong>Jesus Christ:</strong> If I have _______ evil tell me what evil I have said. But if not why hit me? (<i>John 18:23</i>)', 'Single Answer', 'said,spoken', 'spoken'),
(9119, 'There are some among the Pharisees who believed Jesus though. Two of them were Nicodemus and Joseph of Arimathea. What bible verse shows Nicodemus as a believer?', 'Single Answer', 'John 7:50,John 3:2,all of the above', 'all of the above'),
(9120, '<strong>Pharisee:</strong> ...I ask you now... Jesus of Nazareth. Tell us, are you the Messiah? ...the son of ______', 'Single Answer', 'God,the living God', 'the living God'),
(9121, '<strong>Jesus Christ:</strong> ...I AM: and you will see the Son of Man seated at the right hand of power and coming on the clouds of heaven. What bible verse has Jesus reply?', 'Single Answer', 'Luke 22:69,Mark 14:62,Matthew 26:64', 'Mark 14:62'),
(9122, '<strong>Then did they spit in his face, and buffeted him; and others smote him with the palms of their hands.</strong> What bible verse is this?', 'Single Answer', 'Matthew 26:67,Luke 20:2,Mark 14:4', 'Matthew 26:67'),
(9123, 'How many times did Peter deny Jesus?', 'Single Answer', '2,3,4', '3'),
(9124, '<strong>Peter:</strong> Wherever you go, Lord, I will _______. To prison, even to death', 'Single Answer', 'go,follow', 'follow'),
(9125, '<strong>Jesus Christ:</strong> Amen, I say to you, before the cock crows, three times you will deny me. What bible verse has Jesus reply to Peter?', 'Single Answer', 'Matthew 26:34,Luke 22:1,John 16:6', 'Matthew 26:34'),
(9126, 'When we sin against, God we shouldn''t let our guilt drive us away from God like Judas. We should run to Him in repentance and He will forgive us. <strong>If we confess our sins, he is faithful and just to forgive us our sins, and to cleanse us from all unrighteousness.</strong> What bible verse is the highlighted?', 'Single Answer', '2John 1:9,1John 1:9,3John 1:1', '1John 1:9'),
(9127, 'Peter repented and was recovered. What bible verse verifies this?', 'Single Answer', 'Luke 22:1,Luke 22:30,Luke 22:32', 'Luke 22:32'),
(9128, '<strong>satan kids (<i>demons</i>):</strong> What''s wrong? Are you _______?', 'Single Answer', 'ok,all right', 'all right'),
(9129, '<strong>satan kids (<i>demons</i>):</strong> Look at his mouth. Hey, can we _____ at it?', 'Single Answer', 'take a look,look', 'look'),
(9130, '<strong>satan kids (<i>demons</i>):</strong> ______ need help? Can we help?', 'Single Answer', 'Do you,You', 'You'),
(9131, '<strong>satan kids (<i>demons</i>):</strong> _______! Look! Blood!', 'Single Answer', 'He''s bleeding,He bleeds', 'He''s bleeding'),
(9132, '<strong>Judas:</strong> Leave me alone, you little ________', 'Single Answer', 'devils,satans', 'satans'),
(9133, '<strong>satan kids (<i>demons</i>):</strong> Aha! Cursing! Are you ______?', 'Single Answer', 'accursed,cursed', 'cursed'),
(9134, '<strong>satan kids (<i>demons</i>):</strong> He''s cursed! Yes, a curse! It''s _______ him, look!', 'Single Answer', 'in,inside', 'inside'),
(9135, '<strong>satan kids (<i>demons</i>):</strong> Watch out, it''s like _____ from his bones!', 'Single Answer', 'oil,burning oil', 'burning oil'),
(9136, 'In underdeveloped countries like Israel or Nigeria, there are few distractions to deceive people of the activities in the spirit realm compared to America where we have so many distractions like TV and technology. Some people can''t even tell when God or the devil is moving. We should strive to live <strong>still, simple and quiet lives</strong> so we can tell what''s going on in the spirit realm around us, and know when God is moving or when the devil is about to set traps for us. What bible verses have the highlighted?', 'Single Answer', 'Psalms 46:10,1Thessalonians 4:11,all of the above', 'all of the above'),
(9137, '<strong>But let it be the hidden man of the heart, in that which is not corruptible, even the ornament of a meek and quiet spirit, which is in the sight of God of great price.</strong> What bible verse is this?', 'Single Answer', '1Peter 3:1,1Peter 3:4,1Peter 3:5', '1Peter 3:4'),
(9138, 'What bible verse shows Judas hanging himself?', 'Single Answer', 'Matthew 27:1,Matthew 27:3,Matthew 27:5', 'Matthew 27:5'),
(9139, '<strong>Claudia:</strong> Don''t condemn this man. He''s _______. You will only bring trouble on yourself.', 'Single Answer', 'not guilty,holy', 'holy'),
(9140, '<strong>Pilate:</strong> Do you always punish your prisoners before they''re _______?', 'Single Answer', 'heard,judged', 'judged'),
(9141, '<strong>Pilate:</strong> Isn''t he the prophet you welcomed into Jerusalem only _____ days ago?', 'Single Answer', '3,5,7', '5'),
(9142, '<strong>Pilate:</strong> And now you want him _______? Can any of you explain this madness to me?', 'Single Answer', 'killed,dead', 'dead'),
(9143, '<strong>Pilate:</strong> Are you the king of  ______?', 'Single Answer', 'Israel,the Jews,the Hebrews', 'the Jews'),
(9144, '<strong>Jesus Christ:</strong> Does this question come from you? Or do you ask me this because others have told you that is what I am? What bible verse is this?', 'Single Answer', 'Luke 23:3,John 18:34,Mark 15:2', 'John 18:34'),
(9145, '<strong>Pilate:</strong> Why would I ask you that? Am I a Jew? Your high priests, your own people delivered you up to me. They want me to have you ________. Why? What have you done? (<i>John 18:35</i>)', 'Single Answer', 'killed,executed', 'executed'),
(9146, '<strong>Jesus Christ:</strong> My kingdom is not of this world. If it were, do you think my __________ would have let them hand me over?', 'Single Answer', 'disciples,followers', 'followers'),
(9147, 'The Kingdom of Heaven is not of this world (Not physical). It is spiritual. It deals with the heart of men. That''s why we as believers are in the world but <strong>not of the world</strong>. Meaning we should not do things they way the world does it nor get our education and attitude to life from the world but from God''s Word. What bible verse has the highlighted?', 'Single Answer', 'John 17:12,John 17:14,John 17:16', 'John 17:14'),
(9148, '<strong>Jesus Christ:</strong> That is why I was born. To give testimony to the truth. The truth is the original purpose for everything. Jesus came to bring the knowledge of the original purpose for everything created, including you and me. True or False?', 'Single Answer', 'True,False', 'True'),
(9149, '<strong>Jesus Christ:</strong> All men who hear the truth hear my voice. It means not all men hear the truth. Some are not interested in the original purpose for anything. They just want things scattered. True or False?', 'Single Answer', 'True,False', 'True'),
(9150, '<strong>Pilate:</strong> What is truth, Claudia? Do you hear it, _______ it when it is spoken?', 'Single Answer', 'identify,recognize,tell', 'recognize'),
(9151, '<strong>Claudia:</strong> Yes, I do. Don''t you? Believers can always recognize the truth when it''s spoken, because they''re in touch with the Truth for Jesus is <strong>the Way, the Truth and the Life.</strong> What bible verse has the highlighted?', 'Single Answer', 'John 14:6,John 15:6,John 16:6', 'John 14:6'),
(9152, '<strong>Claudia:</strong> If you will not hear the truth, no one can tell you. A person must be willing to accept Jesus (the Truth) before he can know the truth. True or False?', 'Single Answer', 'True,False', 'True'),
(9153, 'They didn''t even like Barrabas. It wasn''t convenient for them but they voted for his release as they did not like to retain God in their knowledge. What bible verse verifies this?', 'Single Answer', 'Romans 1:20,Romans 1:28,1Corinthians 16:12', 'Romans 1:28'),
(9154, '<strong>Who His own self bare our sins in His own body on the tree, that we, being dead to sins, should live unto righteousness: by whose stripes you were healed.</strong> What bible verse is this?', 'Single Answer', '2Peter 2:24,1Peter 2:24', '1Peter 2:24'),
(9155, '<strong>Who His own self bare our sins in His own body on the tree, that we, being dead to sins, should live unto righteousness: by whose stripes you ______ healed.</strong> That''s the price Jesus paid for our healing. If we get sick, it''s because we allowed the devil to cheat us. Let''s refuse to subscribe to sickness because the price is already paid. (Hint: the right answer is the implication of the scripture)', 'Single Answer', 'were,are,all of the above', 'all of the above'),
(9156, 'If we were healed, we are healed. True or False?', 'Single Answer', 'True,False', 'True'),
(9157, '<strong>Jesus Christ:</strong> My _______ is ready, Father. My _______ is ready', 'Single Answer', 'soul,life,heart', 'heart'),
(9158, '<strong>The heart is deceitful above all things, and desperately wicked: who can know it.</strong> What bible verse is this?', 'Single Answer', 'Jeremiah 15:9,Jeremiah 17:9,Jeremiah 20:9', 'Jeremiah 17:9'),
(9159, 'They could beat Jesus that way, forgetting He''s not an animal. He put on flesh like them. That''s the state of the heart of a man without Jesus. Never trust any man or woman who is not saved. No matter how they look or what they say. The condition of their heart is not right. True or False?', 'Single Answer', 'True,False', 'True'),
(9160, 'The brutality in the movie is better than what happened in reality. <strong>As many were astonished at thee; his visage was so marred more than any man, and his form more than the sons of men.</strong> After His beating, He didn''t look like a human being. The person in the movie still looked like a human after the beating. What bible verse has the highlighted?', 'Single Answer', 'Isaiah 51:14,Isaiah 52:14,Isaiah 53:14', 'Isaiah 52:14'),
(9161, 'The bible calls the devil the <strong>god of this world</strong>. The devil looks for every opportunity to get back at God for kicking him out of heaven. What bible verse has the highlighted?', 'Single Answer', '1Corinthians 4:4,2Corinthians 4:4', '2Corinthians 4:4'),
(9162, '<strong>Mary:</strong> My son, when, where, how will you choose to be ________?', 'Single Answer', 'free from this,delivered of this', 'delivered of this'),
(9163, 'That''s the price for sin. God is just in that He will never break His Word. He said the wages of sin is death (Romans 6:23). <strong>The soul that sins, it shall die</strong>. But He''s also merciful. He loves us so much that He paid the price so we don''t have to bear the just reward of sin. God has done His best, it''s up to us to believe and appreciate the price He paid for us. The best we can do is to live for Him. What bible verse is the highlighted?', 'Single Answer', 'John 3:16,Ezekiel 18:20', 'Ezekiel 18:20'),
(9164, '<strong>For God so loved the world, that he gave his only begotten Son, that whosoever believes in him should not perish, but have everlasting life.</strong> What bible verse is this?', 'Single Answer', 'John 3:5,John 3:16,John 3:17', 'John 3:16'),
(9165, '<strong>Jesus Christ:</strong> If the world hates you, remember that it has hated me first. What bible verse is this?', 'Single Answer', 'John 14:18,John 15:18,John 16:18', 'John 15:18'),
(9166, '<strong>Jesus Christ:</strong> Remember also that no servant is greater than his master. If they persecuted me, they will persecute you. You must not be afraid. The Helper will come, who reveals the truth about God and who comes from the Father. Who is this Helper?', 'Single Answer', 'The Holy Ghost,The Holy Spirit,all of the above', 'all of the above'),
(9167, 'The woman caught in adultery, reached out to Jesus after she sinned. She teaches us to reach out to Jesus Christ even after we sin and He''ll help us up. True or False?', 'Single Answer', 'True,False', 'True'),
(9168, 'The story of the woman caught in adultery is found in what bible portion', 'Single Answer', 'Matthew 8:3-11,Mark 8:3-11,Luke 8:3-11,John 8:3-11', 'John 8:3-11'),
(9169, 'Even after Jesus was severely flogged, the Pharisees still wanted Him killed. It takes the power of the Holy Spirit to change the heart of a person who is accustomed to do evil. Even God asks the question: <strong>Can the Ethiopian change his skin, or the leopard his spots? then may you also do good, that are accustomed to do evil.</strong> What bible verse has the highlighted?', 'Single Answer', 'Isaiah 13:23,Jeremiah 13:23,Ezekiel 13:23', 'Jeremiah 13:23'),
(9170, '<strong>Pilate:</strong> Speak to me. I have the power to crucify you, or else to _______ (<i>John 19:10</i>)', 'Single Answer', 'release you,set you free', 'set you free'),
(9171, '<strong>Jesus Christ:</strong> You have no power over me except what is given you from above. Therefore, it is he who delivered me to you who has the greater sin. What bible verse is this?', 'Single Answer', 'John 18:11,John 19:11,John 20:11', 'John 19:11'),
(9172, 'Mary felt the whipping of Jesus in her heart. Parents can sense if their child is going through pain because the child is wearing their body. That''s why sometimes a mother can tell when there''s something wrong with her child. True or False?', 'Single Answer', 'True,False', 'True'),
(9173, '<strong>Mary:</strong> I''m ______', 'Single Answer', 'here,here son', 'here'),
(9174, '<strong>Jesus Christ:</strong> See, _______, I make all things new', 'Single Answer', 'Mary,mother', 'mother'),
(9175, 'The name of the person who helped Jesus carry His cross is ________ (Hint: Matthew 27:32)', 'Single Answer', 'Peter,Simon,Simon of Cyrene,Judas,James', 'Simon of Cyrene'),
(9176, '<strong>Jesus Christ:</strong> You have heard it said, you shall love your neighbor and hate your enemy. But I say to you love your enemies and pray for those who persecute you. What bible portion is this?', 'Single Answer', 'Matthew 5:43-44,Luke 6:27-28,Luke 6:35', 'Matthew 5:43-44'),
(9177, '<strong>Jesus Christ:</strong> I am the Good Shepherd. I lay down My life for My sheep. No one takes My life from Me, but I lay it down of my own accord. I have power to lay it down, and power to take it up again. This command is from My Father. What bible portion is this?', 'Single Answer', 'John 10:11,John 10:18,John 10:11-18,John 10:11&18', 'John 10:11&18'),
(9178, 'The reason the essence of the bible is scattered in different books, chapters and verses is to lock out those who don''t want to seek God with all their heart. Someone whose heart seeks God will find the connection. <strong>And you shall seek Me, and find Me, when you shall search for Me with all your heart.</strong> What bible verse is the highlighted?', 'Single Answer', 'Isaiah 29:13,Jeremiah 29:13', 'Jeremiah 29:13'),
(9179, '<strong>Jesus Christ:</strong> You are My friends. <strong>There is no greater love than for a man to lay down his life for his friends.</strong> What bible verse has the highlighted?', 'Single Answer', 'John 15:12,Mark 12:31,John 15:13', 'John 15:13'),
(9180, 'The charge of sin against us was erased from God''s sight as Jesus was nailed to the cross. <strong>Blotting out the handwriting of ordinances that was against us, which was contrary to us, and took it out of the way, nailing it to his cross.</strong> What bible verse has the highlighted?', 'Single Answer', 'Romans 2:14,Colossians 2:14,Ephesians 2:14', 'Colossians 2:14'),
(9181, '<strong>Jesus Christ:</strong> ... love one another. <strong>As I have loved you, so love one another.</strong> What bible verse has the highlighted?', 'Single Answer', 'John 13:34,John 15:12,all of the above', 'all of the above'),
(9182, '<strong>Jesus Christ:</strong> You believe in Me. You know that <strong>I am the Way, the Truth, and the Life. no man comes to the Father, but by Me.</strong> What bible verse has the highlighted?', 'Single Answer', 'John 14:6,John 15:6,John 16:6', 'John 14:6'),
(9183, '<strong>Jesus Christ:</strong> Take this and eat. <strong>This is My body... which is given up for you.</strong> What bible portion has the?', 'Single Answer', 'Matthew 26:26,Luke 22:19,Matthew 26:26 & Luke 22:19', 'Matthew 26:26 & Luke 22:19'),
(9184, '<strong>Jesus Christ:</strong> Take this and drink. <strong>This is My blood of the new covenant, which is given for you and for many, for the forgiveness of sins. </strong> What bible portion has the highlighted?', 'Single Answer', 'Luke 22:20,Mark 14:24,Matthew 26:28,Luke 22:20 & Mark 14:24 & Matthew 26:28', 'Luke 22:20 & Mark 14:24 & Matthew 26:28'),
(9185, 'Pharisees are usually concerned about their buildings and things. They care less about people. A true disciple of Jesus Christ cares more about people than physical things. True or False?', 'Single Answer', 'True,False', 'True'),
(9186, '<strong>Jesus Christ:</strong> Father, _______ them. They know not what they do.', 'Single Answer', 'pardon,forgive', 'forgive'),
(9187, 'Who was the first person to go to paradise after Jesus death?', 'Single Answer', 'Peter,One of the thief on the cross,Judas,James', 'One of the thief on the cross'),
(9188, '<strong>And, behold, the veil of the temple was rent in twain from the top to the bottom; and the earth did quake, and the rocks rent;</strong> What bible verse is this?', 'Single Answer', 'Nahum 1:5,Joel 2:10,Matthew 27:51', 'Matthew 27:51'),
(9189, 'Jesus Christ carried the sin of the world. God forsook Him, because He <strong>cannot look on iniquity.</strong> The physical sufferings on Jesus'' body is a result of the absence of God''s presence. When you see sorrow on someone''s body, it''s a direct result of the absence of the presence of God. What bible verse has the highlighted?', 'Single Answer', 'Isaiah 59:1,Habakkuk 1:13', 'Habakkuk 1:13'),
(9190, 'It takes the blood of Jesus Christ to open the eyes of a man''s heart (his understanding). True or False?', 'Single Answer', 'True,False', 'True'),
(9191, 'The physical temple the Pharisees were interested in got destroyed. God says we should not <strong>look or focus our mind on the things that are seen, but be concerned about the unseen (like the heart of man). For the things that are seen are temporary (they will pass away), but the things that can''t be seen are eternal (even in eternity they still exist)</strong> What bible portion has the highlighted?', 'Single Answer', '2Corinthians 4:18,1Corinthians 4:18', '2Corinthians 4:18'),
(9192, 'The devil screamed because Jesus collected the keys of death from Him. What bible verse proves this?', 'Single Answer', 'Romans 1:18,Revelation 1:18', 'Revelation 1:18'),
(9193, '<strong> Therefore we are buried with Him by baptism into death: that like as Christ was raised up from the dead by the glory of the Father, even so we also should walk in newness of life.</strong> What bible verse is this?', 'Single Answer', 'Romans 8:4,Romans 6:4', 'Romans 6:4'),
(9194, 'We are buried with Christ by baptism into death. The death for us is death to living for ourselves. When we put an end to living for ourselves, our perspective towards life changes and we walk in the newness of life. True or False?', 'Single Answer', 'True,False', 'True'),
(9195, 'This is what God went through because He loves us. <strong>For God so loved the world, that he gave his only begotten Son, that whosoever believes in him should not perish, but have everlasting life.</strong> Let''s not buy into the world''s idea that love is a feeling. What the world calls love is what the bible calls lust. Love is a choice that demands sacrifice. It cost God His only begotten Son. It''ll cost us something. What bible verse is the highlighted?', 'Single Answer', 'John 3:16,John 3:I6,John 3:l6', 'John 3:16');
...
(27, 'Oluwaseyi', 'Alofe', '10', 'oluwaseyialofe13@gmail.com', '9125a5ca7d2d99dec906b5548dec123f66da5711', '789.92', '15th', '0', 'FF530C', 'OA', 'Lilshay', 'oluwaseyialofescores', '', '{"cTab":"Message","wQAnswered":"17","wQGotten":"17","wQMissed":"0","mQAnswered":"8","mQGotten":"7","mQMissed":"1","sTyped":"0","sWordsTyped":"","sGotten":"0","sMissed":"0","tPoints":"230","eAForToday":"23","totalAggregate":"789.92","email":"oluwaseyialofe13@gmail.com","age":"10"}'),
...
(29, 'Prosper', 'Falodun', '11', 'prosperfalodun@gmail.com', '16254f13cea30be88237e04d059e57802a28b819', '1051.989', '12th', '0', '3a2805', 'PF', 'pros353', 'prosperfalodunscores', '', '{"cTab":"Scripture","wQAnswered":"17","wQGotten":"16","wQMissed":"1","mQAnswered":"1","mQGotten":"1","mQMissed":"0","sTyped":"10","sWordsTyped":"Proverbs 2:10-When wisdom enters into your heart, and knowledge is pleasant to your soul:","sGotten":"9","sMissed":"1","tPoints":"240","eAForToday":"21.816","totalAggregate":"1051.989","email":"prosperfalodun@gmail.com","age":"11"}'),
...
(34, 'Mofeolu', 'Odeneye', '11', 'mofeoluodeneye@gmail.com', 'ad5dbfebc446ef0e881a129fd01c57c88a79733a', '129.101', '32nd', '0', 'e8800c', 'MO', 'mo', 'mofeoluodeneyescores', '', ''),
...
(37, 'James', 'Otokiti', '13', 'jamesotokiti@gmail.com', 'caf9ceb956dfc1bdca4783f2a851ce7051e149c1', '206.47', '29th', '0', '205523', 'JO', '7th Hokage', 'jamesotokitiscores', '', ''),
(38, 'Adebayo', 'Inioluwa', '11', 'adebayoinioluwa@gmail.com', '0a301781fc9fa0f094ef9fb1781e26f70daabe7e', '718.363', '17th', '0', '000000', 'AI', 'ini', 'adebayoinioluwascores', '', '{"cTab":"Scripture","wQAnswered":"17","wQGotten":"17","wQMissed":"0","mQAnswered":"83","mQGotten":"71","mQMissed":"12","sTyped":"5","sWordsTyped":"Proverbs 2:5-Then will you understand the fear of the LORD, and find the knowledge of God.","sGotten":"3","sMissed":"2","tPoints":"770","eAForToday":"69.993","totalAggregate":"718.363","email":"adebayoinioluwa@gmail.com","age":"11"}'),
(39, 'Adebayo', 'Omolade', '18', 'adebayoomolade@gmail.com', '957afdf565bcf7c16174f04309f9f5f5aa07f33d', '128.082', '33rd', '0', '400040', 'AO', 'lade', 'adebayoomoladescores', '', '{"cTab":"Message","wQAnswered":"17","wQGotten":"17","wQMissed":"0","mQAnswered":"1","mQGotten":"0","mQMissed":"1","sTyped":"0","sWordsTyped":"","sGotten":"0","sMissed":"0","tPoints":"160","eAForToday":"8.896","totalAggregate":"128.082","email":"adebayoomolade@gmail.com","age":"18"}'),
(40, 'Adebayo', 'Oluwatunbukunmi', '14', 'adebayooluwatunbukunmi@gmail.com', 'a53fc2b89ed768b53708b933ae6cf8648ba60041', '131.638', '31st', '0', '2b002b', 'AO', 'Lizzy', 'adebayooluwatunbukunmiscores', '', '{"cTab":"Message","wQAnswered":"17","wQGotten":"17","wQMissed":"0","mQAnswered":"42","mQGotten":"20","mQMissed":"22","sTyped":"0","sWordsTyped":"","sGotten":"0","sMissed":"0","tPoints":"150","eAForToday":"10.71","totalAggregate":"131.638","email":"adebayooluwatunbukunmi@gmail.com","age":"14"}'),
(41, 'Adebayo', 'Temiloluwa', '16', 'temiloluwabdy@gmail.com', '7083c7b0ca2977fedbd65ac2889410763c7c9f9f', '236.5', '26th', '0', '800000', 'AT', 'Mac-Switch', 'adebayotemiloluwascores', '', '{"cTab":"Worship","wQAnswered":"17","wQGotten":"16","wQMissed":"1","mQAnswered":"0","mQGotten":"0","mQMissed":"0","sTyped":"0","sWordsTyped":"","sGotten":"0","sMissed":"0","tPoints":"150","eAForToday":"9.375","totalAggregate":"236.5","email":"temiloluwabdy@gmail.com","age":"16"}'),
...
(43, 'Kolawole', 'Otokiti', '10', 'kolawoleotokiti@gmail.com', 'fb76b9af8c64358dcdbe8636dd8b189ed98cd5a7', '127.75', '34th', '0', '000040', 'KO', 'Emmanuel', 'kolawoleotokitiscores', '', ''),
...
(1, 'quiz', 'Materials', '2018-01-05 23:59:00');
...
(34, 'Proverbs', 2, 1, 'Proverbs 2:1-My son, if you will receive my words, and hide my commandments with you;', 'Proverbs 2:1'),
(35, 'Proverbs', 2, 2, 'Proverbs 2:2-So that you incline your ear to wisdom, and apply your heart to understanding;', 'Proverbs 2:2'),
(36, 'Proverbs', 2, 3, 'Proverbs 2:3-Yes, if you cry after knowledge, and lift up your voice for understanding;', 'Proverbs 2:3'),
(37, 'Proverbs', 2, 4, 'Proverbs 2:4-If you seek her as silver, and search for her as for hid treasures;', 'Proverbs 2:4'),
(38, 'Proverbs', 2, 5, 'Proverbs 2:5-Then will you understand the fear of the LORD, and find the knowledge of God.', 'Proverbs 2:5'),
(39, 'Proverbs', 2, 6, 'Proverbs 2:6-For the LORD gives wisdom: out of His mouth comes knowledge and understanding.', 'Proverbs 2:6'),
(40, 'Proverbs', 2, 7, 'Proverbs 2:7-He lays up sound wisdom for the righteous: He is a buckler to them that walk uprightly.', 'Proverbs 2:7'),
(41, 'Proverbs', 2, 8, 'Proverbs 2:8-He keeps the paths of judgment, and preserves the way of His saints.', 'Proverbs 2:8'),
(42, 'Proverbs', 2, 9, 'Proverbs 2:9-Then will you understand righteousness, and judgment, and equity; yes, every good path.', 'Proverbs 2:9'),
(43, 'Proverbs', 2, 10, 'Proverbs 2:10-When wisdom enters into your heart, and knowledge is pleasant to your soul;', 'Proverbs 2:10'),
(44, 'Proverbs', 2, 11, 'Proverbs 2:11-Discretion will preserve you, understanding will keep you:', 'Proverbs 2:11'),
(45, 'Proverbs', 2, 12, 'Proverbs 2:12-To deliver you from the way of the evil man, from the man that speaks froward (perverse) things;', 'Proverbs 2:12'),
(46, 'Proverbs', 2, 13, 'Proverbs 2:13-Who leave the paths of uprightness, to walk in the ways of darkness;', 'Proverbs 2:13'),
(47, 'Proverbs', 2, 14, 'Proverbs 2:14-Who rejoice to do evil, and delight in the frowardness of the wicked;', 'Proverbs 2:14'),
(48, 'Proverbs', 2, 15, 'Proverbs 2:15-Whose ways are crooked, and they froward in their paths:', 'Proverbs 2:15'),
(49, 'Proverbs', 2, 16, 'Proverbs 2:16-to deliver you from the strange woman, even from the stranger who flatters with her words;', 'Proverbs 2:16'),
(50, 'Proverbs', 2, 17, 'Proverbs 2:17-Who forsake the guide of her youth, and forgets the covenant of her God.', 'Proverbs 2:17'),
(51, 'Proverbs', 2, 18, 'Proverbs 2:18-For her house inclines to death, and her paths to the dead.', 'Proverbs 2:18'),
(52, 'Proverbs', 2, 19, 'Proverbs 2:19-None that go to her return again, neither do they take hold of the paths of life.', 'Proverbs 2:19'),
(53, 'Proverbs', 2, 20, 'Proverbs 2:20-That you may walk in the way of good men, and keep the paths of the righteous.', 'Proverbs 2:20'),
(54, 'Proverbs', 2, 21, 'Proverbs 2:21-For the upright will dwell in the land, and the perfect will remain in it.', 'Proverbs 2:21'),
(55, 'Proverbs', 2, 22, 'Proverbs 2:22-But the wicked will be cut off from the earth, and the transgressors will be rooted out of it.', 'Proverbs 2:22'),
(56, 'Proverbs', 3, 1, 'Proverbs 3:1-My son, don''t forsake my law, but let your heart keep my commandments:', 'Proverbs 3:1'),
(57, 'Proverbs', 3, 2, 'Proverbs 3:2-For length of days, and long life, and peace, will they add to you.', 'Proverbs 3:2'),
(58, 'Proverbs', 3, 3, 'Proverbs 3:3-Don''t let mercy and truth forsake you: bind them about your neck; write them on the table of your heart.', 'Proverbs 3:3'),
(59, 'Proverbs', 3, 4, 'Proverbs 3:4-So you will find favor and good understanding in the sight of God and man.', 'Proverbs 3:4'),
(60, 'Proverbs', 3, 5, 'Proverbs 3:5-Trust in the LORD with all your heart; lean not unto your own understanding.', 'Proverbs 3:5'),
(61, 'Proverbs', 3, 6, 'Proverbs 3:6-In all your ways acknowledge Him, and He will direct your paths.', 'Proverbs 3:6'),
(62, 'Proverbs', 3, 7, 'Proverbs 3:7-Be not wise in your own eyes: fear the LORD, and depart from evil.', 'Proverbs 3:7'),
(63, 'Proverbs', 3, 8, 'Proverbs 3:8-It will be health to your navel, and marrow to your bones.', 'Proverbs 3:8'),
(64, 'Proverbs', 3, 9, 'Proverbs 3:9-Honor the LORD with your substance, and with the firstfruits of all your increase:', 'Proverbs 3:9'),
(65, 'Proverbs', 3, 10, 'Proverbs 3:10-So will your barns be filled with plenty, and your presses will burst out with new wine.', 'Proverbs 3:10'),
(66, 'Proverbs', 3, 11, 'Proverbs 3:11-My son, despise not the chastening of the LORD, neither be weary of His correction.', 'Proverbs 3:11'),
(67, 'Proverbs', 3, 12, 'Proverbs 3:12-For whom the LORD loves He corrects; even as a father the son in whom he delights.', 'Proverbs 3:12'),
(68, 'Proverbs', 3, 13, 'Proverbs 3:13-Happy is the man that finds wisdom, and the man that gets understanding.', 'Proverbs 3:13'),
(69, 'Proverbs', 3, 14, 'Proverbs 3:14-For the merchandise of it is better than the merchandise of silver, and the gain thereof than fine gold.', 'Proverbs 3:14'),
(70, 'Proverbs', 3, 15, 'Proverbs 3:15-She is more precious than rubies: and all the things you can desire are not to be compared to her.', 'Proverbs 3:15'),
(71, 'Proverbs', 3, 16, 'Proverbs 3:16-Length of days is in her right hand; and in her left hand riches and honor.', 'Proverbs 3:16'),
(72, 'Proverbs', 3, 17, 'Proverbs 3:17-Her ways are ways of pleasantness, and all her paths are peace.', 'Proverbs 3:17'),
(73, 'Proverbs', 3, 18, 'Proverbs 3:18-She is a tree of life to them that lay hold upon her: and happy is every one that retains her.', 'Proverbs 3:18'),
(74, 'Proverbs', 3, 19, 'Proverbs 3:19-The LORD by wisdom has founded the earth; by understanding has He established the heavens.', 'Proverbs 3:19'),
(75, 'Proverbs', 3, 20, 'Proverbs 3:20-By His knowledge the depths are broken up, and the clouds drop down the dew.', 'Proverbs 3:20'),
(76, 'Proverbs', 3, 21, 'Proverbs 3:21-My son, let them not depart from your eyes: keep sound wisdom and discretion:', 'Proverbs 3:21'),
(77, 'Proverbs', 3, 22, 'Proverbs 3:22-So shall they be life to your soul, and grace to your neck.', 'Proverbs 3:22'),
(78, 'Proverbs', 3, 23, 'Proverbs 3:23-Then will you walk in your way safely, and your foot will not stumble.', 'Proverbs 3:23'),
(79, 'Proverbs', 3, 24, 'Proverbs 3:24-When you lie down, you will not be afraid: yes, you will lie down, and your sleep will be sweet.', 'Proverbs 3:24'),
(80, 'Proverbs', 3, 25, 'Proverbs 3:25-Don''t be afraid of sudden fear, neither of the desolation of the wicked, when it comes.', 'Proverbs 3:25'),
(81, 'Proverbs', 3, 26, 'Proverbs 3:26-For the LORD will be your confidence, and will keep your foot from being taken.', 'Proverbs 3:26'),
(82, 'Proverbs', 3, 27, 'Proverbs 3:27-Do not withhold good from them to whom it is due, when it is in the power of your hand to do it.', 'Proverbs 3:27'),
(83, 'Proverbs', 3, 28, 'Proverbs 3:28-Do not say to your neighbor, Go, and come again, and tomorrow I will give; when you have it by you.', 'Proverbs 3:28'),
(84, 'Proverbs', 3, 29, 'Proverbs 3:29-Do not devise evil against your neighbor, seeing he dwells securely by you.', 'Proverbs 3:29'),
(85, 'Proverbs', 3, 30, 'Proverbs 3:30-Do not strive with a man without cause, if he has done you no harm.', 'Proverbs 3:30'),
(86, 'Proverbs', 3, 31, 'Proverbs 3:31-Do not envy the oppressor, and choose none of his ways.', 'Proverbs 3:31'),
(87, 'Proverbs', 3, 32, 'Proverbs 3:32-For the froward (perverse) is abomination to the LORD: but his secret is with the righteous.', 'Proverbs 3:32'),
(88, 'Proverbs', 3, 33, 'Proverbs 3:33-The curse of the LORD is in the house of the wicked: but he blesses the habitation of the just.', 'Proverbs 3:33'),
(89, 'Proverbs', 3, 34, 'Proverbs 3:34-Surely he scorns the scorner: but he gives grace to the lowly.', 'Proverbs 3:34'),
(90, 'Proverbs', 3, 35, 'Proverbs 3:35-The wise will inherit glory: but shame will be the promotion of fools.', 'Proverbs 3:35'),
(91, 'Proverbs', 4, 1, 'Proverbs 4:1-Hear, you children, the instruction of a father, and attend to know understanding.', 'Proverbs 4:1'),
(92, 'Proverbs', 4, 2, 'Proverbs 4:2-For I give you good doctrine, do not forsake my law.', 'Proverbs 4:2'),
(93, 'Proverbs', 4, 3, 'Proverbs 4:3-For I was my father''s son, tender and only beloved in the sight of my mother.', 'Proverbs 4:3'),
(94, 'Proverbs', 4, 4, 'Proverbs 4:4-He taught me also, and said to me, Let your heart retain my words: keep my commandments, and live.', 'Proverbs 4:4'),
(95, 'Proverbs', 4, 5, 'Proverbs 4:5-Get wisdom, get understanding: do not forget it; neither decline from the words of my mouth.', 'Proverbs 4:5'),
(96, 'Proverbs', 4, 6, 'Proverbs 4:6-Do not forsake her, and she will preserve you: love her, and she will keep you.', 'Proverbs 4:6'),
(97, 'Proverbs', 4, 7, 'Proverbs 4:7-Wisdom is the principal thing; therefore get wisdom: and with all your getting get understanding.', 'Proverbs 4:7'),
(98, 'Proverbs', 4, 8, 'Proverbs 4:8-Exalt her, and she will promote you: she will bring you to honor, when you embrace her.', 'Proverbs 4:8'),
(99, 'Proverbs', 4, 9, 'Proverbs 4:9-She will give to your head an ornament of grace: a crown of glory will she deliver to you.', 'Proverbs 4:9'),
(100, 'Proverbs', 4, 10, 'Proverbs 4:10-Hear, O my son, and receive my sayings; and the years of your life will be many.', 'Proverbs 4:10'),
(101, 'Proverbs', 4, 11, 'Proverbs 4:11-I have taught in the way of wisdom; I have led you in right paths.', 'Proverbs 4:11'),
(102, 'Proverbs', 4, 12, 'Proverbs 4:12-When you go, your steps will not be straitened (in distress); and when you run, you will not stumble.', 'Proverbs 4:12'),
(103, 'Proverbs', 4, 13, 'Proverbs 4:13-Take fast hold of instruction; let her not go: keep her; for she is your life.', 'Proverbs 4:13'),
(104, 'Proverbs', 4, 14, 'Proverbs 4:14-Do not enter into the path of the wicked, and do not go in the way of evil men.', 'Proverbs 4:14'),
(105, 'Proverbs', 4, 15, 'Proverbs 4:15-Avoid it, do not pass by it, turn from it, and pass away.', 'Proverbs 4:15'),
(106, 'Proverbs', 4, 16, 'Proverbs 4:16-For they do not sleep, except they have done mischief; and their sleep is taken away, unless they cause some to fall.', 'Proverbs 4:16'),
(107, 'Proverbs', 4, 17, 'Proverbs 4:17-For they eat the bread of wickedness, and drink the wine of violence.', 'Proverbs 4:17'),
(108, 'Proverbs', 4, 18, 'Proverbs 4:18-But the path of the just is as the shining light, that shines more and more unto the perfect day.', 'Proverbs 4:18'),
(109, 'Proverbs', 4, 19, 'Proverbs 4:19-The way of the wicked is as darkness: they do not know at what they stumble.', 'Proverbs 4:19'),
(110, 'Proverbs', 4, 20, 'Proverbs 4:20-My son, attend to my words; incline your ear unto my sayings.', 'Proverbs 4:20'),
(111, 'Proverbs', 4, 21, 'Proverbs 4:21-Let them not depart from your eyes; keep them in the midst of your heart.', 'Proverbs 4:21'),
(112, 'Proverbs', 4, 22, 'Proverbs 4:22-For they are life to those that find them, and health to all their flesh.', 'Proverbs 4:22'),
(113, 'Proverbs', 4, 23, 'Proverbs 4:23-Keep your heart with all diligence; for out of it are the issues of life.', 'Proverbs 4:23'),
(114, 'Proverbs', 4, 24, 'Proverbs 4:24-Put away from you a froward mouth, and perverse lips put far from you.', 'Proverbs 4:24'),
(115, 'Proverbs', 4, 25, 'Proverbs 4:25-Let your eyes look right on, and let your eyelids look straight before you.', 'Proverbs 4:25'),
(116, 'Proverbs', 4, 26, 'Proverbs 4:26-Ponder the path of your feet, and let all your ways be established.', 'Proverbs 4:26'),
(117, 'Proverbs', 4, 27, 'Proverbs 4:27-Turn not to the right hand nor to the left: remove your foot from evil.', 'Proverbs 4:27'),
(118, 'Proverbs', 5, 1, 'Proverbs 5:1-My son, attend to my wisdom, and bow your ear to my understanding:', 'Proverbs 5:1'),
(119, 'Proverbs', 5, 2, 'Proverbs 5:2-That you may regard discretion, and that your lips may keep knowledge.', 'Proverbs 5:2'),
(120, 'Proverbs', 5, 3, 'Proverbs 5:3-For the lips of a strange woman drop as an honeycomb, and her mouth is smoother than oil:', 'Proverbs 5:3'),
(121, 'Proverbs', 5, 4, 'Proverbs 5:4-But her end is bitter as wormwood, sharp as a twoedged sword.', 'Proverbs 5:4'),
(122, 'Proverbs', 5, 5, 'Proverbs 5:5-Her feet go down to death; her steps take hold on hell.', 'Proverbs 5:5'),
(123, 'Proverbs', 5, 6, 'Proverbs 5:6-Lest you should ponder the path of life, her ways are moveable, that you can not know them.', 'Proverbs 5:6'),
(124, 'Proverbs', 5, 7, 'Proverbs 5:7-Hear me now therefore, O you children, and depart not from the words of my mouth.', 'Proverbs 5:7'),
(125, 'Proverbs', 5, 8, 'Proverbs 5:8-Remove your way from her, and do not come near the door of her house:', 'Proverbs 5:8'),
(126, 'Proverbs', 5, 9, 'Proverbs 5:9-Lest you give your honor to others, and your years to the cruel:', 'Proverbs 5:9'),
(127, 'Proverbs', 5, 10, 'Proverbs 5:10-Lest strangers be filled with your wealth; and your labors be in the house of a stranger;', 'Proverbs 5:10'),
(128, 'Proverbs', 5, 11, 'Proverbs 5:11-And you mourn at the last, when your flesh and your body are consumed,', 'Proverbs 5:11'),
(129, 'Proverbs', 5, 12, 'Proverbs 5:12-And say, How have I hated instruction, and my heart despised reproof;', 'Proverbs 5:12'),
(130, 'Proverbs', 5, 13, 'Proverbs 5:13-And have not obeyed the voice of my teachers, nor inclined my ear to them that instructed me!', 'Proverbs 5:13'),
(131, 'Proverbs', 5, 14, 'Proverbs 5:14-I was almost in all evil in the midst of the congregation and assembly.', 'Proverbs 5:14'),
(132, 'Proverbs', 5, 15, 'Proverbs 5:15-Drink waters out of your own cistern, and running waters out of your own well.', 'Proverbs 5:15'),
(133, 'Proverbs', 5, 16, 'Proverbs 5:16-Let your fountains be dispersed abroad, and rivers of waters in the streets.', 'Proverbs 5:16'),
(134, 'Proverbs', 5, 17, 'Proverbs 5:17-Let them be only your own, and not strangers'' with you.', 'Proverbs 5:17'),
(135, 'Proverbs', 5, 18, 'Proverbs 5:18-Let your fountain be blessed: and rejoice with the wife of your youth.', 'Proverbs 5:18'),
(136, 'Proverbs', 5, 19, 'Proverbs 5:19-Let her be as the loving hind and pleasant roe; let her breasts satisfy you at all times; and be ravished always with her love.', 'Proverbs 5:19'),
(137, 'Proverbs', 5, 20, 'Proverbs 5:20-And why will you, my son, be ravished with a strange woman, and embrace the bosom of a stranger?', 'Proverbs 5:20'),
(138, 'Proverbs', 5, 21, 'Proverbs 5:21-For the ways of man are before the eyes of the LORD, and he ponders all his goings.', 'Proverbs 5:21'),
(139, 'Proverbs', 5, 22, 'Proverbs 5:22-His own iniquities shall take the wicked himself, and he will be holden with the cords of his sins.', 'Proverbs 5:22'),
(140, 'Proverbs', 5, 23, 'Proverbs 5:23-He will die without instruction; and in the greatness of his folly he will go astray.', 'Proverbs 5:23');
...
(10, 'Maker of earth and ____, and everything before our eyes', 'Single Answer', 'stars,skies,sky', 'sky'),
(11, 'Your Word formed life and light, within the crucible of ________', 'Single Answer', 'time,life', 'time'),
(12, 'The _______ of all mankind', 'Single Answer', 'beginning,genesis', 'genesis'),
(13, 'Our lives a tapestry of _______, your hand has weaved together', 'Single Answer', 'grace,love', 'grace'),
(14, 'In You no thread will every _____, this hope is ours forever.', 'Single Answer', 'frey,fray', 'fray'),
(15, 'Your work of art a ______, beyond all earthly measure', 'Single Answer', 'misery,mystery', 'mystery'),
(16, 'Your love for us a masterpiece, ______ our hope always', 'Single Answer', 'Jesus Christ,Jesus', 'Jesus'),
(17, '_______ of grace divine, love orchestrated in our lives', 'Single Answer', 'Father,Author', 'Author'),
(18, 'The cross of Calvary, the ______ of God the centerpiece', 'Single Answer', 'gift,love', 'gift'),
(19, 'Upon that cross You set us _______', 'Single Answer', 'freed,free', 'free'),
(20, 'Lift our ______ towards the Son, glorious You stand alone', 'Single Answer', 'eye,eyes', 'eyes'),
(21, 'Raised to life ___________, holy is the Lord our God.', 'Single Answer', 'You overcame,You''ve overcome', 'You''ve overcome'),
(22, 'Your love is ________', 'Single Answer', 'unparalleled,unrivalled', 'unrivalled'),
(23, 'Your glory spans ______', 'Single Answer', 'eternally,eternity', 'eternity'),
(24, 'Your Word is final, the cross of Christ our _______', 'Single Answer', 'victories,victory', 'victory'),
(25, 'Every ______ will bow at the name of Jesus', 'Single Answer', 'person,knee', 'knee'),
(26, 'For there is no name like the name of _______', 'Single Answer', 'Jesus Christ,Jesus', 'Jesus');
...
--
ALTER TABLE `messagequestions`
  MODIFY `id` mediumint(9) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=9196;
--
